...
### [4] [On Problems of Implicit Context Compression for Software Engineering Agents](https://arxiv.org/abs/2605.11051)
...
### [5] [SHIA: A Direct SysML-Hardware Interface Architecture for Model-Centric Verification](https://arxiv.org/abs/2605.11248)
...
### [6] [Natural Language based Specification and Verification](https://arxiv.org/abs/2605.11315)
...
### [7] [NeuroFlake: A Neuro-Symbolic LLM Framework for Flaky Test Classification](https://arxiv.org/abs/2605.11482)
...
### [8] [Decaf: Improving Neural Decompilation with Automatic Feedback and Search](https://arxiv.org/abs/2605.11501)
...
### [9] [A Research Agenda on Agents and Software Engineering: Outcomes from the Rio A2SE Seminar](https://arxiv.org/abs/2605.11720)
...
### [10] [An Extensive Replication Study of the ABLoTS Approach for Bug Localization](https://arxiv.org/abs/2605.11790)
...
### [11] [The Death Spiral of Open Source Projects: A Post-Mortem Analysis of Pull Request Workflow Dynamics](https://arxiv.org/abs/2605.11844)
...
### [12] [StepCodeReasoner: Aligning Code Reasoning with Stepwise Execution Traces via Reinforcement Learning](https://arxiv.org/abs/2605.11922)
...
### [13] [Property-Level Reconstructability of Agent Decisions: An Anchor-Level Pilot Across Vendor SDK Adapter Regimes](https://arxiv.org/abs/2605.12078)
*Oleg Solozobov*
...
### [14] [HM-Req: A Framework for Embedding Values within CPS Human Monitoring Requirements](https://arxiv.org/abs/2605.12100)
...
### [15] [CIDR: A Large-Scale Industrial Source Code Dataset for Software Engineering Research](https://arxiv.org/abs/2605.12153)
*Vladislav Savenkov*
...
### [16] [ReproBreak: A Dataset of Reproducible Web Locator Breaks](https://arxiv.org/abs/2605.12158)
...
### [17] [Uncertainty Quantification for LLM-based Code Generation](https://arxiv.org/abs/2605.12201)
...
### [18] [Characterizing the Failure Modes of LLMs in Resolving Real-World GitHub Issues](https://arxiv.org/abs/2605.12270)
...
### [19] [Iterative Audit Convergence in LLM-Managed Multi-Agent Systems: A Case Study in Prompt Engineering Quality Assurance](https://arxiv.org/abs/2605.12280)
*Elias Calboreanu*
...
### [20] [PASA: A Principled Embedding-Space Watermarking Approach for LLM-Generated Text under Semantic-Invariant Attacks](https://arxiv.org/abs/2605.10977)
...
### [21] [Few-Shot Truly Benign DPO Attack for Jailbreaking LLMs](https://arxiv.org/abs/2605.10998)
...
### [22] [MT-JailBench: A Modular Benchmark for Understanding Multi-Turn Jailbreak Attacks](https://arxiv.org/abs/2605.11002)
...
### [23] [The Authorization-Execution Gap Is a Major Safety and Security Problem in Open-World Agents](https://arxiv.org/abs/2605.11003)
...
### [24] [DCVD: Dual-Channel Cross-Modal Fusion for Joint Vulnerability Detection and Localization](https://arxiv.org/abs/2605.11015)
...
### [25] [AgentShield: Deception-based Compromise Detection for Tool-using LLM Agents](https://arxiv.org/abs/2605.11026)
...
### [26] [FragBench: Cross-Session Attacks Hidden in Benign-Looking Fragments](https://arxiv.org/abs/2605.11029)
...
### [27] [MambaNetBurst: Direct Byte-level Network Traffic Classification without Tokenization or Pretraining](https://arxiv.org/abs/2605.11034)
...
### [28] [Sequential Behavioral Watermarking for LLM Agents](https://arxiv.org/abs/2605.11036)
...
### [29] [The Granularity Mismatch in Agent Security: Argument-Level Provenance Solves Enforcement and Isolates the LLM Reasoning Bottleneck](https://arxiv.org/abs/2605.11039)
...
### [30] [A Multi-Interface Firmware Acquisition and Validation Methodology for Low-Cost Consumer Drones: A Case Study on Three Holy Stone Platforms](https://arxiv.org/abs/2605.11040)
...
### [31] [Red-Teaming Agent Execution Contexts: Open-World Security Evaluation on OpenClaw](https://arxiv.org/abs/2605.11047)
...
### [32] [MCPShield: Content-Aware Attack Detection for LLM Agent Tool-Call Traffic](https://arxiv.org/abs/2605.11053)
*Sultan Zavrak*
...
### [33] [ExploitGym: Can AI Agents Turn Security Vulnerabilities into Real Attacks?](https://arxiv.org/abs/2605.11086)
...
### [34] [FedSurrogate: Backdoor Defense in Federated Learning via Layer Criticality and Surrogate Replacement](https://arxiv.org/abs/2605.11122)
...
### [35] [Benchmarking LLM-Based Static Analysis for Secure Smart Contract Development: Reliability, Limitations, and Potential Hybrid Solutions](https://arxiv.org/abs/2605.11163)
...
### [36] [Adversarial SQL Injection Generation with LLM-Based Architectures](https://arxiv.org/abs/2605.11188)
...
### [37] [Continuous Discovery of Vulnerabilities in LLM Serving Systems with Fuzzing](https://arxiv.org/abs/2605.11202)
...
### [38] [Comment and Control: Hijacking Agentic Workflows via Context-Grounded Evolution](https://arxiv.org/abs/2605.11229)
...
### [39] [Context-Aware Spear Phishing: Generative AI-Enabled Attacks Against Individuals via Public Social Media Data](https://arxiv.org/abs/2605.11268)
...
### [40] [A Systematic Security Testing Approach for InterUSS-based environments](https://arxiv.org/abs/2605.11339)
...
### [41] [Options, Not Clicks: Lattice Refinement for Consent-Driven MCP Authorization](https://arxiv.org/abs/2605.11360)
...
### [42] [Can a Single Message Paralyze the AI Infrastructure? The Rise of AbO-DDoS Attacks through Targeted Mobius Injection](https://arxiv.org/abs/2605.11442)
...
### [43] [Digital Identity for Agentic Systems: Toward a Portable Authorization Standard for Autonomous Agents](https://arxiv.org/abs/2605.11487)
*Partha Madhira*
...
### [44] [FlowSteer: Prompt-Only Workflow Steering Exposes Planning-Time Vulnerabilities in Multi-Agent LLM Systems](https://arxiv.org/abs/2605.11514)
...
### [45] [Convolutional-Neural-Networks for Deanonymisation of I2P Traffic](https://arxiv.org/abs/2605.11606)
...
### [46] [PhishSigma++: Malicious Email Detection with Typed Entity Relations](https://arxiv.org/abs/2605.11619)
...
### [47] [Every Bit, Everywhere, All at Once: A Binomial Multibit LLM Watermark](https://arxiv.org/abs/2605.11653)
...
### [48] [HySecTwin: A Knowledge-Driven Digital Twin Framework Augmented with Hybrid Reasoning for Cyber-Physical Systems](https://arxiv.org/abs/2605.11682)
...
### [49] [Deanonymizable Scoped Linkable Ring Signatures](https://arxiv.org/abs/2605.11715)
...
### [50] [Behavioral Integrity Verification for AI Agent Skills](https://arxiv.org/abs/2605.11770)
...
### [51] [Five Attacks on x402 Agentic Payment Protocol](https://arxiv.org/abs/2605.11781)
...
### [52] [IPI-proxy: An Intercepting Proxy for Red-Teaming Web-Browsing AI Agents Against Indirect Prompt Injection](https://arxiv.org/abs/2605.11868)
...
### [53] [Proteus: A Self-Evolving Red Team for Agent Skill Ecosystems](https://arxiv.org/abs/2605.11891)
*Zhaojiacheng Zhou*
...
### [54] [AccLock: Unlocking Identity with Heartbeat Using In-Ear Accelerometers](https://arxiv.org/abs/2605.11901)
...
### [55] [A microservices-based endpoint monitoring platform with predictive NLP models for real-time security and hate-speech risk alerting](https://arxiv.org/abs/2605.11997)
...
### [57] [The Deepfakes We Missed: We Built Detectors for a Threat That Didn't Arrive](https://arxiv.org/abs/2605.12075)
*Shaina Raza*
...
### [58] [PrivacySIM: Evaluating LLM Simulation of User Privacy Behavior](https://arxiv.org/abs/2605.12147)
...
### [59] [ACTING: A Platform for Cyber Ranges Federation](https://arxiv.org/abs/2605.12170)
...
### [60] [ORCHID: Orchestrated Reduction Consensus for Hash-based Integrity in Distributed Ledgers](https://arxiv.org/abs/2605.12211)
...
### [61] [Reconstruction of Personally Identifiable Information from Supervised Finetuned Models](https://arxiv.org/abs/2605.12264)
...
### [62] [Attacks and Mitigations for Distributed Governance of Agentic AI under Byzantine Adversaries](https://arxiv.org/abs/2605.12364)
...
### [63] [TextSeal: A Localized LLM Watermark for Provenance & Distillation Protection](https://arxiv.org/abs/2605.12456)
