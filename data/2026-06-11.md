...
### [14] [When Poison Fails After Retrieval: Revisiting Corpus Poisoning under Chunking and Reranking Pipelines](https://arxiv.org/abs/2606.11265)
...
### [15] [MPC-Patch-Bench: Security-Aware LLM Code Patch for Multi-Party Computation](https://arxiv.org/abs/2606.11416)
...
### [16] [JailbreakOPT: Tool-Assisted Iterative Jailbreak Prompt Optimization](https://arxiv.org/abs/2606.11425)
...
### [17] [Evaluating and Combating the Impact of Concept Drift on the Performance of Machine Learning-Based Phishing Detection Systems](https://arxiv.org/abs/2606.11471)
...
### [18] [Hiding the Trees in the Forest: Building Network Covert Channels with Hash-Based Covert Carrier Filtering](https://arxiv.org/abs/2606.11532)
...
### [19] [VIPIR: A Versatile GPU Framework for Integrating Private Information Retrieval Protocols](https://arxiv.org/abs/2606.11536)
...
### [20] [PriME-Deal: Privacy-Preserving Bilateral Data Trading with Efficient Matchmaking and Auditable Fair Exchange on Blockchain](https://arxiv.org/abs/2606.11539)
...
### [21] [WHET: Welding Homomorphic Encryption to Accelerator Architectures](https://arxiv.org/abs/2606.11541)
...
### [22] [Privacy-Preserving Federated Autoencoder for ECG Anomaly Detection on Edge Devices](https://arxiv.org/abs/2606.11556)
...
### [23] [A Deterministic Forensic Preprocessing Framework for Heterogeneous Network Datasets: Formal Foundations, Implementation, and Empirical Validation](https://arxiv.org/abs/2606.11565)
...
### [24] [Defense Against Prompt Inversion Attacks: An Information-Theoretic Approach for LLM Collaborative Inference](https://arxiv.org/abs/2606.11592)
...
### [25] [Sovereign Assurance Boundary: Certificate-Bound Admission for Agentic Infrastructure](https://arxiv.org/abs/2606.11632)
*Jun He,Deying Yu*
...
### [26] [Dummy Backdoor as a Defense: Removing Unknown Backdoors via Shared Internal Mechanisms for Generative LLMs](https://arxiv.org/abs/2606.11648)
...
### [27] [A Robust Framework for Sybil Attack Detection in Vehicular Ad Hoc Networks](https://arxiv.org/abs/2606.11667)
...
### [28] [Runtime Skill Audit: Targeted Runtime Probing for Agent Skill Security](https://arxiv.org/abs/2606.11671)
*Tu Lan,Chaowei Xiao*
...
### [29] [Can Open-Source LLM Agents Replace Static Application Security Testing Tools? An Empirical Assessment](https://arxiv.org/abs/2606.11672)
...
### [30] [T2S: A Rehearsal-Based Approach for Extraction-Resistant Model Watermarking](https://arxiv.org/abs/2606.11698)
...
### [31] [Grammar-Constrained Decoding Can Jailbreak LLMs into Generating Malicious Code](https://arxiv.org/abs/2606.11817)
...
### [32] [A VPN-as-a-Service Tailored Enabler for Computing-constrained Environments](https://arxiv.org/abs/2606.11729)
...
### [33] [MHOT: Height-Optimized Authenticated Data Structure for Blockchain State Commitment](https://arxiv.org/abs/2606.11736)
...
### [34] [SwarmSense-DNN: A Trustworthy and Decentralized Neural Framework for Proactive Anomaly Defense in Consumer IoT](https://arxiv.org/abs/2606.11803)
...
### [35] [Jaguar: Fast Private CNN Inference with Power-of-Two Homomorphic Arithmetic](https://arxiv.org/abs/2606.11827)
...
### [36] [Systematic Cybersecurity Risk Analysis of European Rail Traffic Management System](https://arxiv.org/abs/2606.11839)
...
### [37] [WarpGuard: Protected-Site Control-Flow Integrity for CUDA SASS Binaries](https://arxiv.org/abs/2606.11871)
*Igor Santos-Grueiro*
...
### [38] [Gerrymandering the Warp: Non-Control-Data Attacks on CUDA Collective Decision](https://arxiv.org/abs/2606.11878)
*Igor Santos-Grueiro*
...
### [39] [Quadratic APN Functions in Dimension 8 via Gröbner Basis Search in a Self-Equivalence Subspace](https://arxiv.org/abs/2606.11967)
*Oleksandr Kuznetsov*
...
### [40] [InjectV: Modeling Fault Injection Attacks in RISC-V Simulation Environment](https://arxiv.org/abs/2606.12011)
...
### [41] [Categorical Robustness Assessment for Machine Learning based Network Intrusion Detection Systems](https://arxiv.org/abs/2606.12075)
...
### [42] [Bridging the Smart City Cybersecurity Data Gap Through AI-Driven Synthetic Dataset Generation](https://arxiv.org/abs/2606.12225)
...
### [43] [Partitioned Tags, Shared Data: Reconciling Strict Cache Isolation with Write-Shared Coherence](https://arxiv.org/abs/2606.12259)
...
### [44] [Selection Integrity for LLM Graph Memory: An Accumulability Criterion for Information-Flow-Blind Retrieval](https://arxiv.org/abs/2606.12290)
...
### [45] [OCELOT: Inference-Leakage Budgets for Privacy-Preserving LLM Agents](https://arxiv.org/abs/2606.12341)
*Jin Xie,Songze Li*
...
### [46] [ECYSAP EYE: From Cyber Situational Awareness to Mission-Centric Decision Support for Enhanced Cyberspace Operations](https://arxiv.org/abs/2606.12354)
...
### [47] [MARCIM-WG: A cyber wargame proposal based on math modeling applied in a naval scenario](https://arxiv.org/abs/2606.12395)
