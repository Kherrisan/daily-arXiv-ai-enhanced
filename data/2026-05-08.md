...
### [23] [SuperPaymaster: Eliminating Centralized Signer Authority via Asset-Oriented Abstraction to Reconcile Usability and Decentralization in Account Abstraction](https://arxiv.org/abs/2605.05774)
...
### [24] [Stego Battlefield: Evaluating Image Steganography Attacks and Steganalysis Defenses](https://arxiv.org/abs/2605.05789)
...
### [25] [LCC-LLM: Leveraging Code-Centric Large Language Models for Malware Attribution](https://arxiv.org/abs/2605.05807)
...
### [26] [LeakDojo: Decoding the Leakage Threats of RAG Systems](https://arxiv.org/abs/2605.05818)
...
### [27] [LoopTrap: Termination Poisoning Attacks on LLM Agents](https://arxiv.org/abs/2605.05846)
...
### [28] [SkillScope: Toward Fine-Grained Least-Privilege Enforcement for Agent Skills](https://arxiv.org/abs/2605.05868)
...
### [29] [ActiveFlowMark: Assessing Tor Anonymity under Active Bandwidth Watermarking](https://arxiv.org/abs/2605.05887)
...
### [30] [Toward Space-Based Public Key Systems: Enabling Secure Space Communications through In-Orbit Trust Services](https://arxiv.org/abs/2605.05948)
...
### [37] [Fine-Tuning Small Language Models for Solution-Oriented Windows Event Log Analysis](https://arxiv.org/abs/2605.06330)
...
### [38] [Constraining Host-Level Abuse in Self-Hosted Computer-Use Agents via TEE-Backed Isolation](https://arxiv.org/abs/2605.06393)
...
### [39] [Pop Quiz Attack: Black-box Membership Inference Attacks Against Large Language Models](https://arxiv.org/abs/2605.06423)
...
### [40] [Autonomous Adversary: Red-Teaming in the age of LLM](https://arxiv.org/abs/2605.06486)
...
### [41] [Privacy by Postprocessing the Discrete Laplace Mechanism](https://arxiv.org/abs/2605.06502)
...
### [42] [On the Security of Research Artifacts](https://arxiv.org/abs/2605.06508)
...
### [43] [FedAttr: Towards Privacy-preserving Client-Level Attribution in Federated LLM Fine-tuning](https://arxiv.org/abs/2605.06596)
...
### [44] [Patch2Vuln: Agentic Reconstruction of Vulnerabilities from Linux Distribution Binary Patches](https://arxiv.org/abs/2605.06601)
...
### [45] [DADL: A Declarative Description Language for Enterprise Tool Libraries in LLM Agent Systems](https://arxiv.org/abs/2605.05247)
*Axel Dunkel*
...
### [46] [Automated Population-Level Audit Assurance via AI-Based Document Intelligence](https://arxiv.org/abs/2605.05252)
...
### [47] [PARNESS: A Paper Harness for End-to-End Automated Scientific Research with Dynamic Workflows, Full-Text Indexing, and Cross-Run Knowledge Accumulation](https://arxiv.org/abs/2605.05258)
...
### [48] [Bridging Generation and Training: A Systematic Review of Quality Issues in LLMs for Code](https://arxiv.org/abs/2605.05267)
...
### [49] [Is this Build Failure Related to my Patch? An Empirical Study of Unrelated Build Failures in Continuous Integration](https://arxiv.org/abs/2605.05564)
...
### [50] [Operationalizing Ethics for AI Agents: How Developers Encode Values into Repository Context Files](https://arxiv.org/abs/2605.05584)
...
### [51] [An Empirical Study of Proactive Coding Assistants in Real-World Software Development](https://arxiv.org/abs/2605.05700)
...
### [52] [From Chat to Interview: Agentic Requirements Elicitation with an Experience Ontology](https://arxiv.org/abs/2605.05828)
...
### [53] [On Fixing Insecure AI-Generated Code through Model Fine-Tuning and Prompting Strategies](https://arxiv.org/abs/2605.05867)
...
### [54] [Evaluating Non-English Developer Support in Machine Learning for Software Engineering](https://arxiv.org/abs/2605.05902)
...
### [55] [Exploring the Effectiveness of Abstract Syntax Tree Patterns for Algorithm Recognition](https://arxiv.org/abs/2605.06098)
...
### [57] [BUILD-AND-FIND: An Effort-Aware Protocol for Evaluating Agent-Managed Codebases](https://arxiv.org/abs/2605.06136)
*Jhen-Ke Lin*
...
### [58] [Modeling Dependency-Propagated Ecosystem Impact of Changes in Maintenance Activities: Evaluating Support Strategies in the PyPI Network](https://arxiv.org/abs/2605.06164)
...
### [59] [Teaching LLMs Program Semantics via Symbolic Execution Traces](https://arxiv.org/abs/2605.06184)
...
### [60] [SiblingRepair: Sibling-Based Multi-Hunk Repair with Large Language Models](https://arxiv.org/abs/2605.06209)
...
### [61] [Correct Code, Vulnerable Dependencies: A Large Scale Measurement Study of LLM-Specified Library Versions](https://arxiv.org/abs/2605.06279)
...
### [62] [Constraint Decay: The Fragility of LLM Agents in Backend Code Generation](https://arxiv.org/abs/2605.06445)
...
### [63] [To What Extent Does Agent-generated Code Require Maintenance? An Empirical Study](https://arxiv.org/abs/2605.06464)
