...
### [18] [Autonomous LLM Agents & CTFs: A Second Look](https://arxiv.org/abs/2605.21497)
...
### [19] [Chain Reactions: How Nonce Collisions in ECDSA Compromise Polygon MEV Searchers](https://arxiv.org/abs/2605.21498)
...
### [21] [ASSEMBLAGE-DEEPHISTORY: A Cross-Build Binary Dataset with Temporal Coverage](https://arxiv.org/abs/2605.21615)
...
### [22] [Adversarial Reframing: A Framework for Targeted Generation in Language Models](https://arxiv.org/abs/2605.21674)
...
### [23] [PocketAgents: A Manifest-Driven Library of Autonomous Defense Agents](https://arxiv.org/abs/2605.21694)
...
### [24] [HIDBench: Benchmarking Large Language Models for Host-Based Intrusion Detection](https://arxiv.org/abs/2605.21773)
...
### [25] [FuzzingBrain V2: A Multi-Agent LLM System for Automated Vulnerability Discovery and Reproduction](https://arxiv.org/abs/2605.21779)
...
### [26] [Polars inside Intel SGX2 Enclaves: An Empirical Study of Confidential Analytical Query Processing](https://arxiv.org/abs/2605.21797)
...
### [27] [Graph Structure of Chebyshev Permutation Polynomials over Binary and Ternary Adic Rings](https://arxiv.org/abs/2605.21819)
...
### [28] [A Large Language Model Approach to Generating Bypass Rules for Malware Evasion in Analysis Sandbox](https://arxiv.org/abs/2605.21821)
...
### [29] [Quality-Assured Fuzz Harness Generation via the Four Principles Framework](https://arxiv.org/abs/2605.21824)
...
### [30] [SPIDER: Two Server Functionality for the Cost of Zero](https://arxiv.org/abs/2605.21857)
...
### [31] [CCLab: Adversarial Testing of Learning- and Non-Learning-Based Congestion Controllers](https://arxiv.org/abs/2605.21915)
...
### [32] [Blind Spots in the Guard: How Domain-Camouflaged Injection Attacks Evade Detection in Multi-Agent LLM Systems](https://arxiv.org/abs/2605.22001)
*Aaditya Pai*
...
### [33] [Parser-Free Querying of Security Logs](https://arxiv.org/abs/2605.22027)
...
### [34] [Benchmarking Autonomous Agents against Temporal, Spatial, and Semantic Evasions](https://arxiv.org/abs/2605.22321)
...
### [35] [RADAR: Defending RAG Dynamically against Retrieval Corruption](https://arxiv.org/abs/2605.22041)
...
### [36] [Innovations in Cardless Artificial Intelligence Banking: A Comprehensive Framework for Cyber Secure and Fraud Mitigation using Machine Learning Algorithms](https://arxiv.org/abs/2605.22604)
*Md Israfeel*
...
### [37] [Safeguarding Text-to-Image Generative Models Against Unauthorized Knowledge Distillation](https://arxiv.org/abs/2605.22060)
...
### [38] [QT-PUF: Quantum Tunneling Leakage Based PUF for Implantable IoMT Devices](https://arxiv.org/abs/2605.22113)
...
### [39] [Adversarial Trust Poisoning in Vehicular Collaborative Perception](https://arxiv.org/abs/2605.22122)
...
### [40] [Market-Analysis-Driven Methodology for Assessing Charging Station Cybersecurity](https://arxiv.org/abs/2605.22151)
...
### [41] [Decision-Aware Quadratic ReLU Replacement for HE-Friendly Inference](https://arxiv.org/abs/2605.22237)
...
### [42] [PACT: Reducing Alert Fatigue in Low-Prevalence SOC Streams with Triggered Active Learning](https://arxiv.org/abs/2605.22324)
...
### [43] [Building Europe's Quantum Shield: The Strategic view for a Continent-Wide Quantum Key Ditribution (QKD) Infrastructure](https://arxiv.org/abs/2605.22332)
...
### [44] [A First Measurement Study on Authentication Security in Real-World Remote MCP Servers](https://arxiv.org/abs/2605.22333)
...
### [45] [TimeGuard: Channel-wise Pool Training for Backdoor Defense in Time Series Forecasting](https://arxiv.org/abs/2605.22365)
...
### [46] [Characterizing the Fault Response of the Intel Neural Compute Stick 2 Under Single-Pulse Electromagnetic Fault Injection](https://arxiv.org/abs/2605.22437)
...
### [47] [A Constant-Time Implementation Methodology for Activation Functions on Microcontrollers](https://arxiv.org/abs/2605.22441)
...
### [48] [EnCAgg: Enhanced Clustering Aggregation for Robust Federated Learning against Dynamic Model Poisoning](https://arxiv.org/abs/2605.22506)
...
### [49] [Measuring Security Without Fooling Ourselves: Why Benchmarking Agents Is Hard](https://arxiv.org/abs/2605.22568)
...
### [50] [A Formal Basis for Quantum Cryptographic Exposure Measurement under HNDL Threat](https://arxiv.org/abs/2605.22569)
...
### [51] [Building an Open Source Operational Technology Pentesting Platform: Lessons from LINICS](https://arxiv.org/abs/2605.22590)
...
### [52] [UNAD+: An Explainable Hybrid Framework for Unknown Network Attack Detection](https://arxiv.org/abs/2605.22621)
...
### [53] [TriSweep: A Four-Drone Swarm Framework for Electromagnetic Side-Channel Analysis](https://arxiv.org/abs/2605.22709)
