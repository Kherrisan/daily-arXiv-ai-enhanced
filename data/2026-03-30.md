...
### [3] [AVDA: Autonomous Vibe Detection Authoring for Cybersecurity](https://arxiv.org/abs/2603.25930)
...
### [4] [Not All Entities are Created Equal: A Dynamic Anonymization Framework for Privacy-Preserving Retrieval-Augmented Generation](https://arxiv.org/abs/2603.26074)
...
### [5] [ROAST: Risk-aware Outlier-exposure for Adversarial Selective Training of Anomaly Detectors Against Evasion Attacks](https://arxiv.org/abs/2603.26093)
...
### [6] [Clawed and Dangerous: Can We Trust Open Agentic Systems?](https://arxiv.org/abs/2603.26221)
...
### [7] [Hermes Seal: Zero-Knowledge Assurance for Autonomous Vehicle Communications](https://arxiv.org/abs/2603.26343)
...
### [8] [Hidden Elo: Private Matchmaking through Encrypted Rating Systems](https://arxiv.org/abs/2603.26407)
...
### [9] [Towards Privacy-Preserving Federated Learning using Hybrid Homomorphic Encryption](https://arxiv.org/abs/2603.26417)
...
### [10] [Machine Learning Transferability for Malware Detection](https://arxiv.org/abs/2603.26632)
...
### [12] [IncreRTL: Traceability-Guided Incremental RTL Generation under Requirement Evolution](https://arxiv.org/abs/2603.25769)
...
### [13] [Opportunities and Limitations of GenAI in RE: Viewpoints from Practice](https://arxiv.org/abs/2603.25905)
...
### [14] [Search-Induced Issues in Web-Augmented LLM Code Generation: Detecting and Repairing Error-Inducing Pages](https://arxiv.org/abs/2603.26091)
...
### [15] [SWE-PRBench: Benchmarking AI Code Review Quality Against Pull Request Feedback](https://arxiv.org/abs/2603.26130)
*Deepak Kumar*
...
### [16] [An Object Web Seminar: A Retrospective on a Technical Dialogue Still Reverbarating](https://arxiv.org/abs/2603.26203)
*James J. Cusick*
...
### [17] [Beyond Code Snippets: Benchmarking LLMs on Repository-Level Question Answering](https://arxiv.org/abs/2603.26567)
...
### [18] [Sustainability Is Not Linear: Quantifying Performance, Energy, and Privacy Trade-offs in On-Device Intelligence](https://arxiv.org/abs/2603.26603)
...
### [19] [Learning to Commit: Generating Organic Pull Requests via Online Repository Memory](https://arxiv.org/abs/2603.26664)
...
### [20] [A Large-scale Empirical Study on the Generalizability of Disclosed Java Library Vulnerability Exploits](https://arxiv.org/abs/2603.25997)
