...
### [19] [ToolMinimize: Auditing and Rewriting LLM Agent Tool Calls to Minimize Privacy Exposure](https://arxiv.org/abs/2608.24957)
...
### [20] [Retrieved But Not Reliable: A Survey on Attacks, and Defenses in Retrieval-Augmented Generation](https://arxiv.org/abs/2608.24977)
...
### [21] [Static Detection of Post-Quantum Cryptographic Algorithms in Stripped Binaries for Digital Forensic Examination and Migration Assurance](https://arxiv.org/abs/2608.25122)
...
### [22] [CA-less Mutual Co-Signing of Documents over a Unidirectional Visual Channel with Transported Hardware Attestation](https://arxiv.org/abs/2608.25144)
*Dmytro Diikun*
...
### [23] [BGPay: An Incentive-Compatible Mechanism for BGP Hijack Filtering](https://arxiv.org/abs/2608.25165)
...
### [24] [Authenticated Data Structures for Dynamic Workloads](https://arxiv.org/abs/2608.25206)
...
### [25] [Automotive HSMs - Architectural Challenges and Security Implications](https://arxiv.org/abs/2608.25216)
...
### [26] [LLMscope: Extracting LLM Assets from Edge AI Chips via Optical Probing](https://arxiv.org/abs/2608.25321)
...
### [27] [Here is a GIFT: Enforcing User Data Isolation in LLM Serving via GPU Information Flow Tracking](https://arxiv.org/abs/2608.25431)
...
### [28] [MACGen: Toward Functionally Correct and Secure Code Generation via Multi-Agent Collaboration](https://arxiv.org/abs/2608.25457)
...
### [29] [Separating Disclosure from Authorization: Field-Tier Minimization for Agent Action Mediation](https://arxiv.org/abs/2608.25474)
...
### [30] [MMJailBench: A Factorized Benchmark for Disentangling Multimodal Jailbreak Vulnerabilities](https://arxiv.org/abs/2608.25490)
...
### [31] [Defending the Peg: Real-Time Dynamic Protection and Anomaly Detection in DeFi Stablecoins](https://arxiv.org/abs/2608.25600)
...
### [32] [AI Slop and Hallucinations in Vulnerability Assessment: A Survey on Reasoning Failures and Trustworthy Mitigation](https://arxiv.org/abs/2608.25667)
...
### [33] [An Analysis of the Impact of Psychological Factors and Techniques Across Different Types of Social Engineering](https://arxiv.org/abs/2608.25670)
...
### [34] [LMSM: LLM Security Framework Inspired by Linux Security Modules](https://arxiv.org/abs/2608.25697)
...
### [35] [Reassembling Distributed Risk: Trajectory-Conditioned Action Generation for Multi-Turn Agent Safety](https://arxiv.org/abs/2608.25711)
...
### [36] [From Verdict to Diagnosis: Attributable Security Review of Pull Requests](https://arxiv.org/abs/2608.25730)
...
### [37] [Pointing the Way, Hiding the Destination: Practical Private Dense Retrieval at Scale](https://arxiv.org/abs/2608.25735)
...
### [38] [MeMark: Membrane-Space Watermarking for Spiking Neural Networks](https://arxiv.org/abs/2608.25738)
...
### [39] [Toward Interpretable Privacy Guarantees in Face-Swapping Anonymization](https://arxiv.org/abs/2608.25750)
...
### [40] [EVOMAL: Self-Poisoning in Self-Evolving Coding Agents](https://arxiv.org/abs/2608.25776)
...
### [41] [Closing the Gap: Automated Discovery of Secure Dockerfile Reference Standards via Semantic Clustering in Enterprise Inner Source](https://arxiv.org/abs/2608.25793)
...
### [42] [SkillShield: Prompt-Space Security Skills for LLM Coding Agents](https://arxiv.org/abs/2608.25817)
...
### [43] [A Hybrid Security Framework for Mini-Programs: Visual UI Compliance and Network Risk Assessment](https://arxiv.org/abs/2608.25877)
...
### [44] [A Self-Evolving Multi-Agent Framework Defense against LLM Jailbreak Attacks](https://arxiv.org/abs/2608.26008)
...
### [45] [RTLGuard: A Lightweight Teacher-Student Defense for Poisoned RTL Code Generation Models](https://arxiv.org/abs/2608.26049)
...
### [46] [From Fleet to Lab: Revisiting the Security and Complexity of Industrial Rowhammer Mitigation](https://arxiv.org/abs/2608.26072)
