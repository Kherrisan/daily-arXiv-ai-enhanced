...
### [25] [Domain-Conditioned Safety in Frontier Computer-Using Agents: A 793-Episode Browser Benchmark, a Coding-Domain Cross-Reference, and a Reproducibility Audit of Recent Red-Teaming](https://arxiv.org/abs/2606.05233)
*Nicholas Saban*
...
### [26] [Search-Time Contamination in Deep Research Agents: Measuring Performance Inflation in Public Benchmark Evaluation](https://arxiv.org/abs/2606.05241)
...
### [27] [From Attack Simulation to SIEM Rule: Deterministic Detection-as-Code Synthesis with Probe-Level Traceability](https://arxiv.org/abs/2606.05252)
...
### [28] [Willing but Unable: Separating Refusal from Capability in Code LLMs via Abliteration](https://arxiv.org/abs/2606.05396)
...
### [29] [A formal framework for the economic security of DeFi compositions](https://arxiv.org/abs/2606.05418)
...
### [30] [Policy-Compliant Cloud Storage Systems](https://arxiv.org/abs/2606.05423)
...
### [31] [CRESS: Quantifying Vulnerabilities of Attack Scenarios in Hardware Reverse Engineering](https://arxiv.org/abs/2606.05459)
...
### [32] [SHIELDS: Automating OS Hardening with Iterative Multi-Agent Remediation](https://arxiv.org/abs/2606.05476)
...
### [33] [Bitcoin After Block Rewards](https://arxiv.org/abs/2606.05503)
*Junhyuk Lee*
...
### [34] [ZERO-APT: A Closed-Loop Adversarial Framework for LLM-Driven Automated Penetration Testing under Intelligent Defense](https://arxiv.org/abs/2606.05567)
...
### [35] [Dimensionality Reduction for Cyberattack Classification: A Comparative Evaluation of PCA and Linear Predictive Coding](https://arxiv.org/abs/2606.05584)
...
### [36] [The Coverage Gap: Chile's Cyber Disclosure Framework versus the USA, EU and UK](https://arxiv.org/abs/2606.05594)
*David Mellafe Z*
...
### [37] [SlotGCG: Exploiting the Positional Vulnerability in LLMs for Jailbreak Attacks](https://arxiv.org/abs/2606.05609)
...
### [38] [Protecting K-Nearest Neighbor Queries from Location Inference Attacks](https://arxiv.org/abs/2606.05648)
...
### [39] [Cognitive Threat Intelligence and Explainable Federated Security Analytics for distributed Infrastructure Systems](https://arxiv.org/abs/2606.05701)
...
### [40] [Explainable AI-Driven Cyber Risk Analytics and Model Reliability Assessment for Intelligent Governance of U.S. Critical Infrastructure: An XGBoost and SHAP-Based Intrusion Detection Framework](https://arxiv.org/abs/2606.05710)
...
### [41] [Hybrid CNN-LSTM Framework for Intelligent Cyber Attack Detection and Prevention in U.S. Critical Digital Infrastructure: A Comparative Machine Learning Evaluation on CSE-CIC-IDS2018](https://arxiv.org/abs/2606.05714)
...
### [42] [An Embarrassingly Simple Detector for Model Extraction Attacks in Large Language Model API Traffic](https://arxiv.org/abs/2606.05725)
...
### [43] [Membrane: A Self-Evolving Contrastive Safety Memory for LLM Agent Defense](https://arxiv.org/abs/2606.05743)
...
### [44] [An Improved CNN-LSTM Based Intrusion Detection System for IoT Networks](https://arxiv.org/abs/2606.05776)
...
### [45] [TinyML-Driven Cybersecurity for Autonomous Spacecraft: Latency-Accuracy Analysis for SPARTA RF and Cyber Threat Detection](https://arxiv.org/abs/2606.05779)
...
### [46] [SentinelRAG: Synthetic Sentinel Knowledge for RAG Database Copyright Protection](https://arxiv.org/abs/2606.05787)
...
### [47] [GCD: Garbled, Corrected, Demonstrandum -- Fixing and Proving Go's Extended GCD Implementation](https://arxiv.org/abs/2606.05796)
*Linard Arquint*
...
### [48] [PriSrv: Privacy-Enhanced and Highly Usable Service Discovery in Wireless Communications](https://arxiv.org/abs/2606.05821)
...
### [49] [Towards Worst-case Hardness for Low-Noise LPN](https://arxiv.org/abs/2606.05834)
...
### [50] [GenTI: Benchmarking LLMs for Autonomous IDPS Rule Generation for Unseen Attacks](https://arxiv.org/abs/2606.05844)
...
### [51] [PriSrv+: Privacy and Usability-Enhanced Wireless Service Discovery with Fast and Expressive Matchmaking Encryption](https://arxiv.org/abs/2606.05902)
...
### [52] [Exploring the connection between coding habits and cognitive styles in malware developers](https://arxiv.org/abs/2606.05945)
...
### [53] [AttackPathGNN: Cross-function vulnerability detection in smart contracts using state interference graphs and conjunction pooling](https://arxiv.org/abs/2606.05986)
...
### [54] [Cheating in Multiplayer Online Games: a Dataset](https://arxiv.org/abs/2606.06013)
...
### [55] [RedEdit: Agentic Red-Teaming of Image Safety Classifiers via MCTS-Guided Photo-Editing](https://arxiv.org/abs/2606.06140)
...
### [56] [Opportunities and Challenges in Securely Reusing and Repurposing Mobile Devices](https://arxiv.org/abs/2606.06181)
...
### [57] [Steering LLM Viewpoints through Fabricated Evidence Injection](https://arxiv.org/abs/2606.06244)
...
### [58] [SecRL-Prune: Structured Reinforcement Learning-Based Pruning of CodeLLMs for Preserving Adversarial Code Mutation](https://arxiv.org/abs/2606.06254)
...
### [59] [Robust Ensemble of Selectively Strengthened and Augmented Predictors](https://arxiv.org/abs/2606.06265)
...
### [60] [Credential Disclosure in (EU) Digital Identity Wallets: Privacy Risks and Practical Mitigations](https://arxiv.org/abs/2606.06354)
...
### [61] [WebMCP Tool Surface Poisoning: Runtime Manipulation Attacks on LLM Agents](https://arxiv.org/abs/2606.06387)
...
### [62] [Will the Agent Recuse Itself? Measuring LLM-Agent Compliance with In-Band Access-Deny Signals](https://arxiv.org/abs/2606.06460)
