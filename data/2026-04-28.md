...
### [37] [Evaluation of Prompt Injection Defenses in Large Language Models](https://arxiv.org/abs/2604.23887)
...
### [38] [MAS-SZZ: Multi-Agentic SZZ Algorithm for Vulnerability-Inducing Commit Identification](https://arxiv.org/abs/2604.24398)
...
### [39] [System-aware contextual digital twin for ICS anomaly diagnosis](https://arxiv.org/abs/2604.24051)
...
### [40] [Listen to the Voices of Everyday Users: Democratizing Privacy Ratings for Sensitive Data Access in Mobile Apps](https://arxiv.org/abs/2604.24066)
...
### [41] [Jailbreaking Frontier Foundation Models Through Intention Deception](https://arxiv.org/abs/2604.24082)
...
### [42] [AgentVisor: Defending LLM Agents Against Prompt Injection via Semantic Virtualization](https://arxiv.org/abs/2604.24118)
...
### [43] [Detecting Avalanche Effect in Adversarial Settings: Spotting the Encryption Loops in Ransomware](https://arxiv.org/abs/2604.24131)
...
### [44] [Defusing the Trigger: Plug-and-Play Defense for Backdoored LLMs via Tail-Risk Intrinsic Geometric Smoothing](https://arxiv.org/abs/2604.24162)
...
### [45] [Dynamic Cyber Ranges](https://arxiv.org/abs/2604.24184)
...
### [46] [Agentic Witnessing: Pragmatic and Scalable TEE-Enabled Privacy-Preserving Auditing](https://arxiv.org/abs/2604.24203)
*Antony Rowstron*
...
### [47] [Converging Zero Trust and IoT Security: A Multivocal Literature Review](https://arxiv.org/abs/2604.24205)
...
### [48] [Resolving Conflicts Between RTOS Timekeeping and Uninterruptable Trusted Computing](https://arxiv.org/abs/2604.24277)
...
### [49] [RowHammer Vulnerability Counter (RVC): Redefining RowHammer Detection with Victim-Centric Tracking](https://arxiv.org/abs/2604.24287)
...
### [50] [X-NegoBox: An Explainable Privacy-Budget Negotiation Framework for Secure Peer-to-Peer Energy Data Exchange](https://arxiv.org/abs/2604.24326)
...
### [51] [GoAT-X: A Graph of Auditing Thoughts for Securing Token Transactions in Cross-Chain Contracts](https://arxiv.org/abs/2604.24341)
...
### [52] [Information-Theoretic Distributed Point Functions with Shorter Keys](https://arxiv.org/abs/2604.24385)
...
### [61] [The Impact of Documentation on Test Engagement in Pull Requests in OSS](https://arxiv.org/abs/2604.23048)
...
### [62] [Code Broker: A Multi-Agent System for Automated Code Quality Assessment](https://arxiv.org/abs/2604.23088)
*Samer Attrah*
...
### [63] [No Test Cases, No Problem: Distillation-Driven Code Generation for Scientific Workflows](https://arxiv.org/abs/2604.23106)
...
### [64] [Source-Code Analysis of iFogSim for Simulating Distributed IoT Architectures: Coverage, Challenges, and Enhancements](https://arxiv.org/abs/2604.23122)
...
### [65] [ArgRE: Formal Argumentation for Conflict Resolution in Multi-Agent Requirements Negotiation](https://arxiv.org/abs/2604.23124)
...
### [66] [RAT: RunAnyThing via Fully Automated Environment Configuration](https://arxiv.org/abs/2604.23190)
...
### [67] [AI-Assisted Code Review as a Scaffold for Code Quality and Self-Regulated Learning: An Experience Report](https://arxiv.org/abs/2604.23251)
...
### [68] [Knowledge Lever Risk Management for Software Engineering: A Stochastic Framework for Mitigating Knowledge Loss](https://arxiv.org/abs/2604.23257)
...
### [69] [Can LLMs be Effective Code Contributors? A Study on Open-source Projects](https://arxiv.org/abs/2604.23340)
...
### [70] [Empirical Insights of Test Selection Metrics under Multiple Testing Objectives and Distribution Shifts](https://arxiv.org/abs/2604.23342)
...
### [71] [An Empirical Evaluation of Locally Deployed LLMs for Bug Detection in Python Code](https://arxiv.org/abs/2604.23361)
...
### [72] [UniAda: Universal Adaptive Multi-objective Adversarial Attack for End-to-End Autonomous Driving Systems](https://arxiv.org/abs/2604.23362)
...
### [73] [CUJBench: Benchmarking LLM-Agent on Cross-Modal Failure Diagnosis from Browser to Backend](https://arxiv.org/abs/2604.23455)
*Haoming Meng*
...
### [74] [Uncertainty Propagation in LLM-Based Systems](https://arxiv.org/abs/2604.23505)
...
### [75] [Uncovering Business Logic Bugs via Semantics-Driven Unit Test Generation](https://arxiv.org/abs/2604.23509)
...
### [76] [Grammar-Constrained Refinement of Safety Operational Rules Using Language in the Loop: What Could Go Wrong](https://arxiv.org/abs/2604.23523)
...
### [77] [AgentEval: DAG-Structured Step-Level Evaluation for Agentic Workflows with Error Propagation Tracking](https://arxiv.org/abs/2604.23581)
...
### [78] [Automated Classification of Human Code Review Comments with Large Language Models](https://arxiv.org/abs/2604.23667)
...
### [79] [KISS Sorcar: A Stupidly-Simple General-Purpose and Software Engineering AI Assistant](https://arxiv.org/abs/2604.23822)
*Koushik Sen*
...
### [80] [Characterizing the Usefulness of Code Review Comments in Scientific Software for Software Quality and Scientific Rigor](https://arxiv.org/abs/2604.23832)
...
### [81] [Constraint-Guided Multi-Agent Decompilation for Executable Binary Recovery](https://arxiv.org/abs/2604.23940)
...
### [82] [Vulnerability Identification by Harnessing Inter-connected Multi-Source Information](https://arxiv.org/abs/2604.24028)
...
### [83] [How Do Developers Use Migration Guides? A Case Study of Log4j](https://arxiv.org/abs/2604.24072)
...
### [84] [Closing the Loop: A Software Framework for AI to Support Business Decision Making](https://arxiv.org/abs/2604.24116)
...
### [85] [Empowering Autonomous Debugging Agents with Efficient Dynamic Analysis](https://arxiv.org/abs/2604.24212)
...
### [86] [RefEvo: Agentic Design with Co-Evolutionary Verification for Agile Reference Model Generation](https://arxiv.org/abs/2604.24218)
...
### [87] [MEMCoder: Multi-dimensional Evolving Memory for Private-Library-Oriented Code Generation](https://arxiv.org/abs/2604.24222)
...
### [88] [Exploring Creativity in Human-Human-LLM Collaborative Software Design](https://arxiv.org/abs/2604.24373)
...
### [89] [On the Footprints of Reviewer Bots Feedback on Agentic Pull Requests in OSS GitHub Repositories](https://arxiv.org/abs/2604.24450)
...
### [90] [How Do Software Engineering Students Use Generative AI in Real-World Capstone Projects? An Empirical Baseline Study](https://arxiv.org/abs/2604.24521)
...
### [91] [Understanding the Limits of Automated Evaluation for Code Review Bots in Practice](https://arxiv.org/abs/2604.24525)
...
### [92] [Mono2Sls: Automated Monolith-to-Serverless Migration via Multi-Stage Pipeline with Static Analysis](https://arxiv.org/abs/2604.24550)
...
### [93] [Measuring the Unmeasurable: Markov Chain Reliability for LLM Agents](https://arxiv.org/abs/2604.24579)
...
### [94] [Evaluation of LLM-Based Software Engineering Tools: Practices, Challenges, and Future Directions](https://arxiv.org/abs/2604.24621)
...
### [95] [Defective Task Descriptions in LLM-Based Code Generation: Detection and Analysis](https://arxiv.org/abs/2604.24703)
...
### [96] [When Prompt Under-Specification Improves Code Correctness: An Exploratory Study of Prompt Wording and Structure Effects on LLM-Based Code Generation](https://arxiv.org/abs/2604.24712)
*Amal AKLI,Mike PAPADAKIS,Maxime CORDY,Yves Le TRAON*
