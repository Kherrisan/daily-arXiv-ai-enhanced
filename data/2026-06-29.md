...
### [12] [How Humans, Bots, and Agents Communicate About Vulnerabilities in Pull Requests](https://arxiv.org/abs/2606.28125)
...
### [13] [Reasoning Beyond Prediction: From Data-Driven to Causal Software Engineering](https://arxiv.org/abs/2606.27960)
...
### [15] [SBridge: Identifying Source-to-Binary Function Similarity via Cross-Domain Control Block Matching](https://arxiv.org/abs/2606.28058)
...
### [16] [The ARDoCo Tool Landscape: REST API, TraceView, and TraceViz for Architecture Traceability](https://arxiv.org/abs/2606.28064)
...
### [20] [When the Aggregator Cheats: Data-Free Backdoors in Federated LLM-based QA Systems](https://arxiv.org/abs/2606.27511)
...
### [21] [On the Inseparability of Instructions and Data in Shared-Embedding Sequence Models](https://arxiv.org/abs/2606.27567)
...
### [22] [AdvScan: Black-Box Adversarial Example Detection at Runtime through Power Analysis](https://arxiv.org/abs/2606.27704)
...
### [23] [Reliable Homomorphic Matching for Fuzzy Labeled PSI at Scale](https://arxiv.org/abs/2606.27803)
*Erkam Uzun*
...
### [24] [Exploring and Exploiting Synchrony Limitations of Time-Triggered Network-Agnostic Guardians](https://arxiv.org/abs/2606.27819)
...
### [25] [Self-Verifying Measurement Records: Hash-Linked Evidence Graphs for Hardware Benchmarking](https://arxiv.org/abs/2606.27934)
...
### [26] [Agentic AI-Powered Re-Identification: An Emerging, Scalable Threat to Mobility Microdata Privacy](https://arxiv.org/abs/2606.27936)
...
### [27] [Decoys Cannot Go Everywhere: Mapping the Deception Surface in MITRE ATT&CK](https://arxiv.org/abs/2606.27966)
...
### [28] [SHARD: cell-keyed residual splitting for alignment-resistant private dense retrieval](https://arxiv.org/abs/2606.27976)
*Sergey Kurilenko*
...
### [29] [AdvancedShelLM: A Stateful Multi-Agent LLM Honeypot for SSH Deception](https://arxiv.org/abs/2606.27990)
...
### [30] [Ghost Without Shell: Measuring Non-Interactive SSH Attacks on Honeypots](https://arxiv.org/abs/2606.28006)
...
### [31] [ToolPrivacyBench: Benchmarking Purpose-Bound Privacy in Tool-Using LLM Agents](https://arxiv.org/abs/2606.28061)
...
### [32] [GTI-mSEMP Framework : A Proposed Framework to Stimulate Malware Propagation with Inclusion of Attacker-Defender Strategy](https://arxiv.org/abs/2606.28079)
...
### [33] [Robust Harmful Features Under Jailbreak Attacks: Mechanistic Evidence from Attention Head Specialization in Large Language Models](https://arxiv.org/abs/2606.28153)
