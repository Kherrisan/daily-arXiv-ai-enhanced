...
### [47] [Boundary-Seeking GAN-Augmented TabTransformer for Adversarially Robust Intrusion Detection](https://arxiv.org/abs/2607.16348)
...
### [48] [Reliable Remediation Impact Prediction for Black-Box Security Ratings](https://arxiv.org/abs/2607.16357)
...
### [49] [Identity-Bound Academic Credentials on Blockchain: On-Chain Issuer Accreditation with ERC-3643 and OnchainID](https://arxiv.org/abs/2607.16383)
...
### [50] [Signal-based Model Access Risk Analysis for AI System Operations Security](https://arxiv.org/abs/2607.16414)
...
### [51] [TaintRadar: Semantic-Aware Taint-Style Vulnerability Detection via Augmented Code Property Graphs](https://arxiv.org/abs/2607.16456)
...
### [52] [Fuzz'EMup: Leveraging EM Side-Channel Emanation to Guide Black-Box Embedded Firmware Fuzzing](https://arxiv.org/abs/2607.16487)
...
### [53] [Enhanced Multi-Class DDoS Attack Identification using a Meta-Learning Ensemble](https://arxiv.org/abs/2607.16521)
...
### [54] [A Control-Driven Framework for Secure SaaS Onboarding in Regulated Enterprises](https://arxiv.org/abs/2607.16543)
...
### [55] [Towards Secure and Trustworthy DAOs for Cross-Chain Governance](https://arxiv.org/abs/2607.16548)
...
### [56] [Auditable Session Admission for Cross-Silo Federated Learning](https://arxiv.org/abs/2607.16559)
...
### [57] [Synchronization-Free Algebraic Fingerprints for Large Language Models: From Autoregressive to Diffusion Models](https://arxiv.org/abs/2607.16648)
...
### [58] [VIGIL: Verifying Identity via Gated Intermittent Likelihoods for Continuous Biometric Authentication](https://arxiv.org/abs/2607.16651)
...
### [59] [SABLE: Minimalist Instruction-Level Authenticated Encryption for Constrained Confidential Computing](https://arxiv.org/abs/2607.16771)
...
### [60] [Rollback-Free Cross-Chain Atomicity Through Forward-Only Correction](https://arxiv.org/abs/2607.16959)
...
### [61] [Adaptive Incident Prioritization for Security Operations at Scale](https://arxiv.org/abs/2607.16963)
...
### [62] [Federated Lightweight Intrusion Detection in Drone Swarms with Knowledge Distillation](https://arxiv.org/abs/2607.17025)
...
### [63] [Federated Learning and LLM-Driven Threat Intelligence for Zero Trust IoT Architecture](https://arxiv.org/abs/2607.17035)
...
### [64] [A Systematic Evaluation of Traditional Privacy Policy Analysis Tools Against LLMs](https://arxiv.org/abs/2607.17075)
...
### [65] [SATLOCK: Handover-Coupled Scheduling for Weather-Resilient Quantum Key Distribution over LEO Constellations](https://arxiv.org/abs/2607.17076)
...
### [66] [A Multi-Model Hybrid Defense Approach Against White-box Adversarial Attacks in Computer Network Traffic](https://arxiv.org/abs/2607.17105)
*Khushnaseeb Roshan*
...
### [67] [DSA Nonce Vulnerabilities: An Interactive Analysis](https://arxiv.org/abs/2607.17107)
...
### [68] [SlotGuard: Stop Oversharing Private Local Context in LLM Agent Transcri](https://arxiv.org/abs/2607.17147)
...
### [69] [How Jailbreak Attacks Inform Safety Alignment: A Defender-Centric, Shapley-Based Evaluation of Jailbreak Contributions](https://arxiv.org/abs/2607.17152)
...
### [70] [Fast and Private Max-Sum Diversification](https://arxiv.org/abs/2607.17196)
...
### [71] [SpexPay: A Privacy-Preserving Pay-As-You-Go System for Dynamic Spectrum Sharing](https://arxiv.org/abs/2607.17218)
...
### [72] [Between Safe Boundaries: Exploiting Temporal Consistency for Jailbreaking Text-To-Video Generation Models](https://arxiv.org/abs/2607.17279)
...
### [73] [Physical Time-Lock Puzzles](https://arxiv.org/abs/2607.17328)
...
### [74] [Measuring and Evaluating the Performance of Generative AI Models for Scam Detection](https://arxiv.org/abs/2607.17353)
...
### [75] [ShadowPickle: Evading Machine Learning Model Scanners via Stealthy Pickle Deserialization Attacks](https://arxiv.org/abs/2607.17503)
...
### [76] [Salience Induction against Multi-Hop RAG Agents: Threat and Defense](https://arxiv.org/abs/2607.17535)
...
### [77] [(A)iSpy: Parasitic Trojans for Machine Learning Infrastructure](https://arxiv.org/abs/2607.17550)
...
### [78] [Quantum-Resilient Banking Transaction Security using DW-HKEM: A Hybrid RSA/ML-KEM Cryptographic Gateway with Real-Time](https://arxiv.org/abs/2607.17573)
...
### [79] [Detection, Attribution, Narration: An End-to-End Pipeline for Explainable Money Mule Identification](https://arxiv.org/abs/2607.17586)
...
### [80] [Protecting Floating-Point Computation for DNN Binaries with MBA Obfuscation](https://arxiv.org/abs/2607.17603)
...
### [81] [Insecure Coding Preferences in Long-Term Memory: Security Risks for LLM-based Code Generation](https://arxiv.org/abs/2607.17619)
...
### [82] [Residual Observability and Attack Detectability in Encrypted OPC UA Traffic](https://arxiv.org/abs/2607.17809)
...
### [83] [Rate-Distortion Function for Encrypted Traffic Side-Channel Defense](https://arxiv.org/abs/2607.17889)
...
### [84] [RT-SHCUA: Real-Time Self-Hosted Computer-Use Agent for UAV Control](https://arxiv.org/abs/2607.17951)
...
### [85] [Self-State Attacks on Self-Hosted AI Agents: How Far Can OS Defenses Go?](https://arxiv.org/abs/2607.17986)
...
### [86] [Adaptive Adversaries: A Multi-Turn, Multi-LLM Benchmark for LLM Agent Security](https://arxiv.org/abs/2607.18063)
...
### [87] [GARAGE: Characterizing the Automation Boundary in LLM-based Attack Graph Generation](https://arxiv.org/abs/2607.18108)
...
### [88] [RRAM-DP: Device-Calibrated Differential Privacy for In-Memory Edge Learning](https://arxiv.org/abs/2607.18169)
