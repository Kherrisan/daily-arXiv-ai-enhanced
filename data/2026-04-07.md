...
### [1] [SDVDiag: Using Context-Aware Causality Mining for the Diagnosis of Connected Vehicle Functions](https://arxiv.org/abs/2604.03391)
...
### [2] [Android Instrumentation Testing in Continuous Integration: Practices, Patterns, and Performance](https://arxiv.org/abs/2604.03438)
...
### [3] [Agile Story-Point Estimation: Is RAG a Better Way to Go?](https://arxiv.org/abs/2604.03443)
...
### [4] [Measuring LLM Trust Allocation Across Conflicting Software Artifacts](https://arxiv.org/abs/2604.03447)
...
### [5] [Inside the Scaffold: A Source-Code Taxonomy of Coding Agent Architectures](https://arxiv.org/abs/2604.03515)
*Benjamin Rombaut*
...
### [6] [AgenticFlict: A Large-Scale Dataset of Merge Conflicts in AI Coding Agent Pull Requests on GitHub](https://arxiv.org/abs/2604.03551)
...
### [7] [From UI to Code: Mobile Ads Detection via LLM-Unified Static-Dynamic Analysis](https://arxiv.org/abs/2604.03561)
...
### [8] [DebugHarness: Emulating Human Dynamic Debugging for Autonomous Program Repair](https://arxiv.org/abs/2604.03610)
...
### [9] [Toward Executable Repository-Level Code Generation via Environment Alignment](https://arxiv.org/abs/2604.03622)
...
### [10] [Persistent Cross-Attempt State Optimization for Repository-Level Code Generation](https://arxiv.org/abs/2604.03632)
...
### [11] [Automata Learning versus Process Mining: The Case for User Journeys](https://arxiv.org/abs/2604.03686)
...
### [12] [AutoReSpec: A Framework for Generating Specification using Large Language Models](https://arxiv.org/abs/2604.03758)
...
### [13] [The Last APK: Retiring Android SDK Development for Institutional Software Using Python-Django, HTMX, and a WebView Bridge](https://arxiv.org/abs/2604.03808)
*Rahul Patel*
...
### [14] [Context Matters: Evaluating Context Strategies for Automated ADR Generation Using LLMs](https://arxiv.org/abs/2604.03826)
...
### [15] [Mapping GitHub Sponsorships: A Longitudinal Observatory for Open-Source Sustainability](https://arxiv.org/abs/2604.03846)
...
### [16] [Beyond Crash-to-Patch: Patch Evolution for Linux Kernel Repair](https://arxiv.org/abs/2604.03851)
...
### [17] [COBOLAssist: Analyzing and Fixing Compilation Errors for LLM-Powered COBOL Code Generation](https://arxiv.org/abs/2604.03978)
...
### [18] [COBOL-Coder: Domain-Adapted Large Language Models for COBOL Code Generation and Translation](https://arxiv.org/abs/2604.03986)
*Anh T. V. Dau,Shin Hwei Tan,Jinqiu Yang,Nghi D. Q. Bui,Anh Tuan Nguyen*
...
### [19] [Benchmarking and Evaluating VLMs for Software Architecture Diagram Understanding](https://arxiv.org/abs/2604.04009)
...
### [20] [SmartPatchLinker: An Open-Source Tool to Linked Changes Detection for Code Review](https://arxiv.org/abs/2604.04045)
...
### [21] [Software Testing Beyond Closed Worlds: Open-World Games as an Extreme Case](https://arxiv.org/abs/2604.04047)
...
### [22] [Humans Integrate, Agents Fix: How Agent-Authored Pull Requests Are Referenced in Practice](https://arxiv.org/abs/2604.04059)
*Islem Khemissi,Moataz Chouchen,Dong Wang,Raula Gaikovina Kula*
...
### [23] [Toward a Sustainable Software Architecture Community: Evaluating ICSA's Environmental Impact](https://arxiv.org/abs/2604.04096)
...
### [24] [ENCRUST: Encapsulated Substitution and Agentic Refinement on a Live Scaffold for Safe C-to-Rust Translation](https://arxiv.org/abs/2604.04527)
...
### [25] [Beyond Fixed Tests: Repository-Level Issue Resolution as Coevolution of Code and Behavioral Constraints](https://arxiv.org/abs/2604.04580)
...
### [26] [MIRAGE: Online LLM Simulation for Microservice Dependency Testing](https://arxiv.org/abs/2604.04806)
*XinRan Zhang*
...
### [27] [A Validated Taxonomy on Software Energy Smells](https://arxiv.org/abs/2604.04809)
...
### [28] [SysTradeBench: An Iterative Build-Test-Patch Benchmark for Strategy-to-Code Trading Systems with Drift-Aware Diagnostics](https://arxiv.org/abs/2604.04812)
...
### [29] [Assessing Large Language Models for Stabilizing Numerical Expression in Scientific Software](https://arxiv.org/abs/2604.04854)
...
### [30] [StatsClaw: An AI-Collaborative Workflow for Statistical Software Development](https://arxiv.org/abs/2604.04871)
...
### [31] [AICCE: AI Driven Compliance Checker Engine](https://arxiv.org/abs/2604.03330)
...
### [32] [Design and Implementation of an Open-Source Security Framework for Cloud Infrastructure](https://arxiv.org/abs/2604.03331)
*Wanru Shao*
...
### [33] [Security Analysis of Universal Circuits as a Mechanism for Hardware Obfuscation](https://arxiv.org/abs/2604.03396)
...
### [34] [AEGIS: Scaling Long-Sequence Homomorphic Encrypted Transformer Inference via Hybrid Parallelism on Multi-GPU Systems](https://arxiv.org/abs/2604.03425)
...
### [35] [CIPHR: Cryptography Inspired IP Protection through Fine-Grain Hardware Redaction](https://arxiv.org/abs/2604.03560)
...
### [36] [SecPI: Secure Code Generation with Reasoning Models via Security Reasoning Internalization](https://arxiv.org/abs/2604.03587)
...
### [37] [ProtoGuard-SL: Prototype Consistency Based Backdoor Defense for Vertical Split Learning](https://arxiv.org/abs/2604.03595)
...
### [40] [A Faceted Classification of Authenticator-Centric Authentication Techniques](https://arxiv.org/abs/2604.03627)
...
### [41] [Explainable PQC: A Layered Interpretive Framework for Post-Quantum Cryptographic Security Assumptions](https://arxiv.org/abs/2604.03665)
...
### [42] [CREBench: Evaluating Large Language Models in Cryptographic Binary Reverse Engineering](https://arxiv.org/abs/2604.03750)
...
### [43] [Spatiotemporal-Aware Bit-Flip Injection on DNN-based Advanced Driver Assistance Systems](https://arxiv.org/abs/2604.03753)
...
### [44] [Partial Number Theoretic Transform Masking in Post Quantum Cryptography Hardware: A Security Margin Analysis](https://arxiv.org/abs/2604.03813)
...
### [45] [Explainability-Guided Adversarial Attacks on Transformer-Based Malware Detectors Using Control Flow Graphs](https://arxiv.org/abs/2604.03843)
...
### [46] [Safety and Liveness of Cross-Domain State Preservation under Byzantine Faults: A Mechanized Proof in Isabelle/HOL](https://arxiv.org/abs/2604.03844)
*Jinwook Kim*
...
### [47] [Defending Buffer Overflows in WebAssembly: A Transpiler Approach](https://arxiv.org/abs/2604.03859)
*Weiqi Feng*
...
### [48] [LiquiLM: Bridging the Semantic Gap in Liquidity Flaw Audit via DCN and LLMs](https://arxiv.org/abs/2604.03860)
...
### [49] [SecureAFL: Secure Asynchronous Federated Learning](https://arxiv.org/abs/2604.03862)
...
### [50] [Graduated Trust Gating for IoT Location Verification: Trading Off Detection and Proof Escalation](https://arxiv.org/abs/2604.03896)
*Yoshiyuki Ootani*
...
### [51] [Context-Binding Gaps in Stateful Zero-Knowledge Proximity Proofs: Taxonomy, Separation, and Mitigation](https://arxiv.org/abs/2604.03900)
*Yoshiyuki Ootani*
...
### [52] [Search-Bound Proximity Proofs: Binding Encrypted Geographic Search to Zero-Knowledge Verification](https://arxiv.org/abs/2604.03902)
*Yoshiyuki Ootani*
...
### [53] [Improving ML Attacks on LWE with Data Repetition and Stepwise Regression](https://arxiv.org/abs/2604.03903)
...
### [54] [Automating Cloud Security and Forensics Through a Secure-by-Design Generative AI Framework](https://arxiv.org/abs/2604.03912)
...
### [55] [TraceGuard: Structured Multi-Dimensional Monitoring as a Collusion-Resistant Control Protocol](https://arxiv.org/abs/2604.03968)
...
### [56] [Assessing Cyber Risks in Hydropower Systems Through HAZOP and Bow-Tie Analysis](https://arxiv.org/abs/2604.03994)
...
### [57] [Enabling Deterministic User-Level Interrupts in Real-Time Processors via Hardware Extension](https://arxiv.org/abs/2604.04015)
...
### [58] [Jellyfish: Zero-Shot Federated Unlearning Scheme with Knowledge Disentanglement](https://arxiv.org/abs/2604.04030)
...
### [59] [Causality Laundering: Denial-Feedback Leakage in Tool-Calling LLM Agents](https://arxiv.org/abs/2604.04035)
...
### [60] [Triggering and Detecting Exploitable Library Vulnerability from the Client by Directed Greybox Fuzzing](https://arxiv.org/abs/2604.04102)
...
### [61] [CoopGuard: Stateful Cooperative Agents Safeguarding LLMs Against Evolving Multi-Round Attacks](https://arxiv.org/abs/2604.04060)
...
### [62] [LLM-Enabled Open-Source Systems in the Wild: An Empirical Study of Vulnerabilities in GitHub Security Advisories](https://arxiv.org/abs/2604.04288)
...
### [63] [Styx: Collaborative and Private Data Processing With TEE-Enforced Sticky Policy](https://arxiv.org/abs/2604.04082)
...
### [64] [Poisoned Identifiers Survive LLM Deobfuscation: A Case Study on Claude Opus 4.6](https://arxiv.org/abs/2604.04289)
*Luis Guzmán Lorenzo*
...
### [65] [Invisible Adversaries: A Systematic Study of Session Manipulation Attacks on VPNs](https://arxiv.org/abs/2604.04099)
...
### [66] [Bridging Safety and Security in Complex Systems: A Model-Based Approach with SAFT-GT Toolchain](https://arxiv.org/abs/2604.04705)
...
### [67] [NetSecBed: A Container-Native Testbed for Reproducible Cybersecurity Experimentation](https://arxiv.org/abs/2604.04121)
...
### [68] [Beamforming Feedback as a Novel Attack Surface for Wi-Fi Physical-Layer Security](https://arxiv.org/abs/2604.04179)
...
### [69] [Merkle Tree Certificate Post-Quantum PKI for Kubernetes and Cloud-Native 5G/B5G Core](https://arxiv.org/abs/2604.04191)
...
### [70] [Perils of Parallelism: Transaction Fee Mechanisms under Execution Uncertainty](https://arxiv.org/abs/2604.04193)
...
### [71] [LOCARD: An Agentic Framework for Blockchain Forensics](https://arxiv.org/abs/2604.04211)
...
### [72] [Governance-Constrained Agentic AI: Blockchain-Enforced Human Oversight for Safety-Critical Wildfire Monitoring](https://arxiv.org/abs/2604.04265)
...
### [73] [Semantics Over Syntax: Uncovering Pre-Authentication 5G Baseband Vulnerabilities](https://arxiv.org/abs/2604.04283)
...
### [74] [Evaluating Future Air Traffic Management Security](https://arxiv.org/abs/2604.04293)
*Konstantinos Spalas*
...
### [75] [DAO to (Anonymous) DAO Transactions](https://arxiv.org/abs/2604.04369)
...
### [76] [Explainable Autonomous Cyber Defense using Adversarial Multi-Agent Reinforcement Learning](https://arxiv.org/abs/2604.04442)
...
### [77] [Mapping the Exploitation Surface: A 10,000-Trial Taxonomy of What Makes LLM Agents Exploit Vulnerabilities](https://arxiv.org/abs/2604.04561)
...
### [78] [Digital Privacy in IoT: Exploring Challenges, Approaches and Open Issues](https://arxiv.org/abs/2604.04572)
...
### [79] [Packing Entries to Diagonals for Homomorphic Sparse-Matrix Vector Multiplication](https://arxiv.org/abs/2604.04683)
...
### [80] [GPIR: Enabling Practical Private Information Retrieval with GPUs](https://arxiv.org/abs/2604.04696)
...
### [81] [Hardware-Level Governance of AI Compute: A Feasibility Taxonomy for Regulatory Compliance and Treaty Verification](https://arxiv.org/abs/2604.04712)
*Samar Ansari*
...
### [82] [Economic Security of VDF-Based Randomness Beacons: Models, Thresholds, and Design Guidelines](https://arxiv.org/abs/2604.04744)
...
### [83] [RegGuard: Legitimacy and Fairness Enforcement for Optimistic Rollups](https://arxiv.org/abs/2604.04748)
...
### [84] [Undetectable Conversations Between AI Agents via Pseudorandom Noise-Resilient Key Exchange](https://arxiv.org/abs/2604.04757)
...
### [85] [Your Agent, Their Asset: A Real-World Safety Analysis of OpenClaw](https://arxiv.org/abs/2604.04759)
...
### [86] [GPU Acceleration of TFHE-Based High-Precision Nonlinear Layers for Encrypted LLM Inference](https://arxiv.org/abs/2604.04783)
...
### [87] [Unpacking .zip: A First Look at Domain and File Name Confusion](https://arxiv.org/abs/2604.04805)
...
### [88] [Cryptanalysis of the Legendre Pseudorandom Function over Extension Fields](https://arxiv.org/abs/2604.04833)
*Daksh Pandey*
...
### [89] [Strengthening Human-Centric Chain-of-Thought Reasoning Integrity in LLMs via a Structured Prompt Framework](https://arxiv.org/abs/2604.04852)
...
### [90] [Comprehensive List of User Deception Techniques in Emails](https://arxiv.org/abs/2604.04926)
