...
### [14] [JailMeter: An Evidence-Based Evaluation Framework for Jailbreak Attacks on Large Language Models](https://arxiv.org/abs/2607.19424)
...
### [15] [ChannelGuard: Safe Models Do Not Compose into Safe Multi-Agent Systems](https://arxiv.org/abs/2607.19430)
...
### [16] [ChainWatch: A Kill Chain-Aligned Sequential Detection Framework for Multi-Step Attacks in MCP-Based AI Agent Systems](https://arxiv.org/abs/2607.19432)
...
### [17] [Building Trust in Autonomous Commerce: A Verifiable Global Event Timeline and AI-Ready Fraud Intelligence Layer](https://arxiv.org/abs/2607.19436)
*Rajat Srivastava*
...
### [18] [Intelligent Disruption: Undetectable Attacks on Wireless Autoencoders](https://arxiv.org/abs/2607.19448)
...
### [19] [Integrity of peer-to-peer distributed LLM inference under malicious nodes](https://arxiv.org/abs/2607.19490)
...
### [20] [When HTTP 402 Meets the Blockchain: Risks on Emerging x402 Payments](https://arxiv.org/abs/2607.19545)
...
### [21] [Examining User Behavior and Cognitive Biases in Personal Password Security](https://arxiv.org/abs/2607.19586)
...
### [22] [Twin Agent: Context Residual Compression for Privilege Separated Agents](https://arxiv.org/abs/2607.19595)
...
### [23] [FedLSG: LLM-Enhanced Semantic Calibration for Federated Graph Backdoor Defense](https://arxiv.org/abs/2607.19674)
...
### [24] [GhostPrompt: Cross-Image Adversarial Prompt for Vision-Language Models](https://arxiv.org/abs/2607.19683)
...
### [25] [An Automated Framework for Extracting Reachable Attack Chains from Cyber Threat Intelligence Reports](https://arxiv.org/abs/2607.19742)
...
### [26] [DARWIN: Evolving Jailbreak Adversary and Guardrail for LLM Safety Evaluation and Protection](https://arxiv.org/abs/2607.19829)
...
### [27] [Defense Against LLM Backdoors using Critical Neuron Isolation Pruning](https://arxiv.org/abs/2607.19894)
...
### [28] [HijackKV: New Threat in Position-Independent KV Cache Reuse](https://arxiv.org/abs/2607.19957)
...
### [29] [Taming the Security-Energy Paradox: A Green AI Approach to Optimized Android Malware Detection](https://arxiv.org/abs/2607.20003)
...
### [30] [Small, Free, and Effective: Orchestrating Open-Weight Small Language Models to Outperform Single LLM for Malware Analysis](https://arxiv.org/abs/2607.20216)
...
### [31] [The Ethics of Autonomous AI Agents for Offensive Security](https://arxiv.org/abs/2607.20255)
...
### [32] [Chained Attacks on Drone-Based Federated Learning: From Network Disruption to Device Impersonation](https://arxiv.org/abs/2607.20280)
...
### [33] [Constant-time decoding of Gabidulin codes and their generalizations with application to RQC](https://arxiv.org/abs/2607.20305)
