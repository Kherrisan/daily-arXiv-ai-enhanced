...
### [5] [Mise en Place for Agentic Coding: Deliberate Preparation as Context Engineering Methodology](https://arxiv.org/abs/2605.05400)
*Andrew Zigler*
...
### [7] [Operationalizing Ethics for AI Agents: How Developers Encode Values into Repository Context Files](https://arxiv.org/abs/2605.05584)
...
### [8] [An Empirical Study of Proactive Coding Assistants in Real-World Software Development](https://arxiv.org/abs/2605.05700)
...
### [9] [From Chat to Interview: Agentic Requirements Elicitation with an Experience Ontology](https://arxiv.org/abs/2605.05828)
...
### [10] [On Fixing Insecure AI-Generated Code through Model Fine-Tuning and Prompting Strategies](https://arxiv.org/abs/2605.05867)
...
### [11] [Evaluating Non-English Developer Support in Machine Learning for Software Engineering](https://arxiv.org/abs/2605.05902)
...
### [12] [Exploring the Effectiveness of Abstract Syntax Tree Patterns for Algorithm Recognition](https://arxiv.org/abs/2605.06098)
...
### [13] [Schedule-and-Calibrate: Utility-Guided Multi-Task Reinforcement Learning for Code LLMs](https://arxiv.org/abs/2605.06111)
...
### [14] [Breaking, Stale, or Missing? Benchmarking Coding Agents on Project-Level Test Evolution](https://arxiv.org/abs/2605.06125)
...
### [15] [BUILD-AND-FIND: An Effort-Aware Protocol for Evaluating Agent-Managed Codebases](https://arxiv.org/abs/2605.06136)
*Jhen-Ke Lin*
...
### [16] [Modeling Dependency-Propagated Ecosystem Impact of Changes in Maintenance Activities: Evaluating Support Strategies in the PyPI Network](https://arxiv.org/abs/2605.06164)
...
### [17] [Teaching LLMs Program Semantics via Symbolic Execution Traces](https://arxiv.org/abs/2605.06184)
...
### [18] [SiblingRepair: Sibling-Based Multi-Hunk Repair with Large Language Models](https://arxiv.org/abs/2605.06209)
...
### [19] [Correct Code, Vulnerable Dependencies: A Large Scale Measurement Study of LLM-Specified Library Versions](https://arxiv.org/abs/2605.06279)
...
### [20] [Constraint Decay: The Fragility of LLM Agents in Backend Code Generation](https://arxiv.org/abs/2605.06445)
...
### [21] [To What Extent Does Agent-generated Code Require Maintenance? An Empirical Study](https://arxiv.org/abs/2605.06464)
...
### [22] [Identifier-Free Code Embedding Models for Scalable Search](https://arxiv.org/abs/2605.05251)
...
### [23] [SecureMCP: A Policy-Enforced LLM Data Access Framework for AIoT Systems via Model Context Protocol](https://arxiv.org/abs/2605.05260)
...
### [24] [Differential Privacy in the Extensive-Form Bandit Problem](https://arxiv.org/abs/2605.05266)
...
### [25] [Dynamic Authorization for Knowledge-Base Agents in 6G](https://arxiv.org/abs/2605.05269)
...
### [26] [Shattering the Echo Chamber: Hidden Safeguards in Manuscripts Against the AI Takeover of Peer Review](https://arxiv.org/abs/2605.05271)
...
### [27] [Sealing the Audit-Runtime Gap for LLM Skills](https://arxiv.org/abs/2605.05274)
...
### [28] [A Novel Byte-Level Flow-to-Image Encoding Method for Network Intrusion Detection Systems](https://arxiv.org/abs/2605.05275)
...
### [29] [GLiNER Guard: Unified Encoder Family for Production LLM Safety and Privacy](https://arxiv.org/abs/2605.05277)
...
### [30] [Securing the Agent: Vendor-Neutral, Multitenant Enterprise Retrieval and Tool Use](https://arxiv.org/abs/2605.05287)
...
### [31] [How Far Are VLMs from Privacy Awareness in the Physical World? An Empirical Study](https://arxiv.org/abs/2605.05340)
...
### [32] [Evolution of Log-Based Detection Rules in Public Repositories](https://arxiv.org/abs/2605.05383)
...
### [33] [Evaluating the Reliability of Multiple Large Language Models in Risk Assessment: A CIS Controls Based Approach](https://arxiv.org/abs/2605.05424)
...
### [34] [Privacy Without Losing Place: A Paradigm for Private Retrieval in Spatial RAGs](https://arxiv.org/abs/2605.05459)
...
### [35] [SOCpilot: Verifying Policy Compliance for LLM-Assisted Incident Response](https://arxiv.org/abs/2605.05501)
...
### [36] [WAAA! Web Adversaries Against Agentic Browsers](https://arxiv.org/abs/2605.05509)
...
### [37] [Age Verification in the Web -- Holy Grail to Control Access to Restricted Content](https://arxiv.org/abs/2605.05513)
...
### [38] [Beyond Collection: Measuring the Detection Efficacy of Modern Security Logging Standards](https://arxiv.org/abs/2605.05531)
...
### [39] [Architecture Matters: Comparing RAG Systems under Knowledge Base Poisoning](https://arxiv.org/abs/2605.05632)
*Samuel Korn*
...
### [40] [AoI-Guided Client Selection for Robust and Timely Federated Intrusion Detection in Cloud-Edge Security Analytics](https://arxiv.org/abs/2605.05644)
*Chun Yin Chiu*
...
### [41] [SafeHarbor: Hierarchical Memory-Augmented Guardrail for LLM Agent Safety](https://arxiv.org/abs/2605.05704)
...
### [42] [$α$-Wasserstein Mechanism for Rényi Pufferfish Privacy](https://arxiv.org/abs/2605.05723)
...
### [43] [SuperPaymaster: Eliminating Centralized Signer Authority via Asset-Oriented Abstraction to Reconcile Usability and Decentralization in Account Abstraction](https://arxiv.org/abs/2605.05774)
...
### [44] [Stego Battlefield: Evaluating Image Steganography Attacks and Steganalysis Defenses](https://arxiv.org/abs/2605.05789)
...
### [45] [LCC-LLM: Leveraging Code-Centric Large Language Models for Malware Attribution](https://arxiv.org/abs/2605.05807)
...
### [46] [LeakDojo: Decoding the Leakage Threats of RAG Systems](https://arxiv.org/abs/2605.05818)
...
### [47] [LoopTrap: Termination Poisoning Attacks on LLM Agents](https://arxiv.org/abs/2605.05846)
...
### [48] [SkillScope: Toward Fine-Grained Least-Privilege Enforcement for Agent Skills](https://arxiv.org/abs/2605.05868)
...
### [49] [ActiveFlowMark: Assessing Tor Anonymity under Active Bandwidth Watermarking](https://arxiv.org/abs/2605.05887)
...
### [50] [Heimdallr: Characterizing and Detecting LLM-Induced Security Risks in GitHub CI Workflows](https://arxiv.org/abs/2605.05969)
...
### [51] [Toward Space-Based Public Key Systems: Enabling Secure Space Communications through In-Orbit Trust Services](https://arxiv.org/abs/2605.05948)
...
### [52] [PragLocker: Protecting Agent Intellectual Property in Untrusted Deployments via Non-Portable Prompts](https://arxiv.org/abs/2605.05974)
...
### [53] [Safety Anchor: Defending Harmful Fine-tuning via Geometric Bottlenecks](https://arxiv.org/abs/2605.05995)
...
### [54] [Secure Seed-Based Multi-bit Watermarking for Diffusion Models from First Principles](https://arxiv.org/abs/2605.06153)
...
### [55] [Stateful Agent Backdoor](https://arxiv.org/abs/2605.06158)
...
### [56] [ClawGuard: Out-of-Band Detection of LLM Agent Workflow Hijacking via EM Side Channel](https://arxiv.org/abs/2605.06205)
...
### [57] [Profiling for Pennies: Unveiling the Privacy Iceberg of LLM Agents](https://arxiv.org/abs/2605.06232)
...
### [58] [Fine-Tuning Small Language Models for Solution-Oriented Windows Event Log Analysis](https://arxiv.org/abs/2605.06330)
...
### [59] [Constraining Host-Level Abuse in Self-Hosted Computer-Use Agents via TEE-Backed Isolation](https://arxiv.org/abs/2605.06393)
...
### [60] [Pop Quiz Attack: Black-box Membership Inference Attacks Against Large Language Models](https://arxiv.org/abs/2605.06423)
...
### [61] [Autonomous Adversary: Red-Teaming in the age of LLM](https://arxiv.org/abs/2605.06486)
...
### [62] [Privacy by Postprocessing the Discrete Laplace Mechanism](https://arxiv.org/abs/2605.06502)
...
### [63] [On the Security of Research Artifacts](https://arxiv.org/abs/2605.06508)
...
### [64] [FedAttr: Towards Privacy-preserving Client-Level Attribution in Federated LLM Fine-tuning](https://arxiv.org/abs/2605.06596)
...
### [65] [Patch2Vuln: Agentic Reconstruction of Vulnerabilities from Linux Distribution Binary Patches](https://arxiv.org/abs/2605.06601)
