...
### [7] [An Event-Driven Tool for Context-Aware Code Smell Detection Using SmellDSL](https://arxiv.org/abs/2605.20675)
...
### [8] [BioDefect: The First Dataset for Defect Detection in Bioinformatics Software](https://arxiv.org/abs/2605.20788)
...
### [9] [Beyond the Tip of the Iceberg: Understanding SATD in Dockerfiles through the Lens of Co-evolution](https://arxiv.org/abs/2605.21238)
...
### [10] [Transforming Privacy Artifacts into Accessible Reports for Non-Technical Stakeholders](https://arxiv.org/abs/2605.21269)
...
### [11] [RSE of a Quantum Transport Code and its Effects](https://arxiv.org/abs/2605.21334)
...
### [12] [Validating Navmesh using Geometry: Voxel-Based Analysis with Prioritized Exploration](https://arxiv.org/abs/2605.21397)
...
### [13] [Stdlib or Third-Party? Empirical Performance and Correctness of LLM-Assisted Zero-Dependency Python Libraries](https://arxiv.org/abs/2605.21405)
...
### [14] [Agentic Model Checking](https://arxiv.org/abs/2605.21434)
...
### [15] [Quality and Security Signals in AI-Generated Python Refactoring Pull Requests](https://arxiv.org/abs/2605.21453)
...
### [16] [Artificial Pancreas Implantables -- How Healthcare Professionals May Deal With DIY Bio Cases](https://arxiv.org/abs/2605.20208)
...
### [17] [Adaptive Probe-based Steering for Robust LLM Jailbreaking](https://arxiv.org/abs/2605.20286)
...
### [18] [Pramana: A Protocol-Layer Treatment of Claim Verification in Autonomous Agent Networks](https://arxiv.org/abs/2605.20312)
...
### [19] [Security Document Classification with a Fine-Tuned Local Large Language Model: Benchmark Data and an Open-Source System](https://arxiv.org/abs/2605.20368)
*Ivan Dobrovolskyi*
...
### [20] [Latent Geometry as a Structural Monitor: Eigenspace Alignment for Anomaly Detection in Anonymity Networks](https://arxiv.org/abs/2605.20391)
*Vaibhav Chhabra*
...
### [21] [Detecting Data Exfiltration through I2P Anonymity Networks: A Two-Phase Machine Learning Approach](https://arxiv.org/abs/2605.20546)
...
### [22] [Trusted Weights, Treacherous Optimizations? Optimization-Triggered Backdoor Attacks on LLMs](https://arxiv.org/abs/2605.20641)
...
### [23] [Heartbeat-Bound Hierarchical Credentials: Cryptographic Revocation for AI Agent Swarms](https://arxiv.org/abs/2605.20704)
*Saurabh Deochake*
...
### [24] [Rethinking Fraud Safety Evaluation: Multi-Round Attacks Reveal Safety-Utility Tradeoffs in Graph-Context LLM Defenders](https://arxiv.org/abs/2605.20759)
...
### [25] [GenAI-Driven Threat Detection with Microsoft Security Copilot](https://arxiv.org/abs/2605.20896)
...
### [26] [An IoT-Enabled Smart Home Automation System for Energy Efficiency with Web-Based Control](https://arxiv.org/abs/2605.20981)
...
### [27] [Domijn: The Security of Domain Registrars and the Risk of a Domain Name Takeover](https://arxiv.org/abs/2605.20984)
...
### [28] [Verifiable Provenance and Watermarking for Generative AI: An Evidentiary Framework for International Operational Law and Domestic Courts](https://arxiv.org/abs/2605.21002)
...
### [29] [An Evidence-driven Protocol for Trustworthy CI Pipelines](https://arxiv.org/abs/2605.21089)
...
### [30] [Image Encryption via Data-Identified Discrete Chaotic Maps](https://arxiv.org/abs/2605.21118)
...
### [31] [Detecting Trojaned DNNs via Spectral Regression Analysis](https://arxiv.org/abs/2605.21146)
...
### [32] [Information Leakage Envelopes](https://arxiv.org/abs/2605.21185)
...
### [33] [Profiling User Vulnerability to Phishing Through Psychological and Behavioral Factors](https://arxiv.org/abs/2605.21246)
...
### [34] [Onion-Routed Multi-Circuit Key Establishment for Quantum-Resilient Sessions](https://arxiv.org/abs/2605.21349)
...
### [35] [Auditing Apple's DifferentialPrivacy.framework: Implementation Bugs, Misconfigurations, and Practical Risks](https://arxiv.org/abs/2605.21378)
...
### [36] [VIPER-MCP: Detecting and Exploiting Taint-Style Vulnerabilities in Model Context Protocol Servers](https://arxiv.org/abs/2605.21392)
