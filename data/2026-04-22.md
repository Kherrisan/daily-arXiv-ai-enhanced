...
### [15] [On Reasoning-Centric LLM-based Automated Theorem Proving](https://arxiv.org/abs/2604.19558)
...
### [16] [Predictive Autoscaling for Node.js on Kubernetes: Lower Latency, Right-Sized Capacity](https://arxiv.org/abs/2604.19705)
...
### [17] [PlayCoder: Making LLM-Generated GUI Code Playable](https://arxiv.org/abs/2604.19742)
...
### [18] [Global Web, Local Privacy? An International Review of Web Tracking](https://arxiv.org/abs/2604.18633)
...
### [19] [Position: No Retroactive Cure for Infringement during Training](https://arxiv.org/abs/2604.18649)
...
### [20] [From Craft to Kernel: A Governance-First Execution Architecture and Semantic ISA for Agentic Computers](https://arxiv.org/abs/2604.18652)
...
### [21] [Owner-Harm: A Missing Threat Model for AI Agent Safety](https://arxiv.org/abs/2604.18658)
...
### [22] [Evaluating Answer Leakage Robustness of LLM Tutors against Adversarial Student Attacks](https://arxiv.org/abs/2604.18660)
...
### [23] [Beyond Explicit Refusals: Soft-Failure Attacks on Retrieval-Augmented Generation](https://arxiv.org/abs/2604.18663)
...
### [24] [Beyond Indistinguishability: Measuring Extraction Risk in LLM APIs](https://arxiv.org/abs/2604.18697)
...
### [25] [TrEEStealer: Stealing Decision Trees via Enclave Side Channels](https://arxiv.org/abs/2604.18716)
...
### [26] [Towards Optimal Agentic Architectures for Offensive Security Tasks](https://arxiv.org/abs/2604.18718)
...
### [27] [Blockchain-Driven AI-Enhanced Post-Quantum Multivariate Identity-based Signature and Privacy-Preserving Data Aggregation Scheme for Fog-enabled Flying Ad-Hoc Networks](https://arxiv.org/abs/2604.18819)
...
### [28] [Temporal UI State Inconsistency in Desktop GUI Agents: Formalizing and Defending Against TOCTOU Attacks on Computer-Use Agents](https://arxiv.org/abs/2604.18860)
*Wenpeng Xu*
...
### [29] [SAGE: Signal-Amplified Guided Embeddings for LLM-based Vulnerability Detection](https://arxiv.org/abs/2604.19031)
...
### [30] [Refute-or-Promote: An Adversarial Stage-Gated Multi-Agent Review Methodology for High-Precision LLM-Assisted Defect Discovery](https://arxiv.org/abs/2604.19049)
*Abhinav Agarwal*
...
### [31] [CHRONOS: A Hardware-Assisted Phase-Decoupled Framework for Secure Federated Learning in IoT](https://arxiv.org/abs/2604.19053)
*Hung Dang*
...
### [32] [ProjLens: Unveiling the Role of Projectors in Multimodal Model Safety](https://arxiv.org/abs/2604.19083)
...
### [33] [Dual-Guard: Dual-Channel Latent Watermarking for Provenance and Tamper Localization in Diffusion Images](https://arxiv.org/abs/2604.19090)
...
### [34] [DP-FlogTinyLLM: Differentially private federated log anomaly detection using Tiny LLMs](https://arxiv.org/abs/2604.19118)
...
### [35] [Sherpa.ai Privacy-Preserving Multi-Party Entity Alignment without Intersection Disclosure for Noisy Identifiers](https://arxiv.org/abs/2604.19219)
...
### [36] [Secure Storage and Privacy-Preserving Scanpath Comparison via Garbled Circuits in Eye Tracking](https://arxiv.org/abs/2604.19422)
...
### [37] [Malicious ML Model Detection by Learning Dynamic Behaviors](https://arxiv.org/abs/2604.19438)
...
### [38] [Involuntary In-Context Learning: Exploiting Few-Shot Pattern Completion to Bypass Safety Alignment in GPT-5.4](https://arxiv.org/abs/2604.19461)
...
### [39] [API Security Based on Automatic OpenAPI Mapping](https://arxiv.org/abs/2604.19471)
...
### [40] [EvoPatch-IoT: Evolution-Aware Cross-Architecture Vulnerability Retrieval and Patch-State Profiling for BusyBox-Based IoT Firmware](https://arxiv.org/abs/2604.19496)
...
### [41] [Evaluating LLM-Generated Obfuscated XSS Payloads for Machine Learning-Based Detection](https://arxiv.org/abs/2604.19526)
...
### [43] [Adding Compilation Metadata To Binaries To Make Disassembly Decidable](https://arxiv.org/abs/2604.19628)
...
### [44] [An AI Agent Execution Environment to Safeguard User Data](https://arxiv.org/abs/2604.19657)
...
### [45] ["We are currently clean on OPSEC": Why JD Can't Encrypt](https://arxiv.org/abs/2604.19711)
