...
### [28] [AnyPoC: Universal Proof-of-Concept Test Generation for Scalable LLM-Based Bug Detection](https://arxiv.org/abs/2604.11950)
...
### [29] [GitFarm: Git as a Service for Large-Scale Monorepos](https://arxiv.org/abs/2604.11977)
...
### [30] [ORBIT: Guided Agentic Orchestration for Autonomous C-to-Rust Transpilation](https://arxiv.org/abs/2604.12048)
...
### [31] [Structured Safety Auditing for Balancing Code Correctness and Content Safety in LLM-Generated Code](https://arxiv.org/abs/2604.12088)
...
### [32] [Automated BPMN Model Generation from Textual Process Descriptions: A Multi-Stage LLM-Driven Approach](https://arxiv.org/abs/2604.12105)
...
### [33] [LLM-Based Automated Diagnosis Of Integration Test Failures At Google](https://arxiv.org/abs/2604.12108)
...
### [34] [Programming Language Co-Usage Patterns on Stack Overflow: Analysis of the Developer Ecosystem](https://arxiv.org/abs/2604.12123)
...
### [35] [From Plan to Action: How Well Do Agents Follow the Plan?](https://arxiv.org/abs/2604.12147)
...
### [36] [Structural Anchors and Reasoning Fragility:Understanding CoT Robustness in LLM4Code](https://arxiv.org/abs/2604.12214)
...
### [37] [Learning Project-wise Subsequent Code Edits via Interleaving Neural-based Induction and Tool-based Deduction](https://arxiv.org/abs/2604.12220)
...
### [38] [CodeSpecBench: Benchmarking LLMs for Executable Behavioral Specification Generation](https://arxiv.org/abs/2604.12268)
...
### [39] [Is Vibe Coding the Future? An Empirical Assessment of LLM Generated Codes for Construction Safety](https://arxiv.org/abs/2604.12311)
*S M Jamil Uddin*
...
### [40] [LLMs Are Not a Silver Bullet: A Case Study on Software Fairness](https://arxiv.org/abs/2604.12640)
...
### [41] [Pricing-Driven Resource Allocation in the Computing Continuum](https://arxiv.org/abs/2604.12642)
...
### [42] [Short Version of VERIFAI2026 Paper -- Learning Infused Formal Reasoning: Contract Synthesis, Artefact Reuse and Semantic Foundations](https://arxiv.org/abs/2604.12747)
...
### [43] [Evaluating LLMs Code Reasoning Under Real-World Context](https://arxiv.org/abs/2604.12881)
*Changshu Liu*
...
### [44] [CoDe-R: Refining Decompiler Output with LLMs via Rationale Guidance and Adaptive Inference](https://arxiv.org/abs/2604.12913)
...
### [45] [Personalizing LLM-Based Conversational Programming Assistants](https://arxiv.org/abs/2604.12998)
*Jonan Richards*
