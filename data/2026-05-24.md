...
### [2] [From Patches to Trajectories: Privileged Process Supervision for Software-Engineering Agents](https://arxiv.org/abs/2605.21996)
...
### [3] [Finding Missing Input Validation in TEEs via LLM-Assisted Symbolic Execution](https://arxiv.org/abs/2605.22058)
...
### [4] [Automated Repair of TEE Partitioning Issues via DSL-Guided and LLM-Assisted Patching](https://arxiv.org/abs/2605.22087)
...
### [5] [SWE-Mutation: Can LLMs Generate Reliable Test Suites in Software Engineering?](https://arxiv.org/abs/2605.22175)
...
### [6] [An Architecture for Decentralised Deployment and Operation of Blockchain Applications](https://arxiv.org/abs/2605.22239)
...
### [7] [At What Cost? Software Developers' Well-Being in the Age of GenAI](https://arxiv.org/abs/2605.22349)
...
### [8] ["Refactoring Runaway": Understanding and Mitigating Tangled Refactorings in Coding Agents for Issue Resolution](https://arxiv.org/abs/2605.22526)
...
### [9] [Why Are Agentic Pull Requests Merged or Rejected? An Empirical Study](https://arxiv.org/abs/2605.22534)
...
### [10] [Contractual Skills: A GovernSpec Design Framework for Enterprise AI Agents](https://arxiv.org/abs/2605.22634)
*Ting Liu*
...
### [11] [FAME: Failure-Aware Mixture-of-Experts for Message-Level Log Anomaly Detection](https://arxiv.org/abs/2605.22779)
...
### [12] [Autonomous LLM Agents & CTFs: A Second Look](https://arxiv.org/abs/2605.21497)
...
### [13] [Chain Reactions: How Nonce Collisions in ECDSA Compromise Polygon MEV Searchers](https://arxiv.org/abs/2605.21498)
...
### [14] [Frequency-Domain Regularized Adversarial Alignment for Transferable Attacks against Closed-Source MLLMs](https://arxiv.org/abs/2605.21541)
...
### [15] [ASSEMBLAGE-DEEPHISTORY: A Cross-Build Binary Dataset with Temporal Coverage](https://arxiv.org/abs/2605.21615)
...
### [16] [Adversarial Reframing: A Framework for Targeted Generation in Language Models](https://arxiv.org/abs/2605.21674)
...
### [17] [PocketAgents: A Manifest-Driven Library of Autonomous Defense Agents](https://arxiv.org/abs/2605.21694)
...
### [18] [HIDBench: Benchmarking Large Language Models for Host-Based Intrusion Detection](https://arxiv.org/abs/2605.21773)
...
### [19] [FuzzingBrain V2: A Multi-Agent LLM System for Automated Vulnerability Discovery and Reproduction](https://arxiv.org/abs/2605.21779)
...
### [25] [CCLab: Adversarial Testing of Learning- and Non-Learning-Based Congestion Controllers](https://arxiv.org/abs/2605.21915)
...
### [26] [Blind Spots in the Guard: How Domain-Camouflaged Injection Attacks Evade Detection in Multi-Agent LLM Systems](https://arxiv.org/abs/2605.22001)
*Aaditya Pai*
...
### [28] [Benchmarking Autonomous Agents against Temporal, Spatial, and Semantic Evasions](https://arxiv.org/abs/2605.22321)
...
### [29] [RADAR: Defending RAG Dynamically against Retrieval Corruption](https://arxiv.org/abs/2605.22041)
...
### [30] [Innovations in Cardless Artificial Intelligence Banking: A Comprehensive Framework for Cyber Secure and Fraud Mitigation using Machine Learning Algorithms](https://arxiv.org/abs/2605.22604)
*Md Israfeel*
...
### [31] [Safeguarding Text-to-Image Generative Models Against Unauthorized Knowledge Distillation](https://arxiv.org/abs/2605.22060)
...
### [32] [QT-PUF: Quantum Tunneling Leakage Based PUF for Implantable IoMT Devices](https://arxiv.org/abs/2605.22113)
...
### [33] [Adversarial Trust Poisoning in Vehicular Collaborative Perception](https://arxiv.org/abs/2605.22122)
...
### [34] [Market-Analysis-Driven Methodology for Assessing Charging Station Cybersecurity](https://arxiv.org/abs/2605.22151)
...
### [35] [Decision-Aware Quadratic ReLU Replacement for HE-Friendly Inference](https://arxiv.org/abs/2605.22237)
...
### [36] [PACT: Reducing Alert Fatigue in Low-Prevalence SOC Streams with Triggered Active Learning](https://arxiv.org/abs/2605.22324)
...
### [37] [Building Europe's Quantum Shield: The Strategic view for a Continent-Wide Quantum Key Ditribution (QKD) Infrastructure](https://arxiv.org/abs/2605.22332)
...
### [38] [A First Measurement Study on Authentication Security in Real-World Remote MCP Servers](https://arxiv.org/abs/2605.22333)
...
### [39] [TimeGuard: Channel-wise Pool Training for Backdoor Defense in Time Series Forecasting](https://arxiv.org/abs/2605.22365)
...
### [40] [Characterizing the Fault Response of the Intel Neural Compute Stick 2 Under Single-Pulse Electromagnetic Fault Injection](https://arxiv.org/abs/2605.22437)
...
### [41] [A Constant-Time Implementation Methodology for Activation Functions on Microcontrollers](https://arxiv.org/abs/2605.22441)
...
### [42] [EnCAgg: Enhanced Clustering Aggregation for Robust Federated Learning against Dynamic Model Poisoning](https://arxiv.org/abs/2605.22506)
...
### [43] [Measuring Security Without Fooling Ourselves: Why Benchmarking Agents Is Hard](https://arxiv.org/abs/2605.22568)
...
### [44] [A Formal Basis for Quantum Cryptographic Exposure Measurement under HNDL Threat](https://arxiv.org/abs/2605.22569)
...
### [45] [Building an Open Source Operational Technology Pentesting Platform: Lessons from LINICS](https://arxiv.org/abs/2605.22590)
...
### [46] [UNAD+: An Explainable Hybrid Framework for Unknown Network Attack Detection](https://arxiv.org/abs/2605.22621)
...
### [47] [TriSweep: A Four-Drone Swarm Framework for Electromagnetic Side-Channel Analysis](https://arxiv.org/abs/2605.22709)
