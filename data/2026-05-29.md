...
### [20] [Echoes within the Reasoning: Stealthy and Effective Watermarking via Chain of Thought](https://arxiv.org/abs/2605.28890)
...
### [21] [Quantum-Enhanced Adversarial Robustness in Artificial Intelligence](https://arxiv.org/abs/2605.28899)
*Jaydip Sen*
...
### [22] [AIRGuard: Guarding Agent Actions with Runtime Authority Control](https://arxiv.org/abs/2605.28914)
...
### [23] [Optimal Rates for Differentially Private Hypothesis Testing with E-values](https://arxiv.org/abs/2605.28952)
...
### [24] [A Secure, Manifest-Based Framework for Delegated Privilege Promotion](https://arxiv.org/abs/2605.28991)
...
### [25] [Measuring Real-World Prompt Injection Attacks in LLM-based Resume Screening](https://arxiv.org/abs/2605.28999)
...
### [26] [GEO-Bench: Benchmarking Ranking Manipulation in Generative Engine Optimization](https://arxiv.org/abs/2605.29107)
...
### [27] [ReasonBreak: Probing Vulnerabilities in Reasoning-Enabled Vision-Language-Action Models for Autonomous Driving](https://arxiv.org/abs/2605.29114)
...
### [28] [unix-ctf: Procedural Environments for Unix-Competence Reinforcement Learning](https://arxiv.org/abs/2605.29115)
...
### [29] [Techreport: Evaluating Tor-based Location Privacy for Ethereum Validators](https://arxiv.org/abs/2605.29131)
...
### [30] [S3C2 Summit 2025-07: Government Secure Supply Chain Summit](https://arxiv.org/abs/2605.29140)
...
### [31] [Domain-Informed Representation for Evolutionary Sieving in Integral and Module Lattices](https://arxiv.org/abs/2605.29169)
...
### [32] [EvaluatAR: A Cross-Device Evaluation Framework for Rapid Prototyping of Bystander PETs in AR](https://arxiv.org/abs/2605.29177)
...
### [33] [The Best-Laid SCHEMEs: Coordinated Sabotage and Monitoring in Multi-Agent Systems](https://arxiv.org/abs/2605.29178)
...
### [34] [SAMD: A Tool for Identifying False Data Injection Scenarios in AI/ML-enabled Medical Devices](https://arxiv.org/abs/2605.29210)
...
### [35] [S3C2 Summit 2025-09: Industry Secure Supply Chain Summit](https://arxiv.org/abs/2605.29226)
...
### [36] [Evolving Skill-Structured Attack Memory Enhances LLM Jailbreaking](https://arxiv.org/abs/2605.29237)
...
### [37] [Implicit Identity Technologies for LLMs: Fingerprinting and Watermarking across Datasets, Models, and Generated Content](https://arxiv.org/abs/2605.29245)
...
### [38] [HunterAgent: Neuro-Symbolic Attack Trace Reconstruction under Anti-Forensics](https://arxiv.org/abs/2605.29269)
...
### [39] [DeepFake Forensics AI: A Multi-Modal Detection and Blockchain-Anchored Evidence Management Platform](https://arxiv.org/abs/2605.29353)
*Naisha Minnah*
...
### [40] [Harmless Yet Harmful: Neutral Prompting Attacks for Stealthy Hallucination Steering in Agent Skills](https://arxiv.org/abs/2605.29354)
...
### [41] [AliMark: Enhancing Robustness of Sentence-Level Watermarking Against Text Paraphrasing](https://arxiv.org/abs/2605.29434)
...
### [42] [Protecting On-Device AI Inference: A Systematic Review of Attacks and Defence Mechanisms](https://arxiv.org/abs/2605.29450)
...
### [43] [Control Flow Graph Recovery for Dynamically Loaded Code via Symbolic Library Resolution](https://arxiv.org/abs/2605.29620)
*Oleksandr Mostovyi*
...
### [44] [Bridging Theory and Practice: An Executable Taxonomy of Security Properties for ProVerif and Tamarin](https://arxiv.org/abs/2605.29465)
...
### [45] [Minimal Prompt Perturbations Lead to Code Vulnerabilities: Prompt Fragility and Hidden-State Signals in Coding LLMs](https://arxiv.org/abs/2605.29737)
...
### [46] [SciIntBench: Measuring LLM Compliance with Research Integrity Norms Under Adversarial Framing](https://arxiv.org/abs/2605.29468)
...
### [47] [KBF: Knowledge Boundary as Fingerprint for Language Model and Black-Box API Auditing](https://arxiv.org/abs/2605.29524)
...
### [48] [Temporal Motif-aware Graph Test-time Adaptation for OOD Blockchain Anomaly Detection](https://arxiv.org/abs/2605.29526)
...
### [49] [LoRA-Key: User-Centric LoRA Watermarking for Text-to-Image Diffusion Models](https://arxiv.org/abs/2605.29569)
...
### [50] [Scarcity Is Not Enough: An Impossibility Result for Linear Sybil Cost Under Parallelizable Resources](https://arxiv.org/abs/2605.29651)
...
### [51] [FIDEM: A Standard-Compliant Framework for Secure Binding of MUD Profiles to IoT Devices](https://arxiv.org/abs/2605.29654)
...
### [52] [Cert-LAS: Toward Certified Model Ownership Verification for Text-to-Image Diffusion Models via Layer-Adaptive Smoothing](https://arxiv.org/abs/2605.29809)
...
### [53] [Ciphera: A Decentralised Biometric Identity Framework](https://arxiv.org/abs/2605.29868)
...
### [54] [Dissecting the Black Box: Circuit-Level Analysis of LLM Vulnerability Detection](https://arxiv.org/abs/2605.29901)
...
### [55] [Hijacking Agent Memory: Stealthy Trojan Attacks Through Conversational Interaction](https://arxiv.org/abs/2605.29960)
...
### [56] [Honeyval: A Comprehensive Evaluation Framework for LLM-powered HTTP Honeypots](https://arxiv.org/abs/2605.29963)
...
### [57] [Fingerprinting Inference Systems of Large Language Models](https://arxiv.org/abs/2605.29979)
...
### [58] [Token Inflation: How Dishonest Providers Can Overcharge for Large Language Model Usage](https://arxiv.org/abs/2605.30040)
...
### [59] [How Reliable Are AI Attackers Against a Fixed Vulnerable Target? A 400-Run Empirical Study of LLM Penetration Testing Consistency](https://arxiv.org/abs/2605.30096)
*Galip Tolga Erdem*
...
### [60] [Privacy-Enhanced Zero-Order Federated Learning via xMK-CKKS over Wireless Channels](https://arxiv.org/abs/2605.30123)
...
### [61] [Token-Level Generalization in LoRA Adapter Backdoors: Attack Characterization and Behavioral Detection](https://arxiv.org/abs/2605.30189)
*Travis Lelle*
...
### [62] [A Bayesian Approach to Membership Inference for Statistical Release](https://arxiv.org/abs/2605.30203)
...
### [63] [bpK#: Delegatable Pseudonyms And Their Applications to National eID Systems](https://arxiv.org/abs/2605.30212)
...
### [64] [DP-SAPF: Saliency-Aware Parameter Fine-tuning of Public Models for Differentially Private Image Synthesis](https://arxiv.org/abs/2605.30312)
