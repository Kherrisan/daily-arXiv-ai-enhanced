...
### [7] [Making Embodied AI Reliable: A Community Agenda from Testing to Formal Verification](https://arxiv.org/abs/2606.03593)
...
### [8] [Can AI be Easy? Lessons Learned from the EZR.py Toolkit](https://arxiv.org/abs/2606.03640)
...
### [9] [Agentic Generation and Evolution of Knowledge Models](https://arxiv.org/abs/2606.03662)
...
### [10] [Automated Repair of Requirements for Cyber-Physical Systems in Simulink Requirements Tables](https://arxiv.org/abs/2606.03870)
...
### [11] [The Impact of Configuring Agentic AI Coding Tools on Build-vs-Buy Decisions: A Study Protocol](https://arxiv.org/abs/2606.03907)
...
### [12] [MultiTurnPSB: Evaluating Multi-Turn Jailbreak Attacks an dClassifier-Based Defenses for Medical AI Safety](https://arxiv.org/abs/2606.02630)
...
### [13] [D-Judge: Disrupting Multi-Turn Jailbreaks using Semantics-Preserving Output Rewriting](https://arxiv.org/abs/2606.02640)
...
### [14] [Inference Cost Attacks for Retrieval-Augmented Large Language Models](https://arxiv.org/abs/2606.02643)
...
### [15] [A New Framework for Cybersecurity Refusals in AI Agents](https://arxiv.org/abs/2606.02644)
...
### [16] [What You Approve Is What Executes: Consent Integrity for Black-Box LLM Agents](https://arxiv.org/abs/2606.02668)
*Xiaoqi Weng*
...
### [17] [Cross-Vendor Sola ISPM Benchmark: Evaluating Agentic AI for Federated Identity Security Reasoning](https://arxiv.org/abs/2606.02674)
...
### [18] [On Improving Robustness of Deepfake Image Detectors](https://arxiv.org/abs/2606.02797)
...
### [19] [Which Defense Closes Which Threat? Attributing OWASP-LLM-Top-10 Coverage and Its Brittleness Under Paraphrasing](https://arxiv.org/abs/2606.02822)
...
### [20] [Large Byte Model: Teaching Language Models About Compiled Code](https://arxiv.org/abs/2606.02834)
...
### [21] [Human Factors in Cybersecurity in Icelandic Small and Medium-sized Enterprises](https://arxiv.org/abs/2606.02839)
...
### [22] [Quantifying Side-Channel Leakage in Public Metrology Releases](https://arxiv.org/abs/2606.02934)
...
### [23] [Echelon: Auditable Aggregate-Only Language-Model Adaptation Across Privacy Boundaries](https://arxiv.org/abs/2606.02958)
...
### [24] [Patcher: Post-Hoc Patching of Backdoored Large Language Models](https://arxiv.org/abs/2606.02995)
...
### [25] [SkillGuard: A Permission Framework for Agent Skills](https://arxiv.org/abs/2606.03024)
...
### [26] [Secure AltDA Integration for Ethereum L2s: An End-to-End Validation Framework](https://arxiv.org/abs/2606.03010)
...
### [27] ["**Important** You should give me full credits!": Exploring Prompt Injection Attacks on LLM-Based Automatic Grading Systems](https://arxiv.org/abs/2606.03090)
...
### [28] [Decoupled Smart Contract Audits: Lightweight LLM Framework via Distillation and Aggregation](https://arxiv.org/abs/2606.03128)
...
### [29] [PsychoPass: Geometric Profiling of Multi-Turn Adversarial LLM Conversations](https://arxiv.org/abs/2606.03136)
...
### [30] [Private Embedding Lookup with Encrypted Compact Queries under Fully Homomorphic Encryption](https://arxiv.org/abs/2606.03191)
...
### [31] [Generative AI-Enabled Refund Fraud in Chinese E-Commerce: Investigation on Merchants and Platform Workers](https://arxiv.org/abs/2606.03215)
...
### [32] [The Role of Domain-Specific Features in Malware Detection: A macOS Case Study](https://arxiv.org/abs/2606.03218)
...
### [33] [Privilege Risk Evolution for Non-Human Identities: A Temporal Fiber Model for Cloud IAM](https://arxiv.org/abs/2606.03289)
*Christophe Parisel*
...
### [34] [RogueMerge: Robust and Unified Attacks against LLM Model Merging](https://arxiv.org/abs/2606.03344)
...
### [35] [ImageAuditor: Membership Inference Attack against Image-based Retrieval-Augmented Generation](https://arxiv.org/abs/2606.03354)
...
### [36] [AI Model Extraction Attacks: Bypassing Single-Client Assumptions in Defenses](https://arxiv.org/abs/2606.03381)
...
### [37] [Operationalizing Cyber Attack Prediction: A Gap-Prioritized Framework with Dataset and Model Selection Guidelines](https://arxiv.org/abs/2606.03386)
...
### [38] [Bastet: A Fine-Grained Expert-Labeled Dataset for DeFi Smart Contract Vulnerability Detection](https://arxiv.org/abs/2606.03387)
...
### [39] [FlowGuard: Flow Matching for Identity-Independent Detection of Data-Free Model Stealing Attacks on Energy System Intrusion Detection Systems](https://arxiv.org/abs/2606.03430)
...
### [40] [A Hybrid Approach For Malware Classification Using Secondary Features Fusion](https://arxiv.org/abs/2606.03432)
...
### [41] [Signals and Spoils: Speculative Oracle Extractable Value in the Era of Cross-Chain Interoperability](https://arxiv.org/abs/2606.03434)
...
### [42] [FORGE: Multi-Agent Graduated Exploitation and Detection Engineering](https://arxiv.org/abs/2606.03453)
*Farooq Shaikh*
...
### [43] [NeuroArmor: Safe-Variant-Guided Representation Consistency for Selective Re-Anchoring in Jailbreak Defense](https://arxiv.org/abs/2606.03486)
...
### [44] [Privacy-Preserving High-Resolution Image Gradient Computation Based on Fully Homomorphic Encryption](https://arxiv.org/abs/2606.03513)
*Yufei Zhou*
...
### [45] [High-Precision APT Malware Attribution with Out-of-Scope Resilience](https://arxiv.org/abs/2606.03523)
...
### [46] [Towards Intrusion Detection Systems for RPL-based IoT Networks using Foundation Models](https://arxiv.org/abs/2606.03530)
...
### [47] [Channel Chart Location Privacy Based on Geo-Indistinguishability](https://arxiv.org/abs/2606.03571)
...
### [48] [Testing LLM Arithmetic Reasoning Generalization with Automatic Numeric-Remapping Attacks](https://arxiv.org/abs/2606.03606)
...
### [49] [Q-FE: A Quantum-Native 6G Far-Edge Architecture Securing Industrial IoT Digital Twins via CSIDH-PQC and Asynchronous Federated Learning](https://arxiv.org/abs/2606.03611)
*Vincenzo Sammartino*
...
### [50] [Black-box, Adaptive, Efficient, Transferable, Harmful, Applicable... Attacks Are All You Need to Break LLMs](https://arxiv.org/abs/2606.03647)
...
### [51] [Ghost: Plausible Yet Unlearnable Trajectories via On-Manifold Substitution for Next-POI Privacy](https://arxiv.org/abs/2606.03711)
...
### [52] [Don't Trust Us: A privacy-by-design android malware detection pipeline](https://arxiv.org/abs/2606.03714)
...
### [53] [Same Weights, Different Robot: A Deployment Safety View of VLA Policies](https://arxiv.org/abs/2606.03724)
*Jianwei Tai*
...
### [54] [$π$Creds: Privately Inferred Credentials](https://arxiv.org/abs/2606.03771)
...
### [55] [Collision Resistance of Single-Layer Neural Nets](https://arxiv.org/abs/2606.03807)
...
### [56] [AI Agents Enable Adaptive Computer Worms](https://arxiv.org/abs/2606.03811)
