...
### [10] [The Verifier Tax: Horizon Dependent Safety Success Tradeoffs in Tool Using LLM Agents](https://arxiv.org/abs/2603.19328)
...
### [11] [Benchmarking Post-Quantum Cryptography on Resource-Constrained IoT Devices: ML-KEM and ML-DSA on ARM Cortex-M0+](https://arxiv.org/abs/2603.19340)
*Rojin Chhetri*
...
### [12] [Automated Membership Inference Attacks: Discovering MIA Signal Computations using LLM Agents](https://arxiv.org/abs/2603.19375)
...
### [15] [Cellular Automata based Resource Efficient Maximally Equidistributed Pseudo-Random Number Generators](https://arxiv.org/abs/2603.19656)
...
### [16] [ProHunter: A Comprehensive APT Hunting System Based on Whole-System Provenance](https://arxiv.org/abs/2603.19658)
...
### [17] [LiteAtt: Secure and Seamless IoT Services Using TinyML-based Self-Attestation as a Primitive](https://arxiv.org/abs/2603.19727)
...
### [18] [From Precise to Random: A Systematic Differential Fault Analysis of the Lightweight Block Cipher Lilliput](https://arxiv.org/abs/2603.19781)
...
### [19] [Kumo: A Security-Focused Serverless Cloud Simulator](https://arxiv.org/abs/2603.19787)
...
### [20] [Text-Based Personas for Simulating User Privacy Decisions](https://arxiv.org/abs/2603.19791)
...
### [21] [Case Study: Horizontal Side-Channel Analysis Attack against Elliptic Curve Scalar Multiplication Accelerator under Laser Illumination](https://arxiv.org/abs/2603.19811)
...
### [22] [A Theory of Composable Lingos for Protocol Dialects](https://arxiv.org/abs/2603.19908)
...
### [23] [TAPAS: Efficient Two-Server Asymmetric Private Aggregation Beyond Prio(+)](https://arxiv.org/abs/2603.19949)
...
### [24] [Channel Prediction-Based Physical Layer Authentication under Consecutive Spoofing Attacks](https://arxiv.org/abs/2603.19962)
...
### [25] [Trojan's Whisper: Stealthy Manipulation of OpenClaw through Injected Bootstrapped Guidance](https://arxiv.org/abs/2603.19974)
...
### [26] [Sharing The Secret: Distributed Privacy-Preserving Monitoring](https://arxiv.org/abs/2603.20107)
...
### [27] [Evolving Jailbreaks: Automated Multi-Objective Long-Tail Attacks on Large Language Models](https://arxiv.org/abs/2603.20122)
...
### [28] [HQC Post-Quantum Cryptography Decryption with Generalized Minimum-Distance Reed-Solomon Decoder](https://arxiv.org/abs/2603.20156)
...
### [29] [Improving Generalization on Cybersecurity Tasks with Multi-Modal Contrastive Learning](https://arxiv.org/abs/2603.20181)
