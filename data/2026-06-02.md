...
### [23] [Needles at Scale: LLM-Assisted Target Selection for Windows Vulnerability Research](https://arxiv.org/abs/2606.01364)
*Michael J. Bommarito*
...
### [24] [GCVE: A Decentralized Model for Vulnerability Identification, Publication, and Operational Enrichment](https://arxiv.org/abs/2606.00856)
*Alexandre Dulaunoy*
...
### [25] [ClawHub Security Signals: When VirusTotal, Static Analysis, and SkillSpector Disagree](https://arxiv.org/abs/2606.01494)
...
### [26] [A Lightweight Hybrid MLP-Based Framework for Real-Time Phishing URL Detection Using Structural URL Features](https://arxiv.org/abs/2606.00889)
...
### [27] [Framework for Discovering GPS Spoofing Attacks in Drone Swarms](https://arxiv.org/abs/2606.00904)
...
### [28] [One (Thread) Can Keep a (PRNG) Secret, but not Two](https://arxiv.org/abs/2606.00918)
...
### [29] [Benchmarking Security Risk Detection and Verification in Open Agentic Skill Ecosystems](https://arxiv.org/abs/2606.00925)
...
### [30] [SS-ZKR: Spatial-Semantic Zero-Knowledge Routing for Privacy-Preserving Multi-Agent Collaboration](https://arxiv.org/abs/2606.00962)
*Hassan Touheed*
...
### [31] [AMP: A Vendor-Neutral Wire Format for Agent Memory Operations](https://arxiv.org/abs/2606.01138)
...
### [32] [BraveGuard: From Open-World Threats to Safer Computer-Use Agents](https://arxiv.org/abs/2606.01166)
...
### [33] [Schema-Agnostic Knowledge Graph Construction via Hybrid Ontology Discovery for Cyber Threat Intelligence](https://arxiv.org/abs/2606.01208)
...
### [34] [GPU Acceleration of Learning With Errors KEMs Using OpenACC for Post-Quantum Cryptography](https://arxiv.org/abs/2606.01211)
...
### [35] [Privacy-Preserving Smart Surveillance with Cross-Dataset Violence Detection and Decentralized Evidence Governance](https://arxiv.org/abs/2606.01225)
...
### [36] [Formal Verification of Secure Encrypted Virtualization](https://arxiv.org/abs/2606.01381)
...
### [37] [Differentially Private Datastore Generation for Retrieval-Augmented Inference](https://arxiv.org/abs/2606.01413)
...
### [38] [On the Evaluation of Spiking Neural Network Configurations for Network Intrusion Detection](https://arxiv.org/abs/2606.01442)
...
### [39] [NetVAD: Foundation-Model Representation Learning for Identifier-Free Unsupervised Intrusion Detection](https://arxiv.org/abs/2606.01452)
...
### [56] [An Empirical Study on Logging Evolution On Stack Overflow: Trends, Topics, and Challenges](https://arxiv.org/abs/2606.00118)
...
### [57] [AI-PROPELLER: Warehouse-Scale Interprocedural Code Layout Optimization with AlphaEvolve](https://arxiv.org/abs/2606.00131)
...
### [58] [Specification-Driven Development Benchmark: Security Knowledge Transition](https://arxiv.org/abs/2606.00167)
...
### [59] [How Generation Architecture Shapes Code Complexity in Multi-Agent LLM Systems: A Paired Study on HumanEval](https://arxiv.org/abs/2606.00308)
*Nazmus Ashrafi*
...
### [60] [Measuring Delivery Consistency in Practice: A DORA Extension from a Multi-Platform Release Setting](https://arxiv.org/abs/2606.00364)
...
### [61] [GitHub Copilot and Developer Productivity: An Observational Dose-Response Analysis](https://arxiv.org/abs/2606.00438)
...
### [62] [When Safe Skills Collide: Measuring Compositional Risk in Agent Skill Ecosystems](https://arxiv.org/abs/2606.00448)
...
### [63] [Sakura: An Approach for Generating Complex Tests from Natural Language Test Descriptions](https://arxiv.org/abs/2606.00530)
...
### [64] [FVSpec: Real-World Property-Based Tests as Lean Challenges](https://arxiv.org/abs/2606.01008)
...
### [65] [BenchEvolver: Frontier Task Synthesis via Solution-Centric Evolution](https://arxiv.org/abs/2606.01286)
...
### [66] [SABER: Benchmarking Operational Safety of LLM Coding Agents in Stateful Project Workspaces](https://arxiv.org/abs/2606.01317)
...
### [67] [Reducing Token Usage of State-in-Context Agents using Minification](https://arxiv.org/abs/2606.01326)
...
### [68] [Understanding Undesirable Attributes of Requirements Engineers: Insights from Practitioners](https://arxiv.org/abs/2606.01370)
...
### [69] [Bridging Requirements and Architecture: Multi-Agent Orchestration with External Knowledge and Hierarchical Memory](https://arxiv.org/abs/2606.01385)
...
### [70] [LLM Consortium for Software Design Refinement: A Controlled Experiment on Multi-Agent Collaboration Topologies](https://arxiv.org/abs/2606.01490)
...
### [71] [Overcoming Challenges in Agile and DevOps Integration: A Qualitative Study](https://arxiv.org/abs/2606.01676)
...
### [72] [Faster than the Team, Faster than the Customer: Tool Integration, Collaboration, and Organisational Lag in AI-assisted RE](https://arxiv.org/abs/2606.01772)
...
### [73] [Improving LLM-Based Go Code Review through Issue-List Generation and Context Augmentation](https://arxiv.org/abs/2606.01859)
...
### [74] [Comparing ML-Specific and General Python Code Smells Across Project Characteristics](https://arxiv.org/abs/2606.01882)
...
### [75] [Trust-Calibrated Code Review: A Participatory Design Study of Review Workflows for LLM-Generated Multi-File Changes](https://arxiv.org/abs/2606.01969)
...
### [76] [An Agentic Approach Towards Replication Package Quality Evaluation](https://arxiv.org/abs/2606.02006)
...
### [77] [Poking Around in the Dark: Why a Shared Understanding of Components Matters](https://arxiv.org/abs/2606.02442)
...
### [78] [Monitoring Agentic Systems Before They're Reliable](https://arxiv.org/abs/2606.02494)
