...
### [21] [Post-Hoc Trajectory-Risk Certification for Modular LLM-Based Security Agents](https://arxiv.org/abs/2608.05199)
*Zhenpeng Li*
...
### [22] [ASTELD: A Six-Axis Classification Framework for Autonomous AI Agents - Design, Evaluation, and an OpenClaw Case Study](https://arxiv.org/abs/2608.05201)
...
### [23] [A Survey of Adversarial Efficiency Degradation for Vision Transformer by Exploiting Input-adaptive Optimization](https://arxiv.org/abs/2608.05217)
...
### [24] [CyberBridge: Bridging the Gap Between Cybersecurity Education and Industry](https://arxiv.org/abs/2608.05231)
...
### [25] [The Hidden Life of Public Safety Communications Signals: A Comparative Security Analysis of TETRA, TETRAPOL, and P25](https://arxiv.org/abs/2608.05247)
...
### [26] [eMicro: Real-Time Multi-Hop Access Control for Microservices with eBPF](https://arxiv.org/abs/2608.05300)
...
### [27] [The Trust-Free Aggregation Layer of the Unicity Infrastructure](https://arxiv.org/abs/2608.05316)
...
### [28] [S12X Patch Diffing with QBinDiff](https://arxiv.org/abs/2608.05350)
*Ben Gardiner*
...
### [29] [Robust Context-Aware Detection of Malicious Instructions in Text](https://arxiv.org/abs/2608.05430)
...
### [30] [Quantifying Bitcoin Network Resilience Through Critical Scenario Discovery: A Dual-Layer Framework for Discovering Contentious Fork Conditions in Decentralized Consensus](https://arxiv.org/abs/2608.05461)
...
### [31] [Exploring Privacy Leakage and Data Disclosure Violations in the MacOS Application Ecosystem](https://arxiv.org/abs/2608.05474)
...
### [32] [PromptShield Home: Ambient Multimodal Prompt Injection Defense for Smart-Home Agents](https://arxiv.org/abs/2608.05495)
...
### [33] [Behavioral Residualization for Unsupervised Intrusion Detection in Automotive CAN Networks](https://arxiv.org/abs/2608.05548)
...
### [34] [A Self-Explainable Deep Architecture for Security Applications](https://arxiv.org/abs/2608.05552)
...
### [35] [When Experience Becomes Instruction: Trajectory Poisoning in Self-Evolving Agent Skill Systems](https://arxiv.org/abs/2608.05563)
...
### [36] [Detecting Safety Training Modification in Language Models via Activation Analysis](https://arxiv.org/abs/2608.05578)
*Glen Messenger*
...
### [37] [Enhancing Anomaly Resilience in Research Networks: A Large-Scale Forecasting Benchmark for Dynamic Security Baselining](https://arxiv.org/abs/2608.05605)
...
### [38] [Breaking Customized LLMs for Coding: Automated Red Teaming for Instruction Backdoor Attacks](https://arxiv.org/abs/2608.05659)
...
### [39] [Algebraic Cryptanalytic Extraction on Hard-Label Neural Networks](https://arxiv.org/abs/2608.05736)
...
### [40] [ABC: Numerical Data Collection under Local Differential Privacy without Prior Knowledge](https://arxiv.org/abs/2608.05737)
...
### [41] [On the Figures of Merit for Quantum Software Security: Toward a Benchmarking Rubric](https://arxiv.org/abs/2608.05831)
...
### [42] [An End-to-End Threat Model for the Quantum-as-a-Service Pipeline](https://arxiv.org/abs/2608.05836)
*Badhon Rahman,Majid Haghparast,Tommi Mikkonen*
...
### [43] [RustGo: Fairly Directed Greybox Fuzzing for Enforcing Rust Memory Safety](https://arxiv.org/abs/2608.05870)
...
### [44] [The Vulnerability With No CVE: Managing Persistent Gaps Between Mandate and Authority in AI Coding Agents](https://arxiv.org/abs/2608.05884)
...
### [45] [Tool Demo: Topology analysis with GPML for detection of cyberattacks in Water Distribution Networks](https://arxiv.org/abs/2608.05902)
...
### [46] [MMAligner: Safeguarding Multimodal Large Language Models through Representation Calibration](https://arxiv.org/abs/2608.05909)
...
### [47] [A Note on the Influence of a Zero Length Nonce on GCM and GMAC](https://arxiv.org/abs/2608.06061)
*Yaobin Shen*
...
### [48] [dfence: Fine-Grained Speculation Barriers for Efficient and Effective Hardware-Software Protection in the Spectre Era (Extended Version)](https://arxiv.org/abs/2608.06124)
...
### [49] [Hardware Keystores for AI Agent Signing Workflows: A Zero-Trust MCP Enforcement Architecture](https://arxiv.org/abs/2608.06130)
...
### [50] [Reversible Unlearnable Examples: Towards the Copyright Protection in Deep Learning Era](https://arxiv.org/abs/2608.06211)
...
### [51] [Game Hopping in Lean](https://arxiv.org/abs/2608.06261)
...
### [52] [A Sound Translation from Tamarin to ProVerif: Enabling Comparative Analysis](https://arxiv.org/abs/2608.06315)
