...
### [17] [Towards a Systematic Risk Assessment of Deep Neural Network Limitations in Autonomous Driving Perception](https://arxiv.org/abs/2604.20895)
...
### [18] [Sensitivity Uncertainty Alignment in Large Language Models](https://arxiv.org/abs/2604.20903)
...
### [19] [Omission Constraints Decay While Commission Constraints Persist in Long-Context LLM Agents](https://arxiv.org/abs/2604.20911)
*Yeran Gamage*
...
### [20] [Hidden Secrets in the arXiv: Discovering, Analyzing, and Preventing Unintentional Information Disclosure in Source Files of Scientific Preprints](https://arxiv.org/abs/2604.20927)
...
### [21] [SafeRedirect: Defeating Internal Safety Collapse via Task-Completion Redirection in Frontier LLMs](https://arxiv.org/abs/2604.20930)
...
### [22] [Adaptive Defense Orchestration for RAG: A Sentinel-Strategist Architecture against Multi-Vector Attacks](https://arxiv.org/abs/2604.20932)
...
### [23] [SDNGuardStack: An Explainable Ensemble Learning Framework for High-Accuracy Intrusion Detection in Software-Defined Networks](https://arxiv.org/abs/2604.20934)
...
### [24] [Breaking Bad: Interpretability-Based Safety Audits of State-of-the-Art LLMs](https://arxiv.org/abs/2604.20945)
...
### [25] [Breaking MCP with Function Hijacking Attacks: Novel Threats for Function Calling and Agentic Models](https://arxiv.org/abs/2604.20994)
...
### [26] [VRSafe: A Secure Virtual Keyboard to Mitigate Keystroke Inference in Virtual Reality](https://arxiv.org/abs/2604.21001)
...
### [27] [Layer 2 Blockchains Simplified: A Survey of Vector Commitment Schemes, ZKP Frameworks, Layer-2 Data Structures and Verkle Trees](https://arxiv.org/abs/2604.21055)
...
### [28] [Behavioral Consistency and Transparency Analysis on Large Language Model API Gateways](https://arxiv.org/abs/2604.21083)
...
### [29] [Cross-Session Threats in AI Agents: Benchmark, Evaluation, and Algorithms](https://arxiv.org/abs/2604.21131)
*Ari Azarafrooz*
...
### [30] [Image-Based Malware Type Classification on MalNet-Image Tiny: Effects of Multi-Scale Fusion, Transfer Learning, Data Augmentation, and Schedule-Free Optimization](https://arxiv.org/abs/2604.21153)
...
### [31] [Adaptive Instruction Composition for Automated LLM Red-Teaming](https://arxiv.org/abs/2604.21159)
...
### [32] [Position Paper: Denial-of-Service Against Multi-Round Transaction Simulation](https://arxiv.org/abs/2604.21169)
...
### [33] [Physically Unclonable Functions for Secure IoT Authentication and Hardware-Anchored AI Model Integrity](https://arxiv.org/abs/2604.21188)
...
### [34] [ECCFROG522PP: An Enhanced 522 bit Weierstrass Elliptic Curve](https://arxiv.org/abs/2604.21261)
*Victor Duarte Melo*
...
### [35] [Strategic Heterogeneous Multi-Agent Architecture for Cost-Effective Code Vulnerability Detection](https://arxiv.org/abs/2604.21282)
...
### [36] [CI-Work: Benchmarking Contextual Integrity in Enterprise LLM Agents](https://arxiv.org/abs/2604.21308)
...
### [37] [Adversarial Evasion in Non-Stationary Malware Detection: Minimizing Drift Signals through Similarity-Constrained Perturbations](https://arxiv.org/abs/2604.21310)
...
### [38] [Provably Secure Steganography Based on List Decoding](https://arxiv.org/abs/2604.21394)
...
### [40] [CSC: Turning the Adversary's Poison against Itself](https://arxiv.org/abs/2604.21416)
...
### [41] [Differentially Private De-identification of Dutch Clinical Notes: A Comparative Evaluation](https://arxiv.org/abs/2604.21421)
...
### [42] [A Stackelberg Model for Hybridization in Cryptography](https://arxiv.org/abs/2604.21436)
...
### [43] [MCP Pitfall Lab: Exposing Developer Pitfalls in MCP Tool Server Security under Multi-Vector Attacks](https://arxiv.org/abs/2604.21477)
*Run Hao,Zhuoran Tan*
...
### [44] [Benchmarking the Utility of Privacy-Preserving Cox Regression Under Data-Driven Clipping Bounds: A Multi-Dataset Simulation Study](https://arxiv.org/abs/2604.21491)
...
### [45] [Mitigate or Fail: How Risk Management Shapes Cybersecurity Competency](https://arxiv.org/abs/2604.21604)
*Jeffrey T. Gardiner*
...
### [46] [Process-Mining of Hypertraces: Enabling Scalable Formal Security Verification of (Automotive) Network Architectures](https://arxiv.org/abs/2604.21606)
...
### [47] [A-THENA: Early Intrusion Detection for IoT with Time-Aware Hybrid Encoding and Network-Specific Augmentation](https://arxiv.org/abs/2604.21623)
...
### [48] [On the Challenges of Holistic Intrusion Detection in ICS](https://arxiv.org/abs/2604.21626)
...
### [49] [A Sociotechnical, Practitioner-Centered Approach to Technology Adoption in Cybersecurity Operations: An LLM Case](https://arxiv.org/abs/2604.21679)
...
### [50] [Stealthy Backdoor Attacks against LLMs Based on Natural Style Triggers](https://arxiv.org/abs/2604.21700)
...
### [51] [Adversarial Robustness of Near-Field Millimeter-Wave Imaging under Waveform-Domain Attacks](https://arxiv.org/abs/2604.21774)
...
### [52] [Black-Box Skill Stealing Attack from Proprietary LLM Agents: An Empirical Study](https://arxiv.org/abs/2604.21829)
...
### [53] [TraceScope: Interactive URL Triage via Decoupled Checklist Adjudication](https://arxiv.org/abs/2604.21840)
...
### [54] [Cross-Modal Phantom: Coordinated Camera-LiDAR Spoofing Against Multi-Sensor Fusion in Autonomous Vehicles](https://arxiv.org/abs/2604.21841)
...
### [55] [Transient Turn Injection: Exposing Stateless Multi-Turn Vulnerabilities in Large Language Models](https://arxiv.org/abs/2604.21860)
