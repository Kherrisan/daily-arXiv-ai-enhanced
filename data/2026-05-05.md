...
### [35] [E-MIA: Exam-Style Black-Box Membership Inference Attacks against RAG Systems](https://arxiv.org/abs/2605.00955)
...
### [36] [Composable Post-Quantum Security for FADEC-Coupled Dual-Spool Turbofan Cyber-Physical Systems](https://arxiv.org/abs/2605.00961)
...
### [37] [SRTJ: Self-Evolving Rule-Driven Training-Free LLM Jailbreaking](https://arxiv.org/abs/2605.00974)
...
### [38] [Certified Purity for Cognitive Workflow Executors: From Static Analysis to Cryptographic Attestation](https://arxiv.org/abs/2605.01037)
*Alan L. McCann*
...
### [39] [LLM Ghostbusters: Surgical Hallucination Suppression via Adaptive Unlearning](https://arxiv.org/abs/2605.01047)
...
### [40] [A Sentence Relation-Based Approach to Sanitizing Malicious Instructions](https://arxiv.org/abs/2605.01078)
...
### [41] [Revisiting Privacy Leakage in Machine Unlearning: Membership Inference Beyond the Forgotten Set](https://arxiv.org/abs/2605.01129)
...
### [42] [When Embedding-Based Defenses Fail: Rethinking Safety in LLM-Based Multi-Agent Systems](https://arxiv.org/abs/2605.01133)
...
### [43] [Trace: Unmasking AI Attack Agents Through Terminal Behavior Fingerprinting](https://arxiv.org/abs/2605.01186)
...
### [44] [FLRSP: Privacy-Preserving Federated Learning Using Randomly Selected Model Parameters](https://arxiv.org/abs/2605.01204)
...
### [45] [Phishing Detection in Ethereum via Temporal Graph Contrastive Learning](https://arxiv.org/abs/2605.01207)
...
### [46] [Write-Domain Separation and Non-Custodial Enforcement: A Structural Impossibility in Account-Based Ledgers, with a Commitment-Based Construction](https://arxiv.org/abs/2605.01210)
*Matthias Hauser*
...
### [47] [FP-Agent: Fingerprinting AI Browsing Agents](https://arxiv.org/abs/2605.01247)
...
### [48] [Checkerboard: A Simple, Effective, Efficient and Learning-free Clean Label Backdoor Attack with Low Poisoning Budget](https://arxiv.org/abs/2605.01298)
...
### [49] [From Stealthy Data Fabrication to Unsafe Driving: Realistic Scenario Attacks on Collaborative Perception](https://arxiv.org/abs/2605.01301)
...
### [50] [VisInject: Disruption != Injection -- A Dual-Dimension Evaluation of Universal Adversarial Attacks on Vision-Language Models](https://arxiv.org/abs/2605.01449)
...
### [51] [PQC Validator: Validating Post-Quantum Readiness in Cloud-Native 5G Core Networks](https://arxiv.org/abs/2605.01454)
...
### [52] [LocalAlign: Enabling Generalizable Prompt Injection Defense via Generation of Near-Target Adversarial Examples for Alignment Training](https://arxiv.org/abs/2605.01462)
...
### [53] [Toward a Principled Framework for Agent Safety Measurement](https://arxiv.org/abs/2605.01644)
...
### [54] [Limit Properties at Critical Indices of Linear Canonical Riesz Potentials and Their Applications to Security of Multi-Image Encryption](https://arxiv.org/abs/2605.01654)
...
### [55] [Class-Aware Adaptive Differential Privacy in Deep Learning for Sensor-Based Fall Detection](https://arxiv.org/abs/2605.01679)
*Joydeb Kumar Sana*
...
### [56] [Automated Channel Fault Analysis with Tofu](https://arxiv.org/abs/2605.01721)
...
### [57] [AgenticVM: Agentic AI for Adaptive Software Vulnerability Management](https://arxiv.org/abs/2605.01739)
...
### [58] [Architectural Obsolescence of Unhardened Agentic-AI Runtimes](https://arxiv.org/abs/2605.01740)
*Alfredo Metere*
...
### [59] [VulKey: Automated Vulnerability Repair Guided by Domain-Specific Repair Patterns](https://arxiv.org/abs/2605.01769)
...
### [60] [Needle-in-RAG: Prompt-Conditioned Character-Level Traceback of Poisoned Spans in Retrieved Evidence](https://arxiv.org/abs/2605.01782)
*Huining Cui,Wei Liu*
...
### [61] [Repurposing and Evaluating the (In)Feasibility of Dataset Poisoning enabled Watermarking for Contrastive Learning](https://arxiv.org/abs/2605.01834)
...
### [62] [QASecClaw: A Multi-Agent LLM Approach for False Positive Reduction in Static Application Security Testing](https://arxiv.org/abs/2605.01885)
...
### [63] [GPU Fingerprinting for Location Verification](https://arxiv.org/abs/2605.01930)
...
### [64] [LAPRAS : Learning-Augmented PRivate Answering for linear query Streams](https://arxiv.org/abs/2605.01960)
...
### [65] [FIRCE: A Framework for Intrusion Response and Conformal Evaluation](https://arxiv.org/abs/2605.01962)
...
### [66] [Trojan Hippo: Weaponizing Agent Memory for Data Exfiltration](https://arxiv.org/abs/2605.01970)
...
### [67] [Plausible Deniability in Fully Homomorphic Computation](https://arxiv.org/abs/2605.01985)
...
### [68] [SCRIBE: Practical Static Binary Patching via Binary-Aware Recompilation of Decompiled Code](https://arxiv.org/abs/2605.02121)
...
### [69] [What's on Your Mind? Exploring Privacy of Mental Health Apps](https://arxiv.org/abs/2605.02016)
...
### [70] [Obscura: Privacy-Preserving Protocol for the Algorand Blockchain Using LSAG Ring Signatures](https://arxiv.org/abs/2605.02077)
*Navid Azimi*
...
### [71] [Stochastic Modeling of Human-Machine Authentication Channels under Partial Information Leakage](https://arxiv.org/abs/2605.02102)
...
### [72] [When Alignment Isn't Enough: Response-Path Attacks on LLM Agents](https://arxiv.org/abs/2605.02187)
...
### [73] [On the Privacy of LLMs: An Ablation Study](https://arxiv.org/abs/2605.02255)
...
### [74] [Optimal Privacy-Utility Trade-Offs in LDP: Functional and Geometric Perspectives](https://arxiv.org/abs/2605.02319)
...
### [75] [APIOT: Autonomous Vulnerability Management Across Bare-Metal Industrial OT Networks](https://arxiv.org/abs/2605.02346)
...
### [76] [Privacy Preserving Machine Learning Workflow: from Anonymization to Personalized Differential Privacy Budgets in Federated Learning](https://arxiv.org/abs/2605.02372)
...
### [77] [Fight Poison with Poison: Enhancing Robustness in Few-shot Machine-Generated Text Detection with Adversarial Training](https://arxiv.org/abs/2605.02374)
...
### [78] [Design and Performance Evaluation of a BLE-Based IoT Authentication System](https://arxiv.org/abs/2605.02381)
...
### [79] [Differentially Private Runtime Monitoring](https://arxiv.org/abs/2605.02391)
...
### [80] [GuardSec: A Multi-Modal Web Platform for Real-Time Digital Fraud Detection, Entity Verification, and Connection Security Analysis in the African Context](https://arxiv.org/abs/2605.02502)
...
### [81] [Noisy Networks, Nosy Neighbors: Simple Privacy Attacks Against Residential Wireless Traffic](https://arxiv.org/abs/2605.02553)
...
### [82] [VertMark: A Unified Training-Free Robust Watermarking Framework for Vertical Domain Pre-trained Language Models](https://arxiv.org/abs/2605.02557)
...
### [83] [Reflecthernet: Exfiltrating 100BASE-TX Ethernet Traffic Using a Retroreflector Hardware Trojan](https://arxiv.org/abs/2605.02702)
...
### [84] [FunFuzz: An LLM-Powered Evolutionary Fuzzing Framework](https://arxiv.org/abs/2605.02789)
...
### [85] [Analyzing Unsolicited Internet Traffic: Measuring IoT Security Threats via Network Telescopes](https://arxiv.org/abs/2605.02795)
...
### [86] [Autonomous LLM Agent Worms: Cross-Platform Propagation, Automated Discovery and Temporal Re-Entry Defense](https://arxiv.org/abs/2605.02812)
...
### [87] [InsureConnect: Blockchain and Digital Identity for the Property Insurance Market](https://arxiv.org/abs/2605.02824)
...
### [88] [The 1-Bit Barrier is Universal: k-Stage Pipeline Composition and Unified Leakage Bounds for Standard Modular Reductions in PQC Hardware](https://arxiv.org/abs/2605.02856)
