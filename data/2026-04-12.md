...
### [3] [Differentially Private Modeling of Disease Transmission within Human Contact Networks](https://arxiv.org/abs/2604.07493)
...
### [4] [TRUSTDESC: Preventing Tool Poisoning in LLM Applications via Trusted Description Generation](https://arxiv.org/abs/2604.07536)
...
### [5] [MCP-DPT: A Defense-Placement Taxonomy and Coverage Analysis for Model Context Protocol Security](https://arxiv.org/abs/2604.07551)
...
### [6] [MEV-ACE: Identity-Authenticated Fair Ordering for Proposer-Controlled MEV Mitigation](https://arxiv.org/abs/2604.07568)
*Jian Sheng Wang*
...
### [7] [Interpreting the Error of Differentially Private Median Queries through Randomization Intervals](https://arxiv.org/abs/2604.07581)
...
### [8] [AITH: A Post-Quantum Continuous Delegation Protocol for Human-AI Trust Establishment](https://arxiv.org/abs/2604.07695)
*Zhaoliang Chen*
...
### [9] [TrajGuard: Streaming Hidden-state Trajectory Detection for Decoding-time Jailbreak Defense](https://arxiv.org/abs/2604.07727)
...
### [10] [The Art of (Mis)alignment: How Fine-Tuning Methods Effectively Misalign and Realign LLMs in Post-Training](https://arxiv.org/abs/2604.07754)
...
### [11] [Anamorphic Encryption with CCA Security: A Standard Model Construction](https://arxiv.org/abs/2604.07771)
...
### [12] [BRASP: Boolean Range Queries over Encrypted Spatial Data with Access and Search Pattern Privacy](https://arxiv.org/abs/2604.07797)
...
### [13] [Are GUI Agents Focused Enough? Automated Distraction via Semantic-level UI Element Injection](https://arxiv.org/abs/2604.07831)
...
### [14] [A Hardware-Anchored Privacy Middleware for PII Sharing Across Heterogeneous Embedded Consumer Devices](https://arxiv.org/abs/2604.07839)
...
### [15] [xDup: Privacy-Preserving Deduplication for Humanitarian Organizations using Fuzzy PSI](https://arxiv.org/abs/2604.08019)
...
### [16] [PrivFedTalk: Privacy-Aware Federated Diffusion with Identity-Stable Adapters for Personalized Talking-Head Generation](https://arxiv.org/abs/2604.08037)
...
### [17] [TADP-RME: A Trust-Adaptive Differential Privacy Framework for Enhancing Reliability of Data-Driven Systems](https://arxiv.org/abs/2604.08113)
...
### [18] [Multimodal Reasoning with LLM for Encrypted Traffic Interpretation: A Benchmark](https://arxiv.org/abs/2604.08140)
...
### [19] [Towards Identification and Intervention of Safety-Critical Parameters in Large Language Models](https://arxiv.org/abs/2604.08297)
...
### [21] [Post-Quantum Cryptographic Analysis of Message Transformations Across the Network Stack](https://arxiv.org/abs/2604.08480)
...
### [22] [PIArena: A Platform for Prompt Injection Evaluation](https://arxiv.org/abs/2604.08499)
...
### [23] [Breaking the Illusion of Identity in LLM Tooling](https://arxiv.org/abs/2604.07398)
*Marek Miller*
...
### [24] [Beyond Single Reports: Evaluating Automated ATT&CK Technique Extraction in Multi-Report Campaign Settings](https://arxiv.org/abs/2604.07470)
...
### [25] [Triage: Routing Software Engineering Tasks to Cost-Effective LLM Tiers via Code Quality Signals](https://arxiv.org/abs/2604.07494)
*Lech Madeyski*
...
### [26] [Beyond Human-Readable: Rethinking Software Engineering Conventions for the Agentic Development Era](https://arxiv.org/abs/2604.07502)
*Dmytro Ustynov*
...
### [27] [Program Analysis Guided LLM Agent for Proof-of-Concept Generation](https://arxiv.org/abs/2604.07624)
...
### [28] [MVOS_HSI: A Python Library for Preprocessing Agricultural Crop Hyperspectral Data](https://arxiv.org/abs/2604.07656)
...
### [29] [Towards Counterfactual Explanation and Assertion Inference for CPS Debugging](https://arxiv.org/abs/2604.07679)
...
### [30] [MIMIC-Py: An Extensible Tool for Personality-Driven Automated Game Testing with Large Language Models](https://arxiv.org/abs/2604.07752)
...
### [31] [An Empirical Study on Influence-Based Pretraining Data Selection for Code Large Language Models](https://arxiv.org/abs/2604.07769)
...
### [32] [To Copilot and Beyond: 22 AI Systems Developers Want Built](https://arxiv.org/abs/2604.07830)
...
### [33] [ZeroCoder: Can LLMs Improve Code Generation Without Ground-Truth Supervision?](https://arxiv.org/abs/2604.07864)
...
### [34] [AFGNN: API Misuse Detection using Graph Neural Networks and Clustering](https://arxiv.org/abs/2604.07891)
...
### [35] [Investigating Code Reuse in Software Redesign: A Case Study](https://arxiv.org/abs/2604.07919)
...
### [36] [Log-based, Business-aware REST API Testing](https://arxiv.org/abs/2604.08007)
...
### [37] [A Comparative Study of Semantic Log Representations for Software Log-based Anomaly Detection](https://arxiv.org/abs/2604.08028)
...
### [38] [Can LLMs Deobfuscate Binary Code? A Systematic Analysis of Large Language Models into Pseudocode Deobfuscation](https://arxiv.org/abs/2604.08083)
...
### [39] [GALA: Multimodal Graph Alignment for Bug Localization in Automated Program Repair](https://arxiv.org/abs/2604.08089)
...
### [40] [Test-Oriented Programming: rethinking coding for the GenAI era](https://arxiv.org/abs/2604.08102)
*Jorge Melegati*
...
### [41] [Towards Improving the External Validity of Software Engineering Experiments with Transportability Methods](https://arxiv.org/abs/2604.08200)
...
### [42] [Empirical Evaluation of Taxonomic Trace Links: A Case Study](https://arxiv.org/abs/2604.08207)
...
### [43] [Externalization in LLM Agents: A Unified Review of Memory, Skills, Protocols and Harness Engineering](https://arxiv.org/abs/2604.08224)
...
### [44] [Tokalator: A Context Engineering Toolkit for Artificial Intelligence Coding Assistants](https://arxiv.org/abs/2604.08290)
...
### [45] [CIAO - Code In Architecture Out - Automated Software Architecture Documentation with Large Language Models](https://arxiv.org/abs/2604.08293)
...
### [46] [Security Concerns in Generative AI Coding Assistants: Insights from Online Discussions on GitHub Copilot](https://arxiv.org/abs/2604.08352)
...
### [47] [Vulnerability Detection with Interprocedural Context in Multiple Languages: Assessing Effectiveness and Cost of Modern LLMs](https://arxiv.org/abs/2604.08417)
