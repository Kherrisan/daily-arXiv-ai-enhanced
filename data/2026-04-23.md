...
### [24] [Efficient Arithmetic-and-Comparison Homomorphic Encryption with Space Switching](https://arxiv.org/abs/2604.19890)
...
### [25] [A Data-Free Membership Inference Attack on Federated Learning in Hardware Assurance](https://arxiv.org/abs/2604.19891)
...
### [26] [DECIFR: Domain-Aware Exfiltration of Circuit Information from Federated Gradient Reconstruction](https://arxiv.org/abs/2604.19915)
*Gijung Lee,Wavid Bowman,Olivia P. Dizon-Paradis,Reiner N. Dizon-Paradis,Ronald Wilson,Damon L. Woodard,Domenic Forte*
...
### [27] [Potentials and Pitfalls of Applying Federated Learning in Hardware Assurance](https://arxiv.org/abs/2604.20020)
...
### [28] [AgentSOC: A Multi-Layer Agentic AI Framework for Security Operations Automation](https://arxiv.org/abs/2604.20134)
...
### [29] [Taint-Style Vulnerability Detection and Confirmation for Node.js Packages Using LLM Agent Reasoning](https://arxiv.org/abs/2604.20179)
...
### [30] [Text Steganography with Dynamic Codebook and Multimodal Large Language Model](https://arxiv.org/abs/2604.20269)
...
### [31] [TLSCheck 2.0: An Enhanced Memory Forensics Approach to Efficiently Detect TLS Callbacks](https://arxiv.org/abs/2604.20378)
...
### [32] [CyberCertBench: Evaluating LLMs in Cybersecurity Certification Knowledge](https://arxiv.org/abs/2604.20389)
...
### [33] [Onyx: Cost-Efficient Disk-Oblivious ANN Search](https://arxiv.org/abs/2604.20401)
...
### [34] [Towards Certified Malware Detection: Provable Guarantees Against Evasion Attacks](https://arxiv.org/abs/2604.20495)
...
### [35] [PVAC: A RowHammer Mitigation Architecture Exploiting Per-victim-row Counting](https://arxiv.org/abs/2604.20576)
...
### [36] [SoK: The Next Frontier in AV Security: Systematizing Perception Attacks and the Emerging Threat of Multi-Sensor Fusion](https://arxiv.org/abs/2604.20621)
...
### [37] [Auto-ART: Structured Literature Synthesis and Automated Adversarial Robustness Testing](https://arxiv.org/abs/2604.20704)
*Abhijit Talluri*
...
### [38] [CVEs With a CVSS Score Greater Than or Equal to 9](https://arxiv.org/abs/2604.20765)
...
### [39] [DAIRE: A lightweight AI model for real-time detection of Controller Area Network attacks in the Internet of Vehicles](https://arxiv.org/abs/2604.20771)
...
### [40] [Fresh Masking Makes NTT Pipelines Composable: Machine-Checked Proofs for Arithmetic Masking in PQC Hardware](https://arxiv.org/abs/2604.20793)
...
### [41] [Synthesizing Multi-Agent Harnesses for Vulnerability Discovery](https://arxiv.org/abs/2604.20801)
...
### [42] [An Analysis of Attack Vectors Against FIDO2 Authentication](https://arxiv.org/abs/2604.20826)
...
### [43] [AVISE: Framework for Evaluating the Security of AI Systems](https://arxiv.org/abs/2604.20833)
