...
TL;DR: This paper introduces <b>Reflection-Driven Control</b>, a safety mechanism for LLM agents during code generation by embedding an <b>internal reflection loop</b> that detects and mitigates risks through retrieval of <b>secure coding guidelines</b>. The system improves <b>security and policy compliance</b> with minimal overhead, offering a practical path toward <b>trustworthy AI coding agents</b>.


<details>
  <summary>Details</summary>
Motivation: Current LLM agents generate outputs that are <b>unconstrained and unpredictable</b>, leading to <b>potentially harmful outcomes</b>, especially in security-sensitive domains. The paper addresses this by seeking a <b>standardized and reliable safety control</b> to enhance trustworthiness without compromising functionality.

Method: The proposed method integrates a <b>Reflection-Driven Control module</b> into general agent architectures. This module incorporates an <b>internal reflection loop</b> to monitor reasoning paths and <b>inject constraints</b> by retrieving <b>secure coding guidelines</b> from a <b>reflective memory</b> during code generation, mitigating risks at runtime.

Result: The method improves <b>security and policy compliance</b> across <b>eight classes</b> of security-critical tasks while <b>preserving functional correctness</b> and incurring <b>minimal runtime overhead</b>.

Conclusion: Reflection-Driven Control is a <b>practical framework</b> for building <b>secure, autonomous, auditable</b> AI coding agents. It demonstrates a scalable path to align AI behavior with safety requirements, <b>without requiring significant architectural changes</b>.
...
TL;DR: This paper establishes the equivalence between fDP (a privacy framework based on hypothesis testing) and QIF (Quantitative Information Flow) via Galois connections, enabling new composition theorems for analyzing privacy mechanisms.


<details>
  <summary>Details</summary>
Motivation: While fDP improves privacy loss predictions, its connection to existing information-theoretic frameworks (like QIF) was unexplored, limiting deeper analytical insights. Bridging this gap could strengthen privacy analysis and design.

Method: The authors demonstrate an equivalence between fDP and QIF by constructing a Galois connection between two partially ordered sets (posets). This mathematical structure reveals an inherent relationship between their definitions, enabling the derivation of composition properties.

Result: A formal equivalence between fDP and QIF is proven, along with novel composition theorems for fDP. These theorems allow better analysis of combined privacy mechanisms, such as parallel and sequential applications, beyond traditional results.

Conclusion: By linking fDP to QIF through ordered structure theory, the paper provides a theoretical foundation for leveraging QIF's tools within fDP. This opens avenues for more robust privacy design, particularly in complex systems requiring rigorous compositional analysis.
...
TL;DR: This paper highlights the vulnerability of CVA6 RISC-V core to side-channel attacks through CPA analysis using VeriSide framework.


<details>
  <summary>Details</summary>
Motivation: Modern RISC-V processors require resilience to side-channel attacks, which demands assessment beyond functional correctness.

Method: The study uses VeriSide, an RTL-level power profiling framework, to evaluate the side-channel vulnerability of CVA6 RISC-V core via software-based AES encryption and Correlation Power Analysis (CPA).

Result: The analysis reveals significant power leakage in CVA6 RISC-V core that could enable key recovery through CPA.

Conclusion: The study emphasizes the role of early-stage RTL evaluations in developing secure RISC-V processors against side-channel attacks.
...
TL;DR: Satellite cybersecurity threats differ drastically by orbit, with encryption and command flaws being universally critical; integrated solutions are required to link cyber resilience to space sustainability.


<details>
  <summary>Details</summary>
Motivation: The proliferation of LEO satellite constellations has shifted space risks from kinetic collisions to complex cyber-physical threats. Traditional debris-focused frameworks neglect vulnerabilities in radio-frequency links, supply chains, and software updates, necessitating a reevaluation of orbit-specific cybersecurity strategies.

Method: The study conducts a comparative analysis of satellite cybersecurity across LEO, MEO, and GEO regimes by synthesizing data from 60 publicly documented security incidents. Key vulnerability proxies included TT&C anomalies, encryption weaknesses, and environmental stressors, with statistical evaluation of attack feasibility and impact.

Result: Distinct threat profiles emerge for each orbit: GEO is vulnerable to high-frequency uplink attacks, LEO faces risks from power/hardware constraints and environmental faults, and weak encryption/command irregularities predict adversarial success across all orbits. Cyber vulnerabilities directly impact sustainability via accelerated hardware depreciation.

Conclusion: The paper argues that unmitigated cyber vulnerabilities in satellite systems accelerate hardware obsolescence and debris accumulation, undermining sustainable carbon-neutral space operations. It emphasizes the need for integrated cybersecurity measures addressing orbit-specific risks.
...
TL;DR: This paper surveys lightweight ciphers for IoT, emphasizes key size as a security benchmark, and introduces taxonomies for IoT application classification and security evaluation. Ciphers with keys <128 bits are flagged as insecure for sensitive data.


<details>
  <summary>Details</summary>
Motivation: Existing surveys on lightweight cryptography focus on hardware/software performance or implementations, but overlook IoT-specific security challenges. This study bridges that gap by prioritizing security evaluation for resource-constrained IoT environments.

Method: The research conducts a comprehensive survey of security evaluations for symmetric lightweight ciphers. It introduces two taxonomies: one for categorizing IoT applications based on characteristics, and another for assessing security levels using key size as a parameter.

Result: Analysis reveals that key sizes below 128 bits render lightweight ciphers insecure. The proposed taxonomies provide a framework to assess security requirements and classify IoT applications based on inherent characteristics and security needs.

Conclusion: The study concludes that key size is a critical factor in the security of lightweight ciphers for IoT systems, with ciphers using keys shorter than 128 bits deemed insufficient for sensitive data protection. The proposed taxonomies aid in evaluating security levels and classifying IoT applications.
...
TL;DR: A new system named LURE uses large language models to act as human chat participants in order to interact with cybercriminals and gain insight into their techniques, successfully remaining undetected in over half of the interactions.


<details>
  <summary>Details</summary>
Motivation: Traditional cybersecurity measures fail to detect conversational cybercrimes such as chat-based scams that rely on trust and psychological manipulation. These methods use real-time messaging platforms and often include multimedia obfuscation, making them difficult for static filters to identify.

Method: The study introduces LURE (LLM-based User Response Engagement), which employs large language models as active agents within adversarial chat environments. It uses automated discovery to find scam groups, then engages in conversations with criminals, and utilizes OCR to analyze image-embedded payment data. This allows LURE to maintain realistic conversations and gather data on scam operations.

Result: LURE was applied to Telegram-based video chat scams and interacted with 53 actors across 98 groups. In over 56% of interactions, the LLM maintained multi-round conversations without being detected as a bot. The system successfully gathered insights into scam operations, including payment flows, upselling strategies, and platform migration tactics.

Conclusion: LURE demonstrates the effectiveness of using large language models as active agents in adversarial chat environments to study and counteract cybercriminal activities. The system's ability to convincingly impersonate a human and remain undetected provides valuable insights into the tactics used by cybercriminals and highlights the potential of LLMs for proactive cybersecurity measures.
...
TL;DR: Smart home IoT devices reuse authentication credentials indefinitely and allow replay attacks, exposing serious security vulnerabilities due to weak trust binding.


<details>
  <summary>Details</summary>
Motivation: The paper addresses the need to understand how authentication is practically enforced in smart home IoT systems, particularly how these systems balance security requirements with usability demands like persistent connectivity and minimal user interaction.

Method: The researchers evaluated a set of widely deployed consumer IoT devices (smart plugs, lighting, cameras, and hubs) in a controlled residential environment using passive network monitoring, mobile app interactions, and replay experiments to analyze authentication behavior during pairing, extended use, network events (e.g., reconnection, address reassignment), and cross-host replay attempts.

Result: Authentication state persistently reuses credentials for extended periods without expiration, survives network disruptions (e.g., reboots, address changes), and can be successfully replayed from unauthorized hosts on the same network with high success rates across multiple device categories and ecosystems.

Conclusion: The study concludes that current smart home IoT authentication mechanisms prioritize usability over security by relying on long-lived trust relationships with insufficient binding to session freshness, network context, or controller identity, creating significant security risks.
...
TL;DR: This review categorizes and evaluates anti-cheat techniques for online games, revealing trade-offs in effectiveness, privacy, and stability, and stressing the need for robust, evolving defenses.


<details>
  <summary>Details</summary>
Motivation: The motivation lies in addressing the persistent challenge of software-based cheating in online multiplayer games, where evolving cheating methods necessitate a comprehensive evaluation of existing countermeasures to guide future research and development.

Method: The study employs a systematic literature review to categorize technical defenses into server-side detection, client-side anti-tamper, kernel-level anti-cheat drivers, and hardware-assisted TEEs, evaluating them across detection effectiveness, performance overhead, privacy impact, and scalability.

Result: The analysis highlights critical trade-offs between high-visibility kernel-level solutions (with privacy/stability risks) and less intrusive server-side approaches (with limited efficacy), while underscoring the dynamic evolution of cheating tactics.

Conclusion: The paper concludes that there is an ongoing arms race between anti-cheat mechanisms and cheaters, emphasizing the need for robust, adversary-resistant designs that balance effectiveness, privacy, and system stability.
...
TL;DR: LAMLAD: Large language models used to attack ML-based Android malware detectors with high success rate.


<details>
  <summary>Details</summary>
Motivation: Android malware's scale and complexity necessitate ML detection, but these models are vulnerable to adversarial attacks. Existing methods lack efficiency and functional preservation.

Method: LAMLAD uses a dual-agent LLM architecture with a manipulator for perturbations and an analyzer for evasion, enhanced by RAG for efficiency and context.

Result: LAMLAD achieved 97% ASR with three attempts/sample against ML malware detectors; adversarial training reduced ASR by 30%.

Conclusion: LAMLAD demonstrates strong adversarial attacks using LLMs, while proposed defense mitigates risks, highlighting LLMs in adversarial contexts.
...
TL;DR: GoldenFuzz is a two-stage fuzzer for hardware, using a fast reference model for quick test case refinement before DUT testing, resulting in higher coverage and efficiency, and finding numerous vulnerabilities. 


<details>
  <summary>Details</summary>
Motivation: Existing hardware fuzzers suffer from limited semantic awareness, inefficient test refinement, and high computational overhead due to slow simulation. 

Method: GoldenFuzz uses a two-stage approach with a fast, ISA-compliant Golden Reference Model (GRM) for initial fuzzing and test case refinement, followed by DUT testing. It employs a feedback-driven mechanism with coverage insights for better state exploration. 

Result: GoldenFuzz outperforms existing fuzzers on three RISC-V processors (RocketChip, BOOM, CVA6), achieving the highest coverage with minimal test case length and overhead. It discovers all known and five new vulnerabilities, four classified as highly severe (CVSS v3 score >7). 

Conclusion: GoldenFuzz is a novel two-stage fuzzer with a GRM digital twin, enabling efficient and effective vulnerability discovery in hardware with reduced computational cost. It significantly outperforms existing fuzzers and uncovers highly critical vulnerabilities in commercial and open-source hardware. 
...
TL;DR: The paper proposes using an involution function-based stream cipher for encryption and Shamir secret sharing for key distribution to reduce server overhead.


<details>
  <summary>Details</summary>
Motivation: Servers experience high computational overhead and slow response times when managing secure data access with traditional methods.

Method: First approach: encryption using an Involution Function Based Stream Cipher. Second approach: key distribution using Shamir secret sharing, with key reconstruction via second-order Lagrange interpolation.

Result: The proposed method reduces server computational overhead and improves performance metrics such as encryption/decryption time, throughput, and security.

Conclusion: The technique offers an efficient solution for secure large-scale data sharing and has potential applications in organizational data management.
...
TL;DR: This paper quantifies the security benefits of QKD-based key rotation intervals in block ciphers, offering a theoretical framework to optimize QKD-classical crypto integration for quantum-resistant systems.


<details>
  <summary>Details</summary>
Motivation: The rapid development of quantum computing threatens classical cryptography, necessitating architectures resilient to quantum attacks. QKD's limited bandwidth requires combination with classical block ciphers, but the security reduction when using single keys for multiple files remains unquantified.

Method: Constructs a precise calculation model for key rotation intervals and proposes a quantitative method to evaluate the security benefits of QKD keys in block ciphers. Derives the maximum number of files (Q*) using concrete security models and analyzes CTR, CBC, and ECBC-MAC modes.

Result: Using SM4, the study shows that under an 80-bit security target, uniform key rotations increase security strength by log2(k) to 2log2(k) bits, providing explicit quantitative metrics for optimization.

Conclusion: The study provides theoretical support and a basis for parameter optimization in integrating QKD keys with classical cryptographic algorithms, enhancing the security of cryptographic systems against quantum threats.
...
TL;DR: The paper introduces 'Verifiable Passkey', a new standard that addresses storage and privacy issues with current passwordless authentication methods by allowing reuse of passkeys across platforms without tracking.


<details>
  <summary>Details</summary>
Motivation: FIDO2 Passkeys face storage limitations due to device constraints and create privacy concerns when using SSO, as the Identity Provider can track users across services.

Method: The paper proposes 'Verifiable Passkey', which utilizes Verifiable Credentials to enable cross-platform use of passkeys without compromising privacy or enabling user tracking.

Result: The proposed Verifiable Passkey standard offers a solution that extends the usability of passkeys beyond individual services or devices without sacrificing security or privacy.

Conclusion: Verifiable Passkey provides an effective way to mitigate the storage constraints and privacy risks associated with traditional passkey implementations while maintaining phishing resistance.
...
TL;DR: This paper presents the Glyph Perturbation Cardinality (GPC) framework, a method for hiding text, images, audio, and video within rendered text by subtly changing pixel information, while remaining visually undetectable.


<details>
  <summary>Details</summary>
Motivation: The need for a more robust and covert method to embed various types of data within text without altering visible content, thus avoiding detection by traditional linguistic or structural analysis methods.

Method: The method uses a deterministic text rendering pipeline to rasterize text, then modifies the resulting bitmap by applying small, imperceptible changes to interior ink pixels of each glyph. These changes represent encoded payload data, which includes any type of multimedia data normalized into integer sequences.

Result: The GPC framework successfully embeds and recovers multimedia payloads hidden within text, demonstrating its robustness and effectiveness in maintaining visual covertness while supporting diverse data types.

Conclusion: The GPC framework provides a novel and effective approach for multimodal steganography by leveraging the pixel space of text glyphs in a computationally efficient and secure manner.
...
TL;DR: This paper demonstrates a machine learning-based side-channel attack on SNOW-V, a 5G encryption candidate, using power analysis to achieve efficient key recovery with neural networks outperforming traditional methods.


<details>
  <summary>Details</summary>
Motivation: Assessing the security of 5G encryption standards like SNOW-V is critical, especially as machine learning enhances side-channel attack capabilities, necessitating robust countermeasures.

Method: The authors implemented SNOW-V on an STM32 microcontroller, captured power traces via a ChipWhisperer board, and employed TVLA to validate leakage before using LDA and FCNs for profiling attacks.

Result: FCNs required >5× fewer traces than CPA-assisted LDA to recover keys, proving ML-based attacks are significantly more efficient against SNOW-V.

Conclusion: SNOW-V's vulnerability to ML-enhanced side-channel attacks underscores the urgency for advanced countermeasures in 5G security implementations.
...
TL;DR: This paper investigates membership inference attacks (MIA), which determine if specific data was used to train a model, applied to generative music systems like MuseGAN. The study finds existing MIAs ineffective against music data, but emphasizes the importance of addressing privacy and copyright concerns in the music industry.


<details>
  <summary>Details</summary>
Motivation: Rapid growth of generative AI raises concerns about user privacy (e.g., sensitive data misuse) and unauthorized use of copyrighted works. The music industry, worth billions, lacks MIA research despite the need to detect illicit use of artists’ work.

Method: The authors empirically evaluate existing MIA techniques on MuseGAN, a generative music model, measuring their effectiveness in identifying training data. They compare results to prior work on generative audio MIAs.

Result: Music data shows resilience to known MIAs, similar to generative audio findings. Existing attacks fail to reliably infer membership in the training set for music models.

Conclusion: While current MIAs are ineffective against generative music, the study underscores the urgency of developing targeted attacks or defenses for the music domain to protect privacy and intellectual property.
...
TL;DR: This paper combines learning theories to create a dynamic cybersecurity model for Industry 4.0, tackling ransomware threats and IoT challenges through adaptive governance frameworks and scalability.


<details>
  <summary>Details</summary>
Motivation: With 65% of industrial companies facing annual ransomware attacks and the impending 18.8B IoT devices, there's an urgent need for dynamic, adaptive cybersecurity governance to address systemic vulnerabilities in Industry 4.0 systems.

Method: The paper synthesizes Argyris & Schön's double-loop learning theory with Crossan's 4I framework, leveraging literature analysis and qualitative research to build a scalable cybersecurity maturity model with feedforward/feedback loops.

Result: The DSL architecture enables operational obstacle bridging, promotes continuous growth, and provides a methodical approach to cybersecurity maturity, directly addressing the growing complexity of industrial cyber-physical systems.

Conclusion: The DSL model offers a proactive and reflective cybersecurity governance framework for Industry 4.0, integrating organizational learning theories to address current cyber threats and future IoT challenges through strategic adaptation and systemic resilience.
...
TL;DR: The paper proposes a lightweight authentication protocol using RFF and PUF for secure IoT drone communication, reducing computational load and dependencies.


<details>
  <summary>Details</summary>
Motivation: Current protocols for IoT drones have high overhead, need third parties, secret storage, and controlled enrollment, limiting cross-domain usability.

Method: Integrate RFF for OTA enrollment and PUF with OTP for ephemeral keying, avoiding secret storage and third-party reliance.

Result: Protocol passes security analyses and outperforms existing schemes in security and efficiency metrics.

Conclusion: The integration of RFF and PUF technologies offers efficient, secure cross-domain drone communication without traditional limitations.
...
TL;DR: This paper proposes the Secure and Compliant NLP Lifecycle Management Framework (SC-NLP-LMF), a six-phase model designed to address security, privacy, and compliance risks in NLP systems through development to retirement, supported by a healthcare case study.


<details>
  <summary>Details</summary>
Motivation: NLP systems are being used in high-risk domains like healthcare, finance, and government but introduce unresolved security and compliance risks, prompting the need for a specialized governance framework.

Method: The framework is developed through a PRISMA-based systematic review of 45 peer-reviewed and regulatory sources, integrating bias detection, privacy methods such as differential privacy and federated learning, secure deployment, explainability, and decommissioning processes.

Result: The SC-NLP-LMF is aligned with leading standards (NIST AI RMF, ISO/IEC 42001:2023, EU AI Act, MITRE ATLAS) and successfully addresses terminology drift in a healthcare case study, aiding in compliant model updates.

Conclusion: The framework provides a practical, end-to-end structure for secure and accountable NLP system operations in regulated, high-risk settings.
...
TL;DR: ReSMT automates obfuscated code analysis using SMT-based logical assertion solving, enabling effective reverse-engineering of complex malware while reducing reliance on manual expertise.


<details>
  <summary>Details</summary>
Motivation: Current reverse-engineering methods struggle with layered or customized obfuscation techniques, limiting their effectiveness despite the growing prevalence of obfuscated malicious software.

Method: The tool translates obfuscated assembly code into logical assertions and employs SMT solving and simulation to analyze execution paths, enabling automated deobfuscation without requiring manual expertise.

Result: ReSMT successfully resolved reverse-engineering challenges in complex obfuscated code during an extensive case study, proving its capability to answer critical functionality questions.

Conclusion: ReSMT demonstrates significant potential as an automated tool for reverse-engineering obfuscated code, effectively overcoming limitations of existing methods by leveraging SMT solving and simulation techniques.
...
TL;DR: This study systematically examines the architecture and classification of Trusted Execution Environments (TEEs) and their abstraction layers, identifying ways to enhance existing solutions. This study also highlights WebAssembly as a promising approach for supporting the largest set of features.


<details>
  <summary>Details</summary>
Motivation: The motivation for this study is to unify the TEE ecosystem through abstraction layers, enabling application developers and system administrators to leverage confidential computing more effectively. By understanding the design choices and features of different TEEs, the paper aims to identify areas for improvement and future research directions.

Method: The study provides an overview of representative TEE technologies and categorizes them based on their design choices. The researchers then propose a systematization of knowledge around each design choice, describing the underlying technologies, inner workings, and features of abstraction layers associated with each TEE. They also compare and contrast the abstraction layers to assess their strengths, weaknesses, and potential for improvement.

Result: The study's results include a comprehensive classification of TEEs and their abstraction layers, revealing opportunities for enhancing existing abstraction layer solutions. The researchers identified WebAssembly as a promising approach for supporting the largest set of features. Additionally, they highlighted areas such as flexibility, performance, and portability for potential improvement.

Conclusion: The conclusion of the paper emphasizes that abstraction layers play a crucial role in enabling the broad and efficient use of confidential computing. The study identifies ways to improve these layers and highlights WebAssembly as a promising direction for future research. The researchers also outline potential future directions for the evolution and integration of abstraction layers within the confidential computing ecosystem.
...
### [23] [Understanding the Role of Large Language Models in Software Engineering: Evidence from an Industry Survey](https://arxiv.org/abs/2512.21347)
*Vítor Mateus de Brito,Kleinner Farias*

Main category: cs.SE

TL;DR: A survey of 46 software engineers reveals both benefits and risks of LLM adoption, emphasizing the need for measured implementation to balance efficiency gains with security and autonomy.


<details>
  <summary>Details</summary>
Motivation: The rapid integration of LLMs into software engineering workflows necessitates understanding their adoption patterns, benefits, and risks to ensure responsible and effective usage.

Method: An empirical study based on a survey of 46 industry professionals with diverse educational backgrounds and experience levels.

Result: Respondents reported benefits such as faster technical question resolution, improved documentation, and code standardization, but raised concerns about cognitive dependence, security risks, and erosion of technical autonomy.

Conclusion: The study underscores the need for critical and supervised use of LLM-based tools in software engineering. It bridges academic and industry practices, providing actionable insights for developers and researchers while motivating future research on ethical, cognitive, and organizational implications of LLMs.
...
### [24] [Fairness Is Not Just Ethical: Performance Trade-Off via Data Correlation Tuning to Mitigate Bias in ML Software](https://arxiv.org/abs/2512.21348)
*Ying Xiao,Shangwen Wang,Sicen Liu,Dingyuan Xue,Xian Zhan,Yepang Liu,Jie M. Zhang*

Main category: cs.SE

TL;DR: This paper positions software fairness as a software quality dimension beyond ethical concerns, and introduces Correlation Tuning (CoT), a pre-processing technique which outperforms state-of-the-art methods in reducing bias metrics and improving predictive performance for unprivileged groups.


<details>
  <summary>Details</summary>
Motivation: Traditional fairness approaches either have broad applicability but poor effectiveness (pre-processing) or high effectiveness but limited applicability (post-processing). The authors note that fairness is not only an ethical concern but a software quality issue, affecting performance across user groups and real-world deployment scenarios such as generalization and transferability.

Method: CoT is a pre-processing method that uses the Phi-coefficient to measure correlation between sensitive attributes and labels. It uses multi-objective optimization to mitigate proxy biases by adjusting data correlations.

Result: CoT outperforms existing methods by 3-10% in reducing bias metrics and improving true positive rates for unprivileged groups. Specifically, it increases the true positive rate by 17.5% on average and reduces SPD, AOD, and EOD by more than 50%.

Conclusion: CoT demonstrates practical effectiveness in addressing the fairness-quality trade-off, providing both broad applicability and high effectiveness. The paper advocates for viewing fairness as a software quality characteristic rather than only an ethical concern.
...
### [25] [CosmoCore-Evo: Evolutionary Dream-Replay Reinforcement Learning for Adaptive Code Generation](https://arxiv.org/abs/2512.21351)
*Santhosh Kumar Ravindran*

Main category: cs.SE

TL;DR: CosmoCore-Evo introduces evolutionary algorithms to enhance adaptability and novelty in code generation by modifying Dream Queue with operations like mutation and fitness-based selection, leading to improved performance and faster adaptation in shifting environments.


<details>
  <summary>Details</summary>
Motivation: The motivation stems from the need for improved adaptability and novelty in code generation tasks, particularly in environments where APIs and libraries evolve. By integrating evolutionary algorithms inspired by human evolution, the framework aims to break free from trained patterns and support emergent behaviors.

Method: The method involves extending the CosmoCore framework by treating RL trajectories as 'genomes' that undergo mutation and selection during a nocturnal replay phase. The Dream Queue is augmented with evolutionary operations, including mutation of high-fitness trajectories and enterprise-tuned fitness functions that emphasize efficiency, compliance, and scalability.

Result: CosmoCore-Evo demonstrated up to a 35% increase in solution novelty and a 25% faster adaptation rate compared to the original CosmoCore and baseline methods like PPO and REAMER. Ablation studies confirmed the significance of the evolutionary components in enhancing agent performance.

Conclusion: The integration of evolutionary algorithms in CosmoCore-Evo successfully bridges the sentient gap for LLM agents by fostering adaptability and innovation in code generation tasks. The results underscore the potential of evolutionary strategies in creating more robust and responsive agents in dynamic environments.
...
### [26] [Multi-Agent LLM Committees for Autonomous Software Beta Testing](https://arxiv.org/abs/2512.21352)
*Sumanth Bharadwaj Hachalli Karanam,Dhiwahar Adhithya Kennady*

Main category: cs.SE

TL;DR: A multi-agent LLM framework with voting protocols outperforms single-agent models in automated web testing (89.5% success vs 78%) and security benchmarks, enabling real-time, reproducible testing in CI/CD pipelines.


<details>
  <summary>Details</summary>
Motivation: Manual software beta testing is costly and time-consuming, while single-agent LLMs suffer from hallucinations and inconsistent behavior, motivating the need for a collaborative, robust testing approach.

Method: A multi-agent committee framework with diverse vision-enabled LLMs collaborates through a three-round voting protocol, leveraging model diversity, persona-driven behavior, and visual UI understanding to explore web applications.

Result: The framework achieves 89.5% task success (91.7-100% for 2-4 agents) vs. 78% for single-agent baselines, 93.1% action success, and 82% OWASP security testing success, with 0.91 F1 score for bug detection.

Conclusion: The multi-agent committee framework demonstrates significant improvements in web application testing compared to single-agent LLMs, achieving high task success rates, effective bug detection, and compatibility with CI/CD pipelines.
...
### [27] [AInsteinBench: Benchmarking Coding Agents on Scientific Repositories](https://arxiv.org/abs/2512.21373)
...
TL;DR: AInsteinBench is a large-scale benchmark to evaluate LLM agents in scientific software development.


<details>
  <summary>Details</summary>
Motivation: Existing benchmarks focus on conceptual knowledge or generic software tasks, while AInsteinBench addresses the gap by testing LLMs in real scientific development scenarios.

Method: AInsteinBench includes tasks from six scientific codebases, curated through a multi-stage process. Evaluation is in executable environments with test-driven verification.

Result: The benchmark provides tasks across various scientific domains with calibrated difficulty, ensuring scientific challenge and meaningful failure modes.

Conclusion: AInsteinBench enables evaluation of LLMs beyond code generation, focusing on core competencies in computational research.
...
### [28] [What Makes a GitHub Issue Ready for Copilot?](https://arxiv.org/abs/2512.21426)
*Mohammed Sayagh*

Main category: cs.SE

TL;DR: This paper introduces 32 detailed criteria for evaluating the quality of GitHub issues to enhance their effectiveness when assigned to AI-agents like Copilot. An interpretable machine learning model is built to predict the likelihood of a GitHub issue leading to a merged pull request. By analyzing successful versus unsuccessful issues, the study shows that clarity, brevity, and specific guidance increase merge rates while external dependencies decrease them. The model achieves a median AUC of 72%, offering practical insights into writing effective GitHub issues.


<details>
  <summary>Details</summary>
Motivation: The performance of AI-agents during coding tasks, like implementing features using GitHub issues, depends heavily on the clarity and quality of the issues provided by developers. Current best practices are limited and do not offer sufficient insight into what makes an issue suitable for an AI agent, possibly leading to failed implementations.

Method: The researchers created 32 quality criteria for GitHub issues based on a comparison of successful (merged) and unsuccessful (closed) cases. They then built an interpretable machine learning model to analyze these criteria and predict whether an issue would result in a merged pull request.

Result: The analysis found that short, well-scoped issues with clear implementation guidance and no external dependencies are more likely to result in a merged pull request. The model built from the criteria achieved a median AUC of 72% in its predictions.

Conclusion: The study underscores the importance of GitHub issue quality when working with AI agents, offering actionable criteria to help developers write effective issues. It also highlights that writing GitHub issues should be considered a first-class software engineering activity as AI teammates become more prevalent.
...
### [29] [Cerberus: Multi-Agent Reasoning and Coverage-Guided Exploration for Static Detection of Runtime Errors](https://arxiv.org/abs/2512.21431)
*Hridya Dhulipala,Xiaokai Rong,Tien N. Nguyen*

Main category: cs.SE

TL;DR: Cerberus is a predictive, execution-free testing framework using LLMs to generate test inputs for detecting runtime errors and increasing code coverage without executing the code. It outperforms existing methods in efficiency and error detection.


<details>
  <summary>Details</summary>
Motivation: The paper addresses the need to detect runtime errors in code snippets without execution, which is crucial for integrating online code into a codebase safely and efficiently.

Method: Cerberus employs a two-phase feedback loop with LLMs. It initially focuses on increasing code coverage and detecting runtime errors, then shifts to exclusively error detection once maximum coverage is achieved. This approach leverages LLMs for generating test inputs and predicting coverage and errors without code execution.

Result: Empirical evaluation shows that Cerberus outperforms conventional and learning-based testing frameworks by generating high-coverage test cases more efficiently, leading to the discovery of more runtime errors in both complete and incomplete code snippets.

Conclusion: Cerberus provides an effective solution for execution-free runtime error detection and coverage-guided testing, proving superior in efficiency and effectiveness compared to existing methods.
...
### [30] [Fuzzwise: Intelligent Initial Corpus Generation for Fuzzing](https://arxiv.org/abs/2512.21440)
*Hridya Dhulipala,Xiaokai Rong,Aashish Yadavally,Tien N. Nguyen*

Main category: cs.SE

TL;DR: FuzzWise is a mutation-based greybox fuzzing method that integrates initial corpus generation and minimization using a multi-agent framework with Large Language Models (LLMs). It reduces test cases while improving code coverage and error detection efficiency through predictive coverage analysis without execution.


<details>
  <summary>Details</summary>
Motivation: Traditional greybox fuzzing separately generates and minimizes test corpora, leading to time inefficiency. FuzzWise addresses this by unifying these processes to optimize the initial corpus and reduce computational overhead, especially in scenarios where execution is impractical.

Method: FuzzWise employs two LLM agents: one generates test cases for the target program, while the second functions as a predictive code coverage module. The second agent evaluates coverage improvement without actual execution, enabling real-time optimization of the test corpus.

Result: Empirical evaluations show FuzzWise generates significantly fewer test cases than baselines while achieving higher code coverage and triggering more runtime errors. It is more time-efficient and coverage-efficient in error detection.

Conclusion: FuzzWise successfully integrates corpus generation and minimization using LLMs, offering a time- and coverage-efficient approach for creating optimal seed corpora in greybox fuzzing, particularly in execution-restricted scenarios.
...
### [31] [Code Clone Refactoring in C# with Lambda Expressions](https://arxiv.org/abs/2512.21511)
*Takuto Kawamoto,Yoshiki Higo*

Main category: cs.SE

TL;DR: The paper proposes a C#-specific 'Extract Method' refactoring technique using lambda expressions to consolidate code clones and evaluates its effectiveness on clone pairs detected by NiCad.


<details>
  <summary>Details</summary>
Motivation: The study is motivated by the lack of research on behavior parameterization techniques in languages other than Java, and the need for optimal 'Extract Method' refactoring that considers language-specific characteristics.

Method: The authors propose a C#-specific approach for 'Extract Method' refactoring that uses lambda expressions, analyze and consolidate code clones. They evaluate the method by applying it to 2,217 clone pairs from 22 projects, identifying refactorable pairs and attempting actual refactoring.

Result: The proposed approach determined that 35.0% of all clone pairs were suitable for refactoring. Among these, 28.9% were successfully refactored using the method.

Conclusion: The study concludes that using lambda expressions in a C#-specific manner can help analyze and consolidate code clones, with the proposed approach showing a moderate success rate in determining and performing refactorable clone pairs.
...
### [32] [XTrace: A Non-Invasive Dynamic Tracing Framework for Android Applications in Production](https://arxiv.org/abs/2512.21555)
*Qi Hu,Jiangchao Liu,Xin Yu,Lin Zhang,Edward Jiang*

Main category: cs.SE

TL;DR: XTrace is a new dynamic tracing framework for Android that provides real-time, non-invasive method interception and tracing to address complex bugs in production environments while maintaining stability and minimal performance impact.


<details>
  <summary>Details</summary>
Motivation: The paper aims to tackle smartphone application instability, especially due to elusive bugs (ghost bugs) that only occur in specific device and runtime scenarios and are difficult to detect with traditional methods like static logging or post-crash analysis.

Method: XTrace employs a novel non-invasive proxying technique and leverages the Android ART virtual machine's built-in instrumentation for fast and stable tracing. It enables arbitrary method interception at runtime without altering ART's internal data structures.

Result: XTrace was evaluated in a major application with a massive user base at ByteDance, demonstrating high stability and performance. A/B testing showed no significant impact on crash or ANR rates. It detected over 11 critical crashes and multiple performance bottlenecks with minimal overhead.

Conclusion: XTrace successfully reconciles the trade-off between comprehensive runtime coverage and system stability in Android apps, offering a production-ready solution for dynamic tracing with non-invasive, high-performance capabilities.
...
### [33] [Co-Evolution of Types and Dependencies: Towards Repository-Level Type Inference for Python Code](https://arxiv.org/abs/2512.21591)
*Shuo Sun,Shixin Zhang,Jiwei Yan,Jun Yan,Jian Zhang*

Main category: cs.SE

TL;DR: This paper introduces \methodName, a novel LLM-based approach for repository-level type inference in Python, which addresses challenges posed by inter-procedural dependencies. By employing an Entity Dependency Graph and an iterative refinement process, it significantly outperforms prior works in type accuracy and error reduction.


<details>
  <summary>Details</summary>
Motivation: Python's dynamic typing, while flexible, introduces runtime type errors in large-scale software. Current type inference tools are limited to isolated code snippets, failing to handle repository-level complexities due to inter-procedural dependencies.

Method: \methodName constructs an Entity Dependency Graph (EDG) to model type dependencies across a repository. It utilizes an iterative process where types and dependencies evolve together, enhanced by a type-checker-in-the-loop strategy to validate and correct inferences.

Result: Evaluations on 12 Python repositories showed \methodName achieved a 27% and 40% improvement in TypeSim and TypeExact scores over the best baseline, respectively, while reducing new type errors by 92.7%.

Conclusion: The proposed \methodName offers a substantial advancement in automated, reliable type annotation for real-world Python development by effectively managing complex, repository-level type dependencies.
...
### [34] [How Do Agents Perform Code Optimization? An Empirical Study](https://arxiv.org/abs/2512.21757)
*Huiyun Peng,Antonio Zhong,Ricardo Andrés Calvo Méndez,Kelechi G. Kalu,James C. Davis*

Main category: cs.SE

TL;DR: This paper analyzes 324 AI-authored and 83 human-authored performance optimization commits, finding that AI PRs are less likely to include performance validation and use similar optimization patterns as humans.


<details>
  <summary>Details</summary>
Motivation: There is a gap in understanding how AI coding agents perform in real-world performance optimization tasks, despite their effectiveness in code generation and bug fixing.

Method: The authors conduct an empirical study using the AIDev dataset, comparing adoption, maintainability, optimization patterns, and validation practices in agent- and human-authored performance optimization commits.

Result: AI-authored performance PRs show a significantly lower rate of explicit performance validation (45.7%) compared to human-authored (63.6%). Additionally, AI commits use optimization patterns similar to humans.

Conclusion: The paper highlights limitations in AI agent performance optimization, such as reduced validation, and suggests opportunities for improvement in agentic code optimization.
...
TL;DR: This paper compares SPDX and CycloneDX SBOM ecosystems quantitatively, revealing strengths (developer engagement vs. maturity), challenges, and opportunities for collaboration.


<details>
  <summary>Details</summary>
Motivation: SBOM adoption hinges on tool ecosystems, yet the two dominant formats (SPDX and CycloneDX) exhibit significant differences in maturity, tool support, and community engagement.

Method: Quantitative analysis of 170 SBOM tools (171 CycloneDX vs. 470 SPDX), 36,990 issue reports, and health metrics of 250 projects per ecosystem to evaluate robustness, maturity, and development challenges.

Result: CycloneDX tools show higher developer engagement and specific health indicators, while SPDX tools benefit from a more mature ecosystem with broader adoption. Challenges include varying ecosystem robustness and development opportunities.

Conclusion: The study provides insights into the complementary strengths of SPDX and CycloneDX ecosystems, highlighting areas for mutual enhancement and guiding developers and practitioners in selecting or improving toolchains.
...
TL;DR: This paper introduces PMSS, a label-free log parser metric addressing ground-truth limitations, showing strong alignment with existing measures and practical adoption guidance.


<details>
  <summary>Details</summary>
Motivation: Existing parser evaluation metrics depend on inconsistent, labeled ground-truth data, limiting industrial applicability and causing performance evaluation discrepancies.

Method: Proposes PMSS, a label-free metric using medoid silhouette analysis and Lev́enshtein distance for template-level evaluation, validated via comparisons with FGA/FTA on six parsers.

Result: PMSS shows 0.648/0.587 Spearman correlations with FGA/FTA (p<1e-8), and top parsers under PMSS/FGA differ by only 2.1%. Discusses metric interpretation challenges and adoption guidelines.

Conclusion: PMSS offers a reliable alternative for evaluating log parsers when ground-truths are inconsistent or unavailable, demonstrating strong correlation with existing metrics while addressing their limitations.
...
TL;DR: The paper proposes a multi-agent system for software engineering, analyzes its vulnerabilities, and suggests a coder-reviewer-tester architecture with a security analysis agent to improve resilience while mitigating efficiency loss. However, the security analysis agent itself is susceptible to advanced code injection attacks through poisoned examples.


<details>
  <summary>Details</summary>
Motivation: The paper aims to address the security challenges in agentic AI and Multi-Agent Systems (MAS), which are becoming increasingly prevalent in proactive multitasking applications. It highlights the need for resilient architectures as these systems transition from reactive to autonomous content generation in fields like software engineering.

Method: The paper proposes an architecture (coder-reviewer-tester) with specific roles for agents in the software implementation phase and evaluates it against threats like code injection. It introduces a security analysis agent to monitor agent-generated code for vulnerabilities and conducts experiments to assess the robustness of this addition against advanced attacks.

Result: Experiments showed that the coder-reviewer-tester system is more resilient than the coder and coder-tester systems, reducing the loss in efficiency over the latter two. However, the security analysis agent was found vulnerable to advanced code injection where the inclusion of poisoned few-shot examples increased attack success rates significantly (up to 71.95%).

Conclusion: The introduction of a security analysis agent enhances the system's resilience without sacrificing efficiency, but it remains vulnerable to sophisticated attacks involving data poisoning. This underscores the need for improved robustness in multi-agent systems, particularly in secure software development applications.
...
TL;DR: This paper introduces a binary analysis framework using kernel modules and containerization to enhance fine-grained analysis performance, validated through experiments showing improved usability and practical application in analyzing security threats.


<details>
  <summary>Details</summary>
Motivation: Existing fine-grained analysis methods face challenges in deployability, memory consumption, and performance - necessitating adaptation to modern analysis scenarios like memory corruption exploits and sandbox evasion techniques.

Method: The framework combines kernel module expansion with decoupled analysis, using process hollowing in containerized environments to reduce overhead while reusing existing dynamic instrumentation platforms.

Result: Windows-based prototype validated through benchmark programs, real-world applications, and successful analysis of exploit programs and malware demonstrating effectiveness.

Conclusion: The proposed framework improves usability and performance of fine-grained binary analysis, demonstrating practical value in analyzing exploit programs and malware through experiments.
...
### [39] [Proceedings First Workshop on Adaptable Cloud Architectures](https://arxiv.org/abs/2512.22054)
*Giuseppe De Palma,Saverio Giallorenzo*

Main category: cs.SE

TL;DR: Post-proceedings volume of WACA 2025 workshop on adaptable cloud architectures, co-located with DisCoTec 2025 conference.


<details>
  <summary>Details</summary>
Motivation: The workshop aimed to bring together researchers and practitioners to discuss challenges and solutions in adaptable cloud computing architectures, fostering collaboration and knowledge-sharing.

Method: The workshop compiled and organized research contributions from participants, published as a post-proceedings volume co-located with DisCoTec 2025.

Result: A post-proceedings volume was created, containing peer-reviewed contributions from the workshop that advance understanding of adaptable cloud architecture techniques and systems.

Conclusion: The post-proceedings volume documents the outcomes and contributions of the WACA 2025 workshop, serving as a scholarly record of adaptable cloud architecture discussions and innovations presented during the event.
