...
### [2] [MuMuTestUp: Mutation-based Multi-Agent Test Case Update](https://arxiv.org/abs/2605.19265)
...
### [3] [When to Answer and When to Defer: A Decision Framework for Reliable Code Predictions](https://arxiv.org/abs/2605.19369)
...
### [4] [Provable Fairness Repair for Deep Neural Networks](https://arxiv.org/abs/2605.19549)
...
### [5] [CriterAlign: Criterion-Centric Rationale Alignment for Code Preference Judging](https://arxiv.org/abs/2605.19665)
...
### [6] [OpenHealth Lake: Designing and testing a data lakehouse platform for health applications](https://arxiv.org/abs/2605.19922)
...
### [8] [Operationalising Artificial Intelligence Bills of Materials (AIBOMs) for Verifiable AI Provenance and Lifecycle Assurance](https://arxiv.org/abs/2605.19755)
...
### [9] [Decentralized autonomous organization and blockchain-based incentivization framework for community-based facilities management](https://arxiv.org/abs/2605.18773)
...
### [10] [DarkLLM: Learning Language-Driven Adversarial Attacks with Large Language Models](https://arxiv.org/abs/2605.18868)
...
### [11] [GenAI-FDIA: Physics-Informed Generative Models for False Data Injection Attacks](https://arxiv.org/abs/2605.18873)
...
### [12] [Lightweight and Fast Backdoor Model Detection](https://arxiv.org/abs/2605.18907)
...
### [13] [Fast and Lightweight Backdoor Detection via Head Random Probing](https://arxiv.org/abs/2605.18908)
...
### [14] [SCAFDS: Edge-Feature Graph Attention for Interbank Fraud Detection with Attribution-Grounded SAR Generation](https://arxiv.org/abs/2605.18913)
...
### [15] [DMN: A Compositional Framework for Jailbreaking Multimodal LLMs with Multi-Image Inputs](https://arxiv.org/abs/2605.18915)
...
### [16] [ESLD (External Surrogate Latent Defense): A Latent-Space Architecture for Faster, Stronger Prompt-Injection Defense](https://arxiv.org/abs/2605.18918)
*Yash Narendra*
...
### [17] [MoCo-EA: Exploiting Adversarial Mode Connectivity for Efficient Evolutionary Attacks](https://arxiv.org/abs/2605.18919)
...
### [18] [OEP: Poisoning Self-Evolving LLM Agents via Locally Correct but Non-Transferable Experiences](https://arxiv.org/abs/2605.18930)
...
### [19] [Surviving the Unseen: Predictive Defense for Novel Multi-Turn Multimodal Attacks](https://arxiv.org/abs/2605.18988)
*Doohee You*
...
### [20] [Agent Security is a Systems Problem](https://arxiv.org/abs/2605.18991)
...
### [21] [Structural Analysis of Cryptographic Sequences using Stringology-Based Fingerprinting](https://arxiv.org/abs/2605.19123)
*Victor Kebande*
...
### [22] [Be Kind, Rewrite: Benign Projections via Rewriting Defend Against LLM Data Poisoning Attacks](https://arxiv.org/abs/2605.19147)
...
### [23] [On the Geometric Limits of Transformer Defenses against Obfuscation Attacks: Latent Embedding Collapse & Performance Robustness Gap](https://arxiv.org/abs/2605.19159)
...
### [24] [Quantum Machine Learning for Cyber-Physical Anomaly Detection in Unmanned Aerial Vehicles: A Leakage-Free Evaluation with Proxy-Audited Feature Sets](https://arxiv.org/abs/2605.19233)
...
### [25] [MultiBallot: Verifiable and privacy-preserving E-Collecting in the Swiss setting](https://arxiv.org/abs/2605.19312)
...
### [26] [RoboJailBench: Benchmarking Adversarial Attacks and Defenses in Embodied Robotic Agents](https://arxiv.org/abs/2605.19328)
...
### [27] [Auditing Privacy in Multi-Tenant RAG under Account Collusion](https://arxiv.org/abs/2605.19847)
...
### [28] [Hunting Vulnerability Variants in AI Infra: Measurement and Reference-Driven Detection](https://arxiv.org/abs/2605.20051)
