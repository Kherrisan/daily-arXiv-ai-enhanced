...
### [5] [Insights from GitHub Community on the Matter Standard: Developer Perspectives and Challenges](https://arxiv.org/abs/2607.01494)
...
### [6] [Kani: A Model Checker for Rust](https://arxiv.org/abs/2607.01504)
...
### [7] [A Capacity-Aware Parr Model for Agile Projects](https://arxiv.org/abs/2607.01562)
*Pedro E. Colla*
...
### [8] [A Single Patch Is Not Enough: Deterministic Fusion of Repair Candidates](https://arxiv.org/abs/2607.01597)
...
### [11] [Refploit: Facilitating Exploit Construction via Code-Agent Trajectory Repair](https://arxiv.org/abs/2607.01760)
...
### [12] [KRCA: An Efficient Root Cause Analysis System in Hyper-Scale Microservice Systems via Agentic AI](https://arxiv.org/abs/2607.01788)
...
### [13] [Archer: Towards Agentic Review for Compiler Optimizations](https://arxiv.org/abs/2607.01808)
*Yunbo Ni,Shaohua Li*
...
### [14] [Decoupling Code Complexity from Newcomer Participation: A Causal Study of AI Coding Agent Adoption in OSS](https://arxiv.org/abs/2607.01810)
...
### [15] [Understanding Software Defect Prediction: A Large-scale Empirical Study Across Uncertainty Quantification and Performance Evaluation](https://arxiv.org/abs/2607.01842)
...
### [16] [Technical Debt Friction for Maintenance Prioritization: An Industrial Multi-Case Study](https://arxiv.org/abs/2607.01850)
...
### [17] [Regression Accumulation in Multi-Turn LLM Programming Conversations](https://arxiv.org/abs/2607.01855)
...
### [18] [An Exploratory Study on LLM-Generated Code and Comments in Code Repositories](https://arxiv.org/abs/2607.01867)
...
### [19] [Understanding Build Reproducibility in the F-Droid Ecosystem](https://arxiv.org/abs/2607.01890)
...
### [20] [AI Writes Faster Than Humans Can Review: A Longitudinal Study of an Enterprise 2x Mandate](https://arxiv.org/abs/2607.01904)
...
### [21] [Beyond Textual Repository Exploration: Dual-Modal Structural Reasoning for Agentic Issue Resolution](https://arxiv.org/abs/2607.01929)
...
### [22] [Underspecification does not imply Incoherence: The Risks of Semantic Collapse in Coding Models](https://arxiv.org/abs/2607.01953)
...
### [23] [HTTP REST API Structure Learning](https://arxiv.org/abs/2607.02442)
*Ran Dubin,Amit Dvir*
...
### [35] [TestEvo-Bench: An Executable and Live Benchmark for Test and Code Co-Evolution](https://arxiv.org/abs/2607.02469)
...
### [36] [Embedding Inference Attack](https://arxiv.org/abs/2607.01276)
...
### [37] [Cognitive Firewall: A Proactive, Zero-Trust, Multi-Gate Framework for LLM Safety](https://arxiv.org/abs/2607.01277)
...
### [38] [Generative AI and Federated Learning for Intrusion Detection Systems: A Survey](https://arxiv.org/abs/2607.01305)
...
### [39] [An alternative approach towards attacks against fully-split PLWE instances](https://arxiv.org/abs/2607.01340)
...
### [40] [Chameleon: Recovering Cyber-Physical Systems from Memory Corruption Attacks via ML Surrogates](https://arxiv.org/abs/2607.01356)
...
### [41] [From Forgeries to Foundation Models: A Systematic Survey of Identity Document Attack and Detection](https://arxiv.org/abs/2607.01442)
...
### [43] [Overthink-Triggered Slowdown Attacks on LVLM-Based Robotic Systems](https://arxiv.org/abs/2607.01518)
...
### [44] [LIB-TRAP: Standard Cell Library Hardware Trojan Risk Assessment and Prevention](https://arxiv.org/abs/2607.01526)
...
### [45] [VeriChat: An Agentic Conversational AI Assistant for Hardware Security Verification](https://arxiv.org/abs/2607.01668)
...
### [46] [Beyond Gradient-Based Attacks: Adversarial Robustness and Explainability Stability in Cybersecurity Classifiers](https://arxiv.org/abs/2607.01679)
...
### [47] [Pmeta-TLA: Backdoor Attacks for Speech Classification Models via Meta-Learning with Timbre Leakage Attack](https://arxiv.org/abs/2607.01702)
...
### [48] [Trust Boundary Semantic Gaps: A Multi-dimensional Analysis and Mitigation for Security-by-Design](https://arxiv.org/abs/2607.01711)
...
### [49] [Resilient Liquid Democracy: Mitigating Voting Power Imbalances via Secure Delegation Networks](https://arxiv.org/abs/2607.01730)
...
### [50] [Knowledge Over Parameters: Evolving Smart Contract Vulnerability Detection](https://arxiv.org/abs/2607.01742)
...
### [51] [Has This Checkpoint Been Abliterated? A Two-Signal Audit and Its Failure Map](https://arxiv.org/abs/2607.01854)
*Gabriel Hurtado*
...
### [52] [Behind the Refusal: Determining Guardrail Activation via Behavioral Monitoring](https://arxiv.org/abs/2607.02121)
...
### [53] [Cloak and Detonate: Scanner Evasion and Dynamic Detection of Agent Skill Malware](https://arxiv.org/abs/2607.02357)
...
### [54] [SoK: A Taxonomy for Cybersecurity Incident Response Influence Factors](https://arxiv.org/abs/2607.02451)
