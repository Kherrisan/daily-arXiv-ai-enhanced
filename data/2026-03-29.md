...
### [9] [Error Understanding in Program Code With LLM-DL for Multi-label Classification](https://arxiv.org/abs/2603.25005)
...
### [10] [Factors Influencing the Quality of AI-Generated Code: A Synthesis of Empirical Evidence](https://arxiv.org/abs/2603.25146)
...
### [11] [WebTestBench: Evaluating Computer-Use Agents towards End-to-End Automated Web Testing](https://arxiv.org/abs/2603.25226)
...
### [12] [Quantum Circuit Repair by Gate Prioritisation](https://arxiv.org/abs/2603.25587)
...
### [13] [SHAPR: Operationalising Human-AI Collaborative Research Through Structured Knowledge Generation](https://arxiv.org/abs/2603.25660)
*Ka Ching Chan*
...
### [14] [The Kitchen Loop: User-Spec-Driven Development for a Self-Evolving Codebase](https://arxiv.org/abs/2603.25697)
*Yannick Roy*
...
### [15] [SolRugDetector: Investigating Rug Pulls on Solana](https://arxiv.org/abs/2603.24625)
...
### [16] [An Explainable Federated Framework for Zero Trust Micro-Segmentation in IIoT Networks](https://arxiv.org/abs/2603.24754)
...
### [17] [AIP: Agent Identity Protocol for Verifiable Delegation Across MCP and A2A](https://arxiv.org/abs/2603.24775)
*Sunil Prakash*
...
### [18] [Bridging Code Property Graphs and Language Models for Program Analysis](https://arxiv.org/abs/2603.24837)
*Ahmed Lekssays*
...
### [19] [AI Security in the Foundation Model Era: A Comprehensive Survey from a Unified Perspective](https://arxiv.org/abs/2603.24857)
...
### [20] [Trusted-Execution Environment (TEE) for Solving the Replication Crisis in Academia](https://arxiv.org/abs/2603.24878)
...
### [21] [An Approach to Generate Attack Graphs with a Case Study on Siemens PCS7 Blueprint for Water Treatment Plants](https://arxiv.org/abs/2603.24888)
...
### [22] [Sovereign AI at the Front Door of Care: A Physically Unidirectional Architecture for Secure Clinical Intelligence](https://arxiv.org/abs/2603.24898)
...
### [26] [The System Prompt Is the Attack Surface: How LLM Agent Configuration Shapes Security and Creates Exploitable Vulnerabilities](https://arxiv.org/abs/2603.25056)
*Ron Litvak*
...
### [27] [PIDP-Attack: Combining Prompt Injection with Database Poisoning Attacks on Retrieval-Augmented Generation Systems](https://arxiv.org/abs/2603.25164)
...
### [28] [zk-X509: Privacy-Preserving On-Chain Identity from Legacy PKI via Zero-Knowledge Proofs](https://arxiv.org/abs/2603.25190)
*Yeongju Bak*
...
### [29] [Mitigating Evasion Attacks in Fog Computing Resource Provisioning Through Proactive Hardening](https://arxiv.org/abs/2603.25257)
...
### [30] [Usability of Passwordless Authentication in Wi-Fi Networks: A Comparative Study of Passkeys and Passwords in Captive Portals](https://arxiv.org/abs/2603.25290)
...
### [31] [Physical Backdoor Attack Against Deep Learning-Based Modulation Classification](https://arxiv.org/abs/2603.25304)
*Younes Salmi,Hanna Bogucka*
...
### [32] [On the Vulnerability of Deep Automatic Modulation Classifiers to Explainable Backdoor Threats](https://arxiv.org/abs/2603.25310)
*Younes Salmi,Hanna Bogucka*
...
### [33] [Multi-target Coverage-based Greybox Fuzzing](https://arxiv.org/abs/2603.25354)
*Masami Ichikawa*
...
### [35] [Shape and Substance: Dual-Layer Side-Channel Attacks on Local Vision-Language Models](https://arxiv.org/abs/2603.25403)
...
### [36] [Unveiling the Resilience of LLM-Enhanced Search Engines against Black-Hat SEO Manipulation](https://arxiv.org/abs/2603.25500)
...
### [37] [TAAC: A gate into Trustable Audio Affective Computing](https://arxiv.org/abs/2603.25570)
