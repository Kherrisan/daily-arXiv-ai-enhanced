...
### [1] [TRACTOR Benchmark for Evaluating C to Rust Translators](https://arxiv.org/abs/2609.25121)
...
### [2] [TAILOR: Template-Preserving Augmentation for Long-Tailed Log Parsing](https://arxiv.org/abs/2609.25261)
...
### [3] [The Vocabulary of Flaky Tests in Swift](https://arxiv.org/abs/2609.25516)
...
### [4] [Dynamic Conformance Testing of WebGPU Through Specification-Driven Mutation](https://arxiv.org/abs/2609.25520)
...
### [5] [Evaluating Shaker for Flaky Test Detection in Python Projects](https://arxiv.org/abs/2609.25528)
...
### [6] [An Empirical Analysis of Cross-OS Portability Issues in Python Projects](https://arxiv.org/abs/2609.25531)
...
### [7] [Understanding Maintenance and Support in a Community-Driven Scientific Workflow Ecosystem: A Cross-Space Study of Galaxy](https://arxiv.org/abs/2609.25587)
...
### [8] [What Was Once Learned May Need to Be Unlearned: Machine Unlearning for Deprecated API Knowledge in Large Language Models](https://arxiv.org/abs/2609.25786)
...
### [9] [Confidence-Guided Cross-Modal Knowledge Transfer for Multimodal Anomaly Detection in Microservice Systems](https://arxiv.org/abs/2609.25856)
...
### [10] [When Should Dependency Updates Invoke Repair Agents? A Lightweight Routing Study](https://arxiv.org/abs/2609.25911)
...
### [11] [Compiling Sufficient Governance Context from Declared Losses and Reachable States: Exact Observation-Contract Synthesis with Cardinality and Cost Objectives](https://arxiv.org/abs/2609.26016)
*Gaston Besanson*
...
### [12] [On Behavioral Alignment of Model-Code and Human-Code Understandability via Behavioral Proxies](https://arxiv.org/abs/2609.26101)
...
### [13] [Post-Hoc Attention Steering of Large Language Models for Robust Code Understanding under Obfuscation](https://arxiv.org/abs/2609.26102)
...
### [14] [Why Do LLMs Fail at OCL Generation? A Graph Reasoning Perspective](https://arxiv.org/abs/2609.26122)
...
### [15] [A Large-Scale Longitudinal Study of Multi-CI Service Adoption](https://arxiv.org/abs/2609.26181)
...
### [16] [WatchPoint: Executable User Feedback for Real-World Agentic Web Development](https://arxiv.org/abs/2609.26204)
...
### [17] [Reducing Hallucinations in Large Language Models Through Integrated Self-Verification and Retrieval-Augmented Generation](https://arxiv.org/abs/2609.26229)
*Ashly Joseph*
...
### [18] [CANcept: Model-based CAN Traffic Generation and Manipulation](https://arxiv.org/abs/2609.26263)
...
### [19] [On the Lexical Superstition of Large Language Models for Code Comprehension: Re-evaluation on Code of Low Lexical Quality](https://arxiv.org/abs/2609.26388)
...
### [20] [FeatLens: Feature-Guided Dynamic Code Graph Construction and Retrieval for Repository-Level Code Generation](https://arxiv.org/abs/2609.26480)
...
### [21] [From Approval to Execution: Reconstruction-Aware Repair Analysis for LLM-Agent Software](https://arxiv.org/abs/2609.26529)
...
### [22] [TraceVIC: Causal Reasoning over Code Evolution for Identifying Vulnerability-Inducing Commits](https://arxiv.org/abs/2609.26711)
...
### [23] [Metrics Failure in LLM-Based Code Vulnerability Repair: An Empirical Study and a Change-Aware Screen](https://arxiv.org/abs/2609.26749)
...
### [24] [Not All 4-bit Quantizers Are Equal: Deployment-Time Mitigation of PII Leakage in Fine-Tuned Small Language Models](https://arxiv.org/abs/2609.25014)
...
### [25] [CPyGraph: A Version-Aware Static Analysis Framework for Native CPython Bytecode](https://arxiv.org/abs/2609.25083)
*Baihong Chen,Wen Li*
...
### [26] [Benchmarking Neural Defend ARCAS 1B: A Foundational Multimodal Deepfake Detection Model](https://arxiv.org/abs/2609.25154)
...
### [27] [Attack Success Rate Is Not a Number: On Measurement Validity in Agentic AI Security Evaluation](https://arxiv.org/abs/2609.25173)
...
### [28] [Partition-Matched Evaluation of Community Features under Distribution Shift in Android Malware Function-Call Graphs](https://arxiv.org/abs/2609.25256)
...
### [30] [SSP-Bench: A Hybrid Data Generation Framework for Safety, Security, and Privacy Evaluation](https://arxiv.org/abs/2609.25352)
...
### [31] [Quantum ROP: Using Quantum Algorithms for ROP Chain Selection in Exploit Construction](https://arxiv.org/abs/2609.25364)
*Carlos Benitez*
...
### [32] [Identifying Suspected Mislabeled Apps in Google Play Application Removal Prediction: An Empirical Comparison of Label Noise Detection Methods](https://arxiv.org/abs/2609.25487)
...
### [33] [FASTAR: FRI Accelerator for Scalable Transparent ARguments of Knowledge](https://arxiv.org/abs/2609.25535)
...
### [34] [Rethinking Backdoor Repair Evaluation: Distinguishing Aggregate Clean Utility from Benign Performance Preservation](https://arxiv.org/abs/2609.25579)
...
### [35] [SLED-IFV: Solver-Validated LLM-Guided Decomposition for Scalable Hardware Information-Flow Verification](https://arxiv.org/abs/2609.25637)
...
### [36] [C-to-Rust Fallacy: Automatic Refactoring != Memory Security](https://arxiv.org/abs/2609.25682)
...
### [37] [GuidedRay: Diversity-Guided Direction Discovery for Targeted Hard-Label Black-Box Attacks](https://arxiv.org/abs/2609.25734)
...
### [38] [Adaptive Traffic Camouflage: Causal and Resource-Aware Defense Against IoT Fingerprinting](https://arxiv.org/abs/2609.25787)
...
### [39] [On the Construction of Trapdoor Claw-Free Functions with Certifiable Key](https://arxiv.org/abs/2609.25819)
*Charles Lim,Yao Ma*
...
### [40] [COBRA: A Content-Agnostic Framework for Zero-Day Detection of Suspicious Domains](https://arxiv.org/abs/2609.25882)
...
### [41] [LoRango: It Takes Two LoRAs to Unlock Hidden Behaviors in Diffusion Models](https://arxiv.org/abs/2609.25884)
...
### [42] [How It's Made: Uncovering Detection Engineering Processes for Network Intrusion Detection Rules](https://arxiv.org/abs/2609.25901)
...
### [43] [Toward Responsible AI-Augmented Cyber Defense: Pattern Recognition, Defense-in-Depth, and the Case for Human-AI Collaboration](https://arxiv.org/abs/2609.25921)
...
### [44] [Policy-Backed Selective Regeneration under Tainted Inter-Agent Communication](https://arxiv.org/abs/2609.26072)
...
### [45] [Learning to Link: Automatic Re-identification of BLE Devices Under MAC Address Randomisation](https://arxiv.org/abs/2609.26079)
...
### [46] [From Bilinear to Linear: Differentially Private Federated LoRA via Low-Dimensional Parameterization](https://arxiv.org/abs/2609.26091)
...
### [47] [Beyond Classification Accuracy: Quantifying Fingerprint Complexity in Encrypted Darknet Services](https://arxiv.org/abs/2609.26096)
...
### [48] [A Cross-Dataset based Zero-Day Intrusion Detection System by Integrating Siamese Network and Reinforcement Learning](https://arxiv.org/abs/2609.26115)
...
### [49] [Zeta-Transform Evaluation for Higher-Order Vanishing Key Recovery](https://arxiv.org/abs/2609.26132)
...
### [50] [The Uncontrolled Variable: Vision-Language Model Refusal Responds to Image Presence in Ways Risk Cannot Explain](https://arxiv.org/abs/2609.26174)
...
### [51] [Refusal without Discrimination: What Encoded Prompts Do to Safety-Trained Models](https://arxiv.org/abs/2609.26176)
...
### [52] [Towards Effective Black-Box Adversarial Attacks on Deep Code Models via Structural and Identifier Perturbations](https://arxiv.org/abs/2609.26234)
...
### [53] [Unread or Unenforced? Separating Representation from Enforcement Failure in Content Guards](https://arxiv.org/abs/2609.26178)
...
### [54] [Design and Evaluation of a Controlled Post-Alert Incident Orchestration and Response Subsystem Using a Rule Engine and a Local Large Language Model](https://arxiv.org/abs/2609.26316)
...
### [55] [Dynamic Deep Prompt Optimization for Defending Against Jailbreak Attacks on LLMs](https://arxiv.org/abs/2609.26185)
...
### [56] [Who Assures the Verifier? An Executable Assurance-Locus Audit of the European Digital Identity Wallet](https://arxiv.org/abs/2609.26220)
*Anton Sokolov*
...
### [57] [Quantum-Ready Secure WAN: A Risk Assessment and Migration Framework](https://arxiv.org/abs/2609.26225)
*Saeed Alam*
...
### [58] [eBPF Security in the Wild: Structural Concentration, Failure Mechanisms, and Discovery Gaps](https://arxiv.org/abs/2609.26254)
...
### [59] [CRT-Decomposed $Σ$-Protocols for CSIDH](https://arxiv.org/abs/2609.26258)
*I. Dey,I. Cherkaoui*
...
### [60] [Image-Based Techniques and Ensemble Soft Voting for Malware Classification](https://arxiv.org/abs/2609.26281)
...
### [61] [Neural Fingerprints for Malware Analysis: An Image-Based Metric Learning Approach with Application to Cross-Domain Classification](https://arxiv.org/abs/2609.26282)
...
### [62] [A Throughput-Oriented Analytical Model for Post-Quantum Security Protocols](https://arxiv.org/abs/2609.26284)
...
### [63] [On the security and privacy of LLMs in Mobility](https://arxiv.org/abs/2609.26295)
...
### [64] [Staged Multi-step UTXO Workflows via Recursive Invariants](https://arxiv.org/abs/2609.26305)
...
### [65] [HYDRA: Proactive Android Malware Drift Adaptation via Hierarchical Graph Contrastive Learning](https://arxiv.org/abs/2609.26352)
...
### [66] [Formally Modeling the Terrapin Attack on SSH](https://arxiv.org/abs/2609.26358)
...
### [67] [Rouxii: Exploiting Honeypots with Deception-Aware AI Pentesters](https://arxiv.org/abs/2609.26555)
...
### [68] [Decoding the Legalese: A Scalable and Quantitative Framework for Analyzing Corporate Privacy Policies](https://arxiv.org/abs/2609.26680)
...
### [69] [From Alignment to Access Control: A Framework for GenAI Policy Enforcement](https://arxiv.org/abs/2609.26682)
*Nathalie Baracaldo*
...
### [70] [A2M: Trace-Optimized Agent Hijacking in the MCP Ecosystem](https://arxiv.org/abs/2609.26761)
