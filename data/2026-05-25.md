...
### [10] [The Misattribution Gap: When Memory Poisoning Looks Like Model Failure in Agentic AI Systems](https://arxiv.org/abs/2605.22842)
...
### [11] [Beyond Zero: Enterprise Security for the AI Era](https://arxiv.org/abs/2605.22985)
...
### [12] [Botnet Detection on CTU-13 Using Lightweight Machine Learning Models](https://arxiv.org/abs/2605.23004)
...
### [13] [BYOT-CPS: A Hybrid Cyber-Physical Systems Testbed for IoT Security Assessment and Platform Evaluation](https://arxiv.org/abs/2605.23059)
...
### [15] [What Does the Server See? Understanding Privacy Leakage from Large Language Models in Split Inference](https://arxiv.org/abs/2605.23158)
...
### [16] [PoisonForge: Task-Level Targeted Poisoning Benchmark for Instruction-Tuned LLMs](https://arxiv.org/abs/2605.23168)
...
### [17] [Robust LLM Watermarking with Minimal Semantic Distortion for IP Protection](https://arxiv.org/abs/2605.23175)
...
### [18] [Prompt Overflow: What the Guardrail Inspects Is Not What the Model Infers](https://arxiv.org/abs/2605.23196)
...
### [19] [Are Frontier LLMs Ready for Cybersecurity? Evidence for Vertical Foundation Models from Dual-Mode Vulnerability Benchmarks](https://arxiv.org/abs/2605.23243)
...
### [20] [Security, Privacy, and Ethical Risks in OpenClaw](https://arxiv.org/abs/2605.23330)
...
### [21] [AI Security Research Should Better Incentivize Defense Research](https://arxiv.org/abs/2605.23448)
*Youqian Zhang*
...
### [22] [When Youth Enter the Algorithmic Wild: Discovering and Understanding Potentially Harmful Teen Videos on Douyin and Kwai](https://arxiv.org/abs/2605.23598)
...
### [23] [CachePrune: Privacy-Aware and Fine-Grained KV Cache Sharing for Efficient LLM Inference](https://arxiv.org/abs/2605.23640)
...
### [24] [Kernel-Based ReLU Approximation for Homomorphic Encryption-Compatible Privacy-preserving Deep Learning Models](https://arxiv.org/abs/2605.23641)
...
### [25] [Less Effort, Shorter Proofs: Reinforcement Learning for Security Protocol Analysis in Tamarin](https://arxiv.org/abs/2605.23643)
...
### [26] [Validating Threat Modeling Results with the Help of Vulnerable Test Applications](https://arxiv.org/abs/2605.23695)
...
### [27] [A blueprint for constructing 3-pass AKE protocols under commitment-based models](https://arxiv.org/abs/2605.23843)
